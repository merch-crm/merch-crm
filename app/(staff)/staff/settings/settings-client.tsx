        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <Card className="crm-card border-none shadow-sm bg-white overflow-hidden group">
                        <CardHeader className="bg-slate-50/50 p-6 border-b border-slate-100 transition-colors group-hover:bg-slate-50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="font-bold text-slate-900 text-sm uppercase tracking-widest leading-none">График работы</h2>
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter mt-1.5">Определение опозданий и смен</p>
                                </div>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="crm-card border-none shadow-sm bg-white overflow-hidden group">
                        <CardHeader className="bg-slate-50/50 p-6 border-b border-slate-100 transition-colors group-hover:bg-slate-50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="font-bold text-slate-900 text-sm uppercase tracking-widest leading-none">Алгоритмы распознавания</h2>
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter mt-1.5">Точность и чувствительность ИИ</p>
                                </div>
                            </div>
                        </CardHeader>
                ...
                <div className="space-y-8">
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-2">Инфраструктура</h3>
                        ...
                        <CardBody className="p-6 relative z-10">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-200 text-[10px] font-medium leading-relaxed mt-2 opacity-80">
...
function InfrastructureCard({
    ...
    return (
        <Card className={cn(
            "crm-card border-none shadow-sm transition-all overflow-hidden",
                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter mt-1.5">{description}</p>
                        </div>
                    </div>
                </div>
