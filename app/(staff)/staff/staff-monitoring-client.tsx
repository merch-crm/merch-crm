  ...
  return (
    <div className="space-y-3 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <StatCard title="Всего сотрудников" value={stats.total} icon={Users} color="blue" />
        <StatCard title="Среднее время (ч)" value={stats.avgWorkHours} icon={Clock} color="green" />
        <StatCard title="Опоздания" value={stats.late} icon={AlertCircle} color="orange" />
      </div>
