        ...
        <div className="space-y-6 pb-20">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-extrabold text-slate-900 tracking-normal">Внешний вид</h1>
                        <p className="text-slate-400 font-bold text-sm uppercase tracking-wider mt-1">Настройка логотипа, цветов и радиусов CRM</p>
                    </div>
                    <Button
                        type="submit"
                        disabled={loading}
                    ...
                    >
                        {loading ? <Database className="w-4 h-4 animate-spin mr-2" /> : <Save className="w-4 h-4 mr-2" />}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-xs font-bold text-primary bg-primary/5 px-2 py-0.5 rounded-md">{formData.radius_outer || 24}px</span>
                            </div>
                            <input
                                type="range"
                                min="0"
                                ...
                                className="w-full h-1.5 bg-slate-100 rounded-[18px] appearance-none cursor-pointer accent-primary"
                            />
                        </div>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <label className="text-sm font-bold text-slate-700">Внутренний радиус (Кнопки/Инпуты)</label>
                                <span className="text-xs font-bold text-primary bg-primary/5 px-2 py-0.5 rounded-md">{formData.radius_inner || 14}px</span>
                            </div>
                            <input
                                type="range"
                                min="0"
