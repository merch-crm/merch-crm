            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div className="relative transform overflow-hidden rounded-[18px] bg-white p-8 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-slate-200">
                    ...
                    <form action={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1">
                            <label className="text-xs font-bold text-slate-400  tracking-normal pl-1">Новый пароль (оставьте пустым, если не хотите менять)</label>
                            <div className="relative">
                        ...
                        <div className="mt-8 flex gap-3">
                            <button
                                type="button"
                                onClick={onClose}
                                className="flex-1 px-4 py-3 text-sm font-bold text-slate-700 bg-slate-100 rounded-[18px] hover:bg-slate-200 transition-all"
                            >
                                Отмена
                            </button>
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex-[2] inline-flex items-center justify-center gap-2 rounded-[18px] border border-transparent bg-primary py-3 px-4 text-sm font-bold text-white shadow-lg shadow-primary/20 hover:opacity-90 focus:outline-none disabled:opacity-50 transition-all active:scale-[0.98]"
                            >
                                {loading ? (
