                ...
                <div className="relative transform overflow-hidden rounded-[18px] bg-white p-0 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-3xl border border-slate-200">
                    ...
                    <div className="px-8 pt-8 pb-6 border-b border-slate-100 relative">
                        ...
                        <div className="flex items-center gap-5">
                            <div className={`h-16 w-16 rounded-[18px] ${colorStyle.bg} ${colorStyle.text} flex items-center justify-center border ${colorStyle.border} shadow-sm shrink-0`}>
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <div className="px-8 pt-6 pb-2">
                            <TabsList className="bg-[#f1f5f9] border-none rounded-full p-1 w-full sm:w-auto inline-flex h-auto shadow-none">
                                <TabsTrigger
                                    value="general"
                                    className="px-8 py-2.5 text-[10px] font-bold  tracking-[0.2em] rounded-full transition-all data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)]"
                                >
                                    Основное
                                </TabsTrigger>
                                <TabsTrigger
                        ...
                        <div className="px-8 pb-8 pt-6 min-h-[400px]">
                            ...
                            <TabsContent value="general">
                                <form action={handleGeneralSubmit} className="space-y-6">
                                    <div className="space-y-1">
                                        <label className="text-xs font-bold text-slate-400  tracking-normal pl-1">Название подразделения</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-xs font-bold text-slate-400  tracking-normal pl-1">Описание деятельности</label>
                                        <textarea
                                            name="description"
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-xs font-bold text-slate-400  tracking-normal pl-1">Визуальный идентификатор (Цвет)</label>
                                    ...
                                    <div className="pt-6 border-t border-slate-50">
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="w-full inline-flex justify-center items-center gap-2 rounded-[18px] border border-transparent bg-primary py-4 px-4 text-sm font-bold text-white shadow-xl shadow-primary/20 hover:opacity-90 disabled:opacity-50 transition-all active:scale-[0.98]"
                                        >
                            ...
                            <TabsContent value="roles">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
                                    {/* Current Roles */}
                                    <div className="flex flex-col bg-slate-50/50 rounded-[18px] border border-slate-100 p-5 h-[450px]">
                                        ...
                                        <div className="space-y-2 overflow-y-auto pr-1 custom-scrollbar flex-1">
                                            {rolesLoading ? (
                                                ...
                                                <div className="h-full flex flex-col items-center justify-center text-center">
                                                    <div className="w-12 h-12 bg-white rounded-[18px] flex items-center justify-center shadow-sm border border-slate-100 mb-3">
                                    ...
                                    {/* Available Roles */}
                                    <div className="flex flex-col border border-slate-200 rounded-[18px] p-5 h-[450px]">
                                        ...
                                        <div className="space-y-2 overflow-y-auto pr-1 custom-scrollbar flex-1">
                                            {rolesLoading ? (
                                                ...
                                                <div className="h-full flex flex-col items-center justify-center text-center">
                                                    <div className="w-12 h-12 bg-slate-50 rounded-[18px] flex items-center justify-center border border-slate-100 mb-3">
                                                ...
                                                availableRoles.map(role => (
                                                    <div key={role.id} className="flex items-center justify-between p-4 bg-slate-50/50 border border-slate-100 rounded-[18px] group hover:border-primary/40 hover:bg-white transition-all">
