                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                            ...
                            {onEdit && (
                                <Button
                                    onClick={onEdit}
                                    variant="outline"
                                    className="h-10 px-4 border-indigo-100 text-#5d00ff rounded-[18px] font-bold text-xs hover:bg-indigo-50"
                                >
                    ...
                    <div className="flex gap-8">
                        {(["general", "orders", "activity"] as const).map((tab) => (
                            ...
                            >
                                ...
                                {activeTab === tab && (
                                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-#5d00ff rounded-t-full mt-auto" />
                                )}
                            </button>
                        ))}
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-slate-50/30">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center h-full space-y-4">
                            <div className="w-10 h-10 border-4 border-indigo-100 border-t-#5d00ff rounded-full animate-spin" />
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm">
                                            <div className="flex items-center gap-3 mb-4">
                                                <div className="w-10 h-10 bg-indigo-50 text-#5d00ff rounded-[18px] flex items-center justify-center">
                                        ...
                                        {showFinancials && (
                                            <div className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm">
                                                ...
                                                <p className="text-3xl font-bold text-slate-900">{Math.round(client.totalSpent)} ₽</p>
                                            </div>
                                        )}
                                    </div>
                                            ...
                                            {client.orders.map(order => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-4">
                                                        <div className="w-12 h-12 rounded-[18px] bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-#5d00ff group-hover:text-white transition-all">
                                                            <ShoppingBag className="w-5 h-5" />
                                                        </div>
                                                        <div>
                                                            <p className="text-sm font-bold text-slate-900 group-hover:text-#5d00ff transition-colors">Заказ #{order.orderNumber}</p>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <Badge className="bg-indigo-50 text-#5d00ff border-none font-bold text-xs">{order.status}</Badge>
                                                        <ExternalLink className="w-4 h-4 text-slate-300 group-hover:text-#5d00ff transition-colors" />
                                                    </div>
                                                </a>
                                            ))}
                                        </div>
                            ...
                            <div className="pt-8 border-t border-slate-100">
                                <div className="flex items-center justify-between text-xs font-medium text-slate-400">
                                    ...
                                    <span className="text-#5d00ff">ID: {client.id ? client.id.slice(0, 8) : "---"}</span>
                                </div>
                            </div>
                        </div>
                    ) : (
