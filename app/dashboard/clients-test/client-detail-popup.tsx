                            ...
                            <div className="p-8 pr-16 border-b border-slate-100 bg-slate-50/50">
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                            ...
                                            {!confirmDelete && (
                                                <div className="flex items-center gap-1">
                                                    <button
                                                        ...
                                                        className="p-2 text-slate-400 hover:text-#5d00ff hover:bg-indigo-50 rounded-[18px] transition-all"
                                        ...
                                        {client.company && (
                                            <p className="text-lg font-medium text-#5d00ff mt-1">{client.company}</p>
                                        )}
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="flex flex-wrap justify-end gap-5">
                                            <div className="bg-white px-6 py-4 rounded-[18px] shadow-sm border border-slate-100 min-w-[100px] text-left transition-all hover:shadow-md">
                                            ...
                                            {showFinancials && (
                                                <div className="bg-white px-6 py-4 rounded-[18px] shadow-sm border border-slate-100 min-w-[140px] text-left transition-all hover:shadow-md">
                                            ...
                                            <ul className="space-y-3">
                                                <li>
                                                    <a
                                                        ...
                                                        className="flex items-center text-sm font-medium text-slate-700 hover:text-#5d00ff transition-colors group"
                                                    >
                                        ...
                                        <section>
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                {!isEditingComments ? (
                                                    <button
                                                        ...
                                                        className="p-1.5 text-slate-400 hover:text-#5d00ff hover:bg-indigo-50 rounded-[18px] transition-all"
                                                        title="Редактировать"
                                                    >
                                            ...
                                            {isEditingComments ? (
                                                <textarea
                                                    ...
                                                    className="w-full bg-slate-50 rounded-[18px] p-4 border border-indigo-200 text-sm text-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none min-h-[100px] resize-none transition-all"
                                                ...
                                                <div
                                                    onClick={() => setIsEditingComments(true)}
                                                    className="bg-slate-50 rounded-[18px] p-4 border border-slate-100 text-sm text-slate-600 whitespace-pre-wrap cursor-pointer hover:bg-slate-100/50 transition-colors group"
                                                >
                                            ...
                                            {(client.orders || []).slice((ordersPage - 1) * 3, ordersPage * 3).map((order) => (
                                                <div key={order.id} className="bg-white border border-slate-100 rounded-[18px] p-4 hover:shadow-md transition-shadow">
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <a href={`/dashboard/orders/${order.id}`} className="text-#5d00ff hover:text-indigo-700 text-sm font-medium">Подробнее</a>
                                                    </div>
                                                </div>
                                            ))}
