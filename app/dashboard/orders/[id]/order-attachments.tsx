            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {attachments.map((file: Attachment) => (
                    <a
                        ...
                        className="flex items-center gap-4 p-4 bg-slate-50/50 border border-slate-100 rounded-[18px] hover:border-primary/20 hover:bg-white hover:shadow-xl hover:shadow-primary/5 transition-all group"
                    >
                        <div className="h-12 w-12 rounded-[18px] bg-white shadow-sm border border-slate-100 flex items-center justify-center shrink-0 group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
                ...
                {attachments.length === 0 && (
                    <div
                        onClick={() => fileInputRef.current?.click()}
                        className="col-span-full border-2 border-dashed border-slate-100 rounded-[18px] p-10 text-center text-slate-400 cursor-pointer hover:border-primary/20 hover:bg-slate-50/50 transition-all group"
                    >
