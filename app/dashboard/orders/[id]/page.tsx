        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between bg-white p-6 rounded-[18px] border border-slate-200 shadow-sm">
                <div className="flex items-center space-x-6">
                    <Link href="/dashboard/orders" className="text-slate-400 hover:text-primary p-2.5 rounded-[18px] hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex gap-4">
                        <div className="w-48">
                            <label className="text-[10px] text-slate-400  font-bold tracking-[0.2em] block mb-2 px-1">Приоритет</label>
                            <PrioritySelect orderId={order.id} currentPriority={order.priority || 'normal'} />
                        </div>
                        <div className="w-56">
                            <label className="text-[10px] text-slate-400  font-bold tracking-[0.2em] block mb-2 px-1">Статус заказа</label>
                    ...
                    <div className="bg-white rounded-[18px] border border-slate-200 p-8 shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-slate-100">
                                <div className="text-[10px] font-bold text-slate-400  tracking-normal mb-2">Адрес доставки</div>
                            ...
                            <div className="space-y-4">
                                ...
                                {order.payments && order.payments.length > 0 && (
                                    <div className="mt-8 space-y-3">
                                        <div className="text-[10px] font-bold text-slate-400  tracking-normal mb-2 flex items-center">
                                            <Receipt className="w-3 h-3 mr-2" />
                                            История платежей
                                        </div>
                                        {order.payments.map((p: OrderPayment) => (
                                            <div key={p.id} className="flex justify-between items-center p-3 rounded-[18px] bg-slate-50 border border-slate-100">
