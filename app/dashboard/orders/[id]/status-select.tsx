                    ...
                    <div className="bg-white w-full max-w-md rounded-[24px] shadow-crm-xl p-8 border border-white animate-in zoom-in-95 duration-300">
                        ...
                        <div className="relative mb-6">
                            ...
                            <textarea
                                ...
                                className="w-full bg-slate-50 border border-slate-100 rounded-[18px] p-4 pl-12 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all outline-none resize-none h-32"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="h-12 rounded-[18px] text-sm font-bold text-slate-500 hover:bg-slate-50 transition-colors  tracking-normal"
                            >
                                Назад
                            </button>
                            <button
                                ...
                                className="h-12 bg-rose-500 text-white rounded-[18px] text-[11px] font-bold  tracking-[0.2em] shadow-lg shadow-rose-500/20 hover:bg-rose-600 transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
                            >
