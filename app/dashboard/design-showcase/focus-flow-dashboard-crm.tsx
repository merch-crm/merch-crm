            ...
            <aside className="w-20 md:w-[240px] bg-white border-r border-slate-50 p-6 flex flex-col shrink-0 relative z-10 transition-all">
                ...
                <div className="hidden md:flex flex-col gap-4 mt-auto">
                    <div className="bg-slate-50 rounded-[var(--radius-outer)] p-6 border border-slate-100 text-center relative overflow-hidden group">
                        ...
                        <h4 className="font-bold text-slate-900 text-xs uppercase tracking-widest mb-1">New Flow</h4>
                    ...
                    <div className="flex items-center gap-3 p-2 bg-slate-900 rounded-[var(--radius-inner)] shadow-xl shadow-slate-900/10">
                        ...
                        <div className="flex-1 overflow-hidden">
                            ...
                            <div className="text-[8px] font-bold text-primary uppercase tracking-widest">Admin</div>
                        </div>
                    </div>
                </div>
            </aside>
                ...
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-3">
                        <div className="px-3 py-1 bg-primary/10 border border-primary/20 rounded-full flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Deep Focus Session</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <button className="h-10 px-6 rounded-[var(--radius-inner)] btn-primary text-xs font-bold uppercase tracking-widest shadow-lg shadow-primary/20">Resume session</button>
                    </div>
                </div>
                            ...
                            <div className="relative h-48 flex items-end">
                                ...
                                <div className="relative z-10 w-full flex justify-between items-end pb-4">
                                    {["Jan", "Feb", "Mar", "Apr", "May", "Jun"].map(m => (
                                        <span key={m} className="text-[10px] font-bold uppercase tracking-widest text-slate-300">{m}</span>
                                    ))}
                                </div>
                            </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className="space-y-1">
                                        ...
                                        <div className="flex items-baseline gap-1">
                                            ...
                                            <span className="text-[8px] font-bold text-primary uppercase tracking-widest">{stat.unit}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                                ...
                                <div key={i} className="crm-card p-8 flex items-center justify-between group cursor-pointer">
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">{flow.meta}</p>
                                        </div>
                                    </div>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                            ...
                            <div className="relative z-10 space-y-8 w-full">
                                <div className="relative w-40 h-40 mx-auto">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        ...
                                        <div className="text-[10px] font-bold text-primary uppercase tracking-widest">Points</div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div className="blue-mesh rounded-[var(--radius-outer)] p-8 bg-slate-900 text-white shadow-2xl shadow-slate-900/40 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between min-h-[160px]">
                                ...
                                <button className="h-10 px-6 rounded-[var(--radius-inner)] bg-white text-slate-900 text-[10px] font-bold uppercase tracking-widest w-fit mt-6 hover:bg-primary hover:text-white transition-all shadow-md">Enable Node</button>
                            </div>
                        </div>

                        <div className="glass-panel p-6 flex flex-col gap-6 bg-white/50 border-white/80">
                            <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest border-b border-slate-50 pb-4">Live Connections</h4>
                            ...
                            <button className="w-full h-12 rounded-[var(--radius-inner)] bg-white border border-slate-100 hover:border-primary/40 hover:text-primary text-xs font-bold uppercase tracking-widest transition-all">Open Session</button>
                        </div>
                    </div>
