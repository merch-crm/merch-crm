                        ...
                        <div className="flex justify-between items-start mb-8">
                            <div>
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="w-8 h-8 rounded-[var(--radius-inner)] bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="crm-card p-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="text-xs font-bold text-slate-400 hover:text-slate-900 uppercase tracking-wider">See all</button>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="crm-card p-6 hover:shadow-crm-lg transition-shadow cursor-pointer">
                            ...
                            <div className="flex gap-2 mb-4">
                                <span className="px-3 py-1 bg-slate-100 rounded-[var(--radius-inner)] text-[10px] font-bold text-slate-500 uppercase tracking-wider">Remote</span>
                                <span className="px-3 py-1 bg-slate-100 rounded-[var(--radius-inner)] text-[10px] font-bold text-slate-500 uppercase tracking-wider">Part-time</span>
                            </div>
                            ...
                            <div className="flex items-center gap-4 text-[10px] text-slate-400 border-t border-slate-50 pt-4 font-medium">
                        ...
                        <div className="crm-card p-6 opacity-60 hover:opacity-100 hover:shadow-crm-lg transition-all cursor-pointer">
                            <div className="flex justify-between items-start mb-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="px-3 py-1 bg-slate-100 rounded-[var(--radius-inner)] text-[10px] font-bold text-slate-500 uppercase tracking-wider">Copyright</div>
                                </div>
                        ...
                        <div className="crm-card p-6 opacity-60 hover:opacity-100 hover:shadow-crm-lg transition-all cursor-pointer">
                            <div className="flex justify-between items-start mb-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="px-3 py-1 bg-slate-100 rounded-[var(--radius-inner)] text-[10px] font-bold text-slate-500 uppercase tracking-wider">Web Des...</div>
                                </div>
                                <div className="text-xs text-slate-400 font-medium">$10/hour</div>
                            </div>
                        </div>
