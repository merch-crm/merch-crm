                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Monday, 27 Jan 2025</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="flex items-center justify-between px-2">
                        ...
                        <button className="text-xs font-bold text-slate-400 hover:text-primary uppercase tracking-widest transition-colors flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="crm-card p-6 flex flex-col justify-between min-h-[160px] group">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mt-1">{device.room}</p>
                                </div>
                            </div>
                        ))}
                        ...
                        <button className="border-2 border-dashed border-slate-200 rounded-[var(--radius-outer)] p-6 min-h-[160px] flex flex-col items-center justify-center gap-3 text-slate-400 hover:border-primary/40 hover:text-primary hover:bg-primary/5 transition-all group">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest">Connect Device</span>
                        </button>
                    </div>
                    ...
                    <div className="crm-card p-0 overflow-hidden">
                        <div className="p-6 bg-slate-900 text-white flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs font-bold text-white/40 uppercase tracking-widest mt-1">Real-time stats</p>
                            </div>
                    ...
                    <div className="crm-card p-8 bg-slate-900 text-white relative flex flex-col items-center">
                        ...
                        <div className="relative w-48 h-48 mb-6">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <div className="text-[10px] uppercase font-bold tracking-widest text-primary mt-1">Optimal</div>
                            </div>
                        </div>
