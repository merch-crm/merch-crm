            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6 relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Inventory Management</span>
                            <span className="w-1 h-1 rounded-full bg-slate-300" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Invoices</span>
                        </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1">
                        <button className="w-12 h-12 flex items-center justify-center bg-white text-slate-900 rounded-[var(--radius-inner)] shadow-md hover:scale-110 active:scale-95 transition-all text-primary border border-slate-100">
                ...
                <div className="lg:col-span-8 flex flex-col gap-8">
                    ...
                    <div className="bg-slate-900 rounded-[var(--radius-outer)] p-10 text-white relative overflow-hidden shadow-2xl shadow-slate-900/20">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row justify-between gap-8">
                            <div>
                                <span className="text-xs font-bold uppercase tracking-widest text-white/50 mb-3 block">Total amount to pay</span>
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="bg-slate-50/50">
                                        ...
                                        <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">Tax</th>
                                        <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">Total</th>
                                    </tr>
                                </thead>
