                        ...
                        <div className="flex items-center justify-center mb-8">
                            <div className="relative w-48 h-48">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <div className="text-sm font-bold text-white/60 uppercase tracking-wider">All expenses</div>
                ...
                <div className="lg:col-span-4 glass-panel p-8 min-h-[400px] flex flex-col">
                    ...
                    <div className="relative w-full h-[180px] bg-gradient-to-br from-[#5d00ff] to-[#3a0099] rounded-[var(--radius-outer)] p-6 mb-6 shadow-xl shadow-[#5d00ff]/20">
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                            <div className="text-white/60 text-xs font-bold uppercase tracking-wider mb-2">Balance</div>
