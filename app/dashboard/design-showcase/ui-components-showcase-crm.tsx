        ...
        <div className="w-full glass-panel p-8 rounded-[var(--radius-outer)] mt-10 overflow-hidden relative min-h-[800px]">
            ...
            <div className="flex items-center justify-between mb-12 relative z-10">
                <div>
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mt-2">Design Components Library</p>
                </div>
                <div className="flex gap-2">
                    {["all", "forms", "widgets", "editors"].map((tab) => (
                        <button
                            ...
                            className={cn(
                                "px-5 py-2.5 rounded-[var(--radius-inner)] text-[10px] font-bold uppercase tracking-widest transition-all",
                                activeTab === tab
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
                ...
                <div className="lg:col-span-4 space-y-10">
                    ...
                    <div className="crm-card p-8 space-y-6">
                        ...
                        <div className="border-2 border-dashed border-slate-100 rounded-[var(--radius-inner)] p-10 flex flex-col items-center justify-center gap-4 group hover:border-primary/20 hover:bg-primary/5 transition-all cursor-pointer">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">SVG, PNG, JPG (Max 10MB)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 space-y-10">
                    <div className="crm-card p-8 space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 rounded-[var(--radius-inner)] bg-slate-50 border border-slate-100 group cursor-pointer hover:border-primary/20 transition-all">
                    ...
                    <div className="glass-panel p-8 bg-primary/5 border-2 border-primary/20 space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Global Event</p>
                            </div>
                        </div>
                        <div className="flex items-center justify-between p-5 bg-white rounded-[var(--radius-inner)] shadow-crm-sm border border-slate-100">
                ...
                <div className="lg:col-span-4 space-y-10">
                    <div className="crm-card p-8 space-y-8 min-h-[440px] flex flex-col">
                        ...
                        <div className="flex-1 border border-slate-100 rounded-[var(--radius-inner)] overflow-hidden flex flex-col">
                            <div className="p-3 bg-slate-50 border-b border-slate-100 flex flex-wrap gap-2">
                        ...
                        <div className="flex justify-end gap-3 mt-4">
                            <button className="h-10 px-6 rounded-[var(--radius-inner)] btn-secondary text-[10px] font-bold uppercase tracking-widest">Discard</button>
                            <button className="h-10 px-6 rounded-[var(--radius-inner)] btn-primary text-[10px] font-bold uppercase tracking-widest">Publish</button>
                        </div>
                    </div>
                </div>
            ...
            {/* Footer Meta */}
            <div className="mt-16 pt-8 border-t border-slate-100 flex items-center justify-between px-4 relative z-10">
                <div className="flex items-center gap-6">
                    ...
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Used by <span className="text-slate-900">12 designers</span> in this session</p>
                </div>
                <div className="flex items-center gap-2 bg-slate-50 px-4 py-2 rounded-full border border-slate-100 text-[10px] font-bold uppercase tracking-widest text-slate-400">
