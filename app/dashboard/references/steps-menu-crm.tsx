                ...
                <div className="lg:col-span-4">
                    <div className="bg-white rounded-[24px] border border-slate-100 shadow-crm-xl overflow-hidden flex flex-col min-h-[500px]">
                        ...
                        <div className="p-6 pt-0 mt-auto">
                            <div className="flex items-center justify-between p-5 bg-slate-50/50 backdrop-blur-md rounded-[var(--radius)] border border-slate-100 shadow-sm relative overflow-hidden">
