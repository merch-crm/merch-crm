            ...
            <AnimatePresence>
                {isHovered && (
                    <motion.div
                        ...
                        style={{ top: 0 }}
                        className="absolute left-full z-50 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] border border-slate-100 p-2 min-w-[200px]"
                    >
            ...
            <div className="flex gap-20">
                ...
                */}
                ...
                <div className="w-[280px] h-[700px] bg-white rounded-[2rem] shadow-[0_20px_50px_-20px_rgba(0,0,0,0.05)] p-5 flex flex-col relative overflow-visible">
                    {/* Toggle Button */}
                    <button className="absolute -right-3 top-12 w-6 h-6 bg-white rounded-full shadow-md flex items-center justify-center text-slate-400 hover:text-slate-600 border border-slate-100 z-10">
                        <ChevronLeft size={14} />
                    </button>
                    ...
                    <div className="flex items-center gap-3 px-2 mb-8 mt-2">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center justify-between bg-slate-50 p-1.5 rounded-lg border border-slate-100 cursor-pointer">
