        ...
        <div className="w-full glass-panel p-8 rounded-[var(--radius-outer)] mt-10 overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6 relative z-10">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            <span className="text-xs font-bold  tracking-normal text-slate-400">Monday, 27 Jan 2025</span>
                            <span className="w-1 h-1 rounded-full bg-slate-300" />
                            <div className="flex items-center gap-1.5 text-primary text-xs font-bold  tracking-normal">
                ...
                <div className="flex items-center gap-3">
                    <button className="w-12 h-12 rounded-[var(--radius-inner)] glass-panel flex items-center justify-center hover:scale-110 transition-transform">
                        <Search className="w-5 h-5 text-slate-600" />
                    </button>
                    <button className="h-12 px-6 rounded-[var(--radius-inner)] btn-primary flex items-center gap-2 text-sm font-bold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                ...
                <div className="lg:col-span-8 space-y-8">
                    <div className="flex items-center justify-between px-2">
                        ...
                        <button className="text-xs font-bold text-slate-400 hover:text-primary  tracking-normal transition-colors flex items-center gap-1">
                        ...
                        {[
                            ...
                            <div key={idx} className="crm-card p-6 flex flex-col justify-between min-h-[160px] group">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-bold  tracking-normal text-slate-400 mt-1">{device.room}</p>
                                </div>
                            </div>
                        ))}

                        {/* Add New Card Overlay */}
                        <button className="border-2 border-dashed border-slate-200 rounded-[var(--radius-outer)] p-6 min-h-[160px] flex flex-col items-center justify-center gap-3 text-slate-400 hover:border-primary/40 hover:text-primary hover:bg-primary/5 transition-all group">
                            ...
                            <span className="text-xs font-bold  tracking-normal">Connect Device</span>
                        </button>
                    </div>
                    ...
                    <div className="crm-card p-0 overflow-hidden">
                        <div className="p-6 bg-slate-900 text-white flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs font-bold text-white/40  tracking-normal mt-1">Real-time stats</p>
                            </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="crm-card p-8 bg-slate-900 text-white relative flex flex-col items-center">
                        <div className="absolute top-4 right-4">
                            <button className="w-10 h-10 rounded-[var(--radius-inner)] bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
                        ...
                        <div className="relative w-48 h-48 mb-6">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <div className="text-[10px]  font-bold tracking-normal text-primary mt-1">Optimal</div>
                            </div>
                        </div>

                        <div className="flex gap-4 w-full">
                            <button className="flex-1 h-12 rounded-[var(--radius-inner)] bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-all">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={idx} className={cn(
                                    ...
                                    scene.active ? (scene.color === "bg-slate-900" ? "bg-slate-900 text-white border-slate-800" : "bg-white text-slate-900 border-primary/40") : "bg-white text-slate-900 border-slate-100 opacity-60 hover:opacity-100"
                                )}>
                                    <div className={cn(
                                    ...
                                    <div className="text-xs font-bold  tracking-normal">{scene.name}</div>
                                </div>
                            ))}
                        </div>
