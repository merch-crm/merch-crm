        ...
        <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-2">
            {icons.map((item) => {
                ...
                return (
                    <div
                        key={item.name}
                        className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg bg-slate-50/50 hover:bg-white hover:shadow-lg hover:shadow-slate-100/50 border border-transparent hover:border-slate-100 transition-all cursor-pointer`}
                        title={item.name}
                    >
                        <div className={`w-9 h-9 rounded-full bg-white border border-slate-100 flex items-center justify-center text-slate-600 ${hoverColor} group-hover:scale-110 transition-all shadow-sm`}>
