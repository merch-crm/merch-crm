                                ...
                                <div className="flex flex-col justify-start items-center w-full">
                                    <div
                                        className={cn(
                                            ...
                                            formData.imagePreview ? "border-slate-200 bg-white" : "border-slate-200 bg-white shadow-inner hover:border-primary/20 hover:bg-slate-50"
                                        )}>
                                        <div ref={containerRef} className="absolute inset-0">
                                            {uploadStates.front?.uploading && loadingIndex === 0 ? (
                                                <div className="flex flex-col items-center justify-center gap-3 w-full h-full animate-in fade-in duration-300">
                                                    ...
                                                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest animate-pulse">Обработка...</span>
                                                </div>
                                            ) : formData.imagePreview ? (
                                                <>
                                                    <div
                                                    ...
                                                    <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-3 z-50 backdrop-blur-[2px]">
                                                        <label className="flex items-center gap-2 px-5 py-3 bg-white rounded-[var(--radius)] cursor-pointer hover:bg-slate-50 transition-all shadow-lg hover:scale-105 active:scale-95 group/btn">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-2 px-5 py-3 bg-rose-500 hover:bg-rose-600 border-none rounded-[var(--radius)] transition-all shadow-lg text-white hover:scale-105 active:scale-95 group/btn"
                                                        >
                                    ...
                                    <div className="space-y-4 flex-1 flex flex-col min-h-0">
                                        ...
                                        <div className="grid grid-cols-4 gap-3 pb-4">
                                            {formData.imageDetailsPreviews?.map((preview: string, idx: number) => (
                                                <div key={idx} className="relative aspect-square rounded-[var(--radius)] overflow-hidden border border-slate-100 shadow-sm group hover:scale-[1.02] transition-all">
                                            ...
                                            {(!formData.imageDetailsPreviews || formData.imageDetailsPreviews.length < 3) && (
                                                <label className="aspect-square rounded-[var(--radius)] border-2 border-dashed border-slate-200 bg-slate-50/50 hover:border-primary/20 hover:bg-white transition-all cursor-pointer flex flex-col items-center justify-center gap-2 group relative">
                                                    {uploadStates.details?.uploading && loadingIndex === (formData.imageDetailsPreviews?.length || 0) ? (
                                                        ...
                                                        <>
                                                            ...
                                                            <div className="w-9 h-9 rounded-full bg-white border border-slate-100 flex items-center justify-center shadow-sm group-hover:scale-110 group-hover:border-primary/20 transition-all">
    ...
    return (
        <div className="flex flex-col min-h-0 space-y-3 flex-1">
            ...
            <div className={cn(
                ...
                preview ? "border-slate-100 bg-white shadow-sm ring-1 ring-slate-100" : "border-slate-100 bg-slate-50/50 hover:border-primary/20 hover:bg-white"
            )}>
                {uploading ? (
                    ...
                    <>
                        ...
                        <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-all flex flex-col items-center justify-center gap-3 z-50 backdrop-blur-[2px]">
                            <label className="flex items-center gap-2 px-4 py-2 bg-white rounded-[18px] cursor-pointer hover:bg-slate-50 transition-all shadow-lg hover:scale-105 active:scale-95 group/btn">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-rose-500 hover:bg-rose-600 border-none rounded-[18px] transition-all shadow-lg text-white hover:scale-105 active:scale-95 group/btn"
                            >
