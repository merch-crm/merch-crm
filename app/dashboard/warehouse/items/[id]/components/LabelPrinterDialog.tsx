            ...
            <DialogContent className="max-w-5xl h-[90vh] p-0 gap-0 overflow-hidden bg-white rounded-3xl flex flex-col [&>button]:hidden">
                ...
                <div className="flex flex-1 min-h-0 h-full">
                    ...
                    <div className="w-[420px] bg-white border-r border-slate-200 flex flex-col h-full z-20 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)] overflow-hidden">
                        {/* 1. Header */}
                        <div className="flex-none px-6 py-5 border-b border-slate-100 bg-white relative z-10">
                        ...
                        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-6 space-y-5 custom-scrollbar relative">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {['58x40', '58x60', '75x120', 'a4', 'custom'].map((size) => (
                                        <button
                                            ...
                                            className={cn(
                                                "w-full h-11 rounded-xl text-xs font-black border-2 transition-all duration-200 uppercase flex items-center justify-center leading-none",
                                                paperSize === size
                                    ...
                                    <div className="grid grid-cols-2 gap-2 animate-in slide-in-from-top-2 fade-in duration-300">
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full pl-3 pr-8 py-2.5 bg-slate-50 border-2 border-transparent rounded-xl text-sm font-bold focus:outline-none focus:border-primary/20 focus:bg-white transition-all outline-none"
                                            />
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                "py-2.5 px-3 rounded-xl border-2 font-black text-[10px] uppercase tracking-wider transition-all",
                                                layoutStyle === style.id ? "bg-slate-900 border-slate-900 text-white shadow-md ring-2 ring-slate-900/10" : "bg-white border-slate-100 text-slate-400 hover:border-slate-200"
                                            )}
                                        >
                                            {style.label}
                                        </button>
                            ...
                            <div className={cn("space-y-2.5 transition-opacity", layoutStyle === 'minimal' && "opacity-40 pointer-events-none")}>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-slate-50 border-2 border-transparent rounded-xl text-sm font-bold focus:outline-none focus:border-primary/20 focus:bg-white transition-all outline-none"
                                />
                            </div>
                            ...
                            <div className="space-y-2.5 pb-2">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl border-2 border-slate-900 bg-slate-900 text-white font-black text-[10px] uppercase tracking-wider shadow-sm transition-all active:scale-[0.98]"
                                    >
                                    ...
                                    <div className="flex bg-slate-50 p-1 rounded-xl border-2 border-transparent">
                                        <button
                        ...
                        <div className="flex-none px-6 pt-5 pb-6 bg-white border-t border-slate-100 z-50 space-y-4 shadow-[0_-12px_30px_-15px_rgba(0,0,0,0.08)]">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2 bg-slate-50 p-1 rounded-[14px]">
                                    ...
                                    />
                                    <button onClick={() => setQuantity(quantity + 1)} className="w-8 h-8 rounded-xl bg-white border border-slate-100 flex items-center justify-center hover:bg-slate-100 text-slate-900 shadow-sm transition-all active:scale-90">
                            ...
                            <div className="flex gap-3">
                                <button
                                    className="h-12 w-16 rounded-[16px] bg-white border-2 border-slate-100 text-slate-900 flex items-center justify-center hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95 group shadow-sm"
                                    title="Скачать PDF"
                                >
                                ...
                                <button
                                    onClick={handlePrint}
                                    className="flex-1 h-12 bg-slate-900 hover:bg-black text-white rounded-[16px] font-black uppercase tracking-[0.2em] text-[10px] flex items-center justify-center gap-2.5 shadow-xl hover:shadow-2xl transition-all active:scale-[0.98] group"
                                >
                    ...
                    <div className="flex-1 bg-[#929292] relative overflow-hidden">
                            ...
                            >
                                ...
                                <div className={cn(
                                    ...
                                    {showCategory && item.category?.name && layoutStyle !== 'minimal' && (
                                        <div style={{ fontSize: `${7 * scale}px` }} className="font-black text-slate-400 uppercase tracking-widest leading-none mb-0.5">
                                            {item.category.name}
                                        </div>
                                    )}
                                    ...
                                    <div className={cn(
                                        ...
                                        {hasComposition && (
                                            <div
                                                ...
                                                className={cn(
                                                    "font-bold text-slate-700 leading-tight border-b border-slate-100 mt-1 w-full break-words",
                                ...
                                {/* Row 3: Footer */}
                                <div className={cn(
                                    "pt-1.5 border-t border-slate-100 flex gap-2 shrink-0",
                        ...
                        <div className="absolute bottom-8 right-8 px-4 py-2 bg-white/90 backdrop-blur-md rounded-full shadow-lg border border-slate-200 pointer-events-none">
                            <span className="text-[10px] font-black text-slate-900 tracking-widest uppercase flex items-center gap-2">
                                МАСШТАБ: {Math.round(previewScale * 100)}%
                                <span className="w-1 h-3 bg-slate-200 rounded-full" />
                                {isLandscape ? getSizeDimensions(paperSize).height.toUpperCase() : getSizeDimensions(paperSize).width.toUpperCase()}
                                <span className="text-slate-400">×</span>
                                {isLandscape ? getSizeDimensions(paperSize).width.toUpperCase() : getSizeDimensions(paperSize).height.toUpperCase()}
                            </span>
                        </div>
                    </div>
                </div>
...
function ToggleItem({ label, checked, onChange, compact }: { label: string; checked: boolean; onChange: (v: boolean) => void; compact?: boolean }) {
    return (
        <label className={cn(
            ...
            compact ? "p-2 rounded-xl hover:bg-slate-50/80" : "p-3 rounded-2xl hover:bg-slate-50"
        )}>
            <span className={cn(
