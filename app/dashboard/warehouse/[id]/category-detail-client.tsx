...
export function CategoryDetailClient({
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="px-2.5 py-1 rounded-[18px] bg-slate-100 text-slate-500 text-xs font-bold border border-slate-200/50 self-start mt-1">
                                    {items.length}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                            ...
                            <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex items-center bg-[#0F172A] text-white p-1.5 pl-2 gap-2 rounded-full shadow-2xl animate-in slide-in-from-bottom-6 fade-in duration-300 border border-slate-800">
                                ...
                                <div className="flex items-center gap-1">
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-3 py-2 rounded-[18px] hover:bg-white/10 transition-colors group"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-3 py-2 rounded-[18px] hover:bg-rose-500/10 transition-colors group"
                                    >
                                        <Trash2 className="w-4 h-4 text-rose-500" />
                                        <span className="text-xs font-bold text-rose-500 group-hover:text-rose-400 transition-colors">Удалить</span>
                                    </button>
                                </div>
                        ...
                        <Button
                            ...
                            className="h-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[18px] px-6 gap-2 font-bold shadow-xl shadow-indigo-100 transition-all active:scale-95"
                        >
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center bg-white p-6 rounded-[18px] border border-slate-200/60 shadow-sm transition-all hover:shadow-md">
                <div className="relative flex-1 w-full group">
                    ...
                    <input
                        ...
                        className="w-full h-14 pl-14 pr-6 rounded-[18px] bg-slate-50 border border-transparent focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 outline-none font-medium text-slate-900 transition-all"
                    />
                </div>
                ...
                <div className="flex items-center p-1.5 bg-slate-50 rounded-full border border-slate-200/60 shrink-0 gap-1 shadow-sm shadow-slate-100/50">
                    <div className="relative pl-1">
                        <button
                            ...
                            className="h-10 pl-5 pr-9 rounded-full bg-transparent text-xs font-bold text-indigo-600 outline-none transition-colors hover:bg-white hover:shadow-sm flex items-center whitespace-nowrap group"
                        >
                        ...
                        {isStorageOpen && (
                            <>
                                ...
                                <div className="absolute top-full mt-3 left-0 min-w-[200px] bg-slate-800/95 backdrop-blur-xl rounded-[18px] shadow-2xl shadow-slate-400/20 overflow-hidden z-50 flex flex-col p-1.5 animate-in fade-in zoom-in-95 duration-200 border border-slate-700">
                                    <button
                                        onClick={() => { setFilterStorage("all"); setIsStorageOpen(false); }}
                                        className={cn(
                                            "w-full text-left px-4 py-3 rounded-[18px] text-xs font-bold transition-all flex items-center gap-3",
                                            filterStorage === "all"
                        ...
                        {subCategories.map((subcat) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="group bg-white border border-slate-200/60 rounded-[18px] p-5 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 hover:border-indigo-100 cursor-pointer flex items-center justify-between relative overflow-hidden"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={cn(
                                            "w-10 h-10 rounded-[18px] flex items-center justify-center transition-all",
                                            colorStyle
                                        )}>
                                    ...
                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                                        <button
                                            ...
                                            className="w-8 h-8 flex items-center justify-center rounded-[18px] text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 transition-all"
                                            title="Редактировать"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="w-8 h-8 flex items-center justify-center rounded-[18px] text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-all"
                                            title="Удалить"
                                        >
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-4">
                                                            <div className="w-12 h-12 rounded-[18px] bg-slate-100 overflow-hidden border border-slate-200 shrink-0 relative">
                                                                {item.image ? (
                                                                    <Image
                                                                        src={item.image}
                                                                        alt={item.name}
                                                            ...
                                                            <div>
                                                                <div className="text-sm font-bold text-slate-900 leading-tight group-hover:text-indigo-600 transition-colors">{item.name}</div>
                                                    ...
                                                    <td className="px-6 py-4 text-center">
                                                        <div className="flex flex-col items-center gap-1">
                                                            <div className={cn(
                                                                "inline-flex items-center px-4 py-2 rounded-xl text-sm font-black transition-all shadow-sm",
                                                                isCritical ? "bg-rose-500 text-white ring-4 ring-rose-500/10 animate-pulse" :
                                                                    isLowStock ? "bg-amber-500 text-white ring-4 ring-amber-500/10" :
                                                    ...
                                                    <td className="px-6 py-4 text-right" onClick={(e) => e.stopPropagation()}>
                                                        <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-all">
                                                            <button
                                                                className="w-9 h-9 flex items-center justify-center bg-white border border-slate-200 rounded-[18px] text-slate-400 hover:text-emerald-500 hover:border-emerald-200 transition-all shadow-sm"
                                                            ...
                                                            <button
                                                                className="w-9 h-9 flex items-center justify-center bg-white border border-slate-200 rounded-[18px] text-slate-400 hover:text-indigo-600 hover:border-indigo-200 transition-all shadow-sm"
                                                                onClick={() => router.push(`/dashboard/warehouse/items/${item.id}`)}
                                                                title="Редактировать"
                                                            >
                                                            ...
                                                            <button
                                                                className="w-9 h-9 flex items-center justify-center bg-white border border-slate-200 rounded-[18px] text-slate-400 hover:text-rose-500 hover:border-rose-200 transition-all shadow-sm"
            ...
            <div className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 animate-in zoom-in-95">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 font-medium mt-1">Перемещение {selectedIds.length} позиций</p>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            className="w-full h-24 p-4 rounded-[18px] border border-slate-100 bg-slate-50 text-sm font-medium outline-none focus:bg-white focus:border-indigo-500 transition-all resize-none"
                    ...
                    <Button
                        ...
                        className="w-full h-12 bg-slate-900 text-white rounded-[18px] font-bold transition-all active:scale-95 shadow-lg shadow-slate-200"
                    >
