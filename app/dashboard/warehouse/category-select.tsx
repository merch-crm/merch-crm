    ...
    return (
        <div className="relative" ref={containerRef}>
            <button
                ...
                className={cn(
                    "w-full h-12 px-4 rounded-[var(--radius)] border flex items-center justify-between transition-all outline-none group",
            ...
            {isOpen && (
                <div
                    className="absolute top-full left-0 right-0 mt-3 z-[70] bg-white rounded-[14px] border border-slate-200/60 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300 shadow-crm-xl"
                >
                    <div className="p-3 border-b border-slate-50 bg-slate-50/30">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full h-10 pl-9 pr-4 rounded-[var(--radius-inner)] bg-white border border-slate-100 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary/20 transition-all text-sm font-medium"
                            />
                        </div>
                    </div>
                            ...
                            filteredCategories.map(cat => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className={cn(
                                                "w-9 h-9 rounded-[var(--radius-inner)] flex items-center justify-center shrink-0 shadow-sm transition-transform group-hover:scale-110",
                                                colorStyles
                                            )}>
