    ...
    return (
        <div className="h-[calc(100vh-130px)] flex flex-col overflow-hidden bg-slate-50/50">
            <div className="px-8 pt-6 shrink-0">
                <Breadcrumbs
                    items={[
                        { label: "Клиенты", href: "/dashboard/clients", icon: User },
                        { label: "Новый клиент" }
                    ]}
                />
            </div>
            ...
            <div className="flex-1 flex min-h-0 gap-6 px-8 pb-8 pt-4">
                ...
                <aside className="w-[320px] bg-white border border-slate-200 rounded-[24px] flex flex-col shrink-0 relative z-20 h-full shadow-lg overflow-hidden">
                    <div className="p-6 shrink-0">
                        ...
                        <p className="text-[11px] text-slate-500 font-bold opacity-60 mt-1 uppercase tracking-wider">
                    ...
                    <div className="bg-white rounded-[24px] shadow-lg border border-slate-200/60 overflow-hidden flex flex-col h-full min-h-0">
                        <div className="flex-1 overflow-y-auto p-10 space-y-8">
                            {step === 0 && (
                                <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="space-y-4">
                                        <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Тип клиента</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Фамилия *</label>
                                            <input
                                                type="text"
                                                value={formData.lastName}
                                                onChange={(e) => updateFormData({ lastName: e.target.value })}
                                                className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 font-bold text-sm focus:border-slate-900 focus:bg-white transition-all outline-none"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Имя *</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Отчество</label>
                                            <input
                                                type="text"
                            ...
                            {step === 1 && (
                                <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Соцсеть</label>
                                            <input
                                                type="text"
                            ...
                            {step === 2 && (
                                <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Менеджер</label>
                                            <select
                                                value={formData.managerId}
                                                onChange={(e) => updateFormData({ managerId: e.target.value })}
                                                className="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 font-bold text-sm focus:border-slate-900 focus:bg-white transition-all outline-none appearance-none cursor-pointer"
                                            >
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Город</label>
                                            <input
                                                type="text"
                                                value={formData.city}
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Источник (откуда пришел)</label>
                                            <select
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Адрес</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Комментарии</label>
                                        <textarea
                                            value={formData.comments}
                                            onChange={(e) => updateFormData({ comments: e.target.value })}
                                            rows={4}
                                            className="w-full p-4 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 font-bold text-sm focus:border-slate-900 focus:bg-white transition-all outline-none resize-none"
                                        />
                                    </div>

                                    {duplicates.length > 0 && (
                                        <div className="p-4 rounded-2xl bg-amber-50 border border-amber-100 space-y-3">
                                            <div className="text-amber-800 font-black text-xs uppercase tracking-wider">
                                            ...
                                            <div className="space-y-2">
                                                {duplicates.map(dup => (
                                                    <div key={dup.id} className="flex items-center justify-between bg-white/50 p-2 rounded-xl border border-amber-200/50">
                                                        ...
                                                        <a href={`/dashboard/clients?id=${dup.id}`} target="_blank" className="text-[10px] font-black text-slate-900 uppercase">Открыть</a>
                                                    </div>
                                                ))}
                                            </div>
                        ...
                        <div className="px-10 py-6 border-t border-slate-100 flex justify-between items-center bg-slate-50/30">
                            ...
                            <div className="flex gap-4">
                                <button
                                    onClick={handleBack}
                                    className="px-6 py-3 rounded-xl border border-slate-200 text-sm font-bold text-slate-400 hover:text-slate-900 bg-white transition-all"
                                >
                                    Назад
                                </button>
                                {step < 2 ? (
                                    <button
                                        onClick={handleNext}
                                        className="px-8 py-3 rounded-xl bg-slate-900 text-white text-sm font-bold shadow-lg hover:bg-slate-800 transition-all"
                                    >
                                        Далее
                                    </button>
                                ) : (
                                    <button
                                        ...
                                        disabled={loading}
                                        className="px-8 py-3 rounded-xl bg-slate-900 text-white text-sm font-bold shadow-lg hover:bg-slate-800 disabled:opacity-50 transition-all"
                                    >
