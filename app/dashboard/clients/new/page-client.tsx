                ...
                <div className="bg-white rounded-[24px] shadow-lg border border-slate-200/60 overflow-hidden flex flex-col h-full min-h-0">
                    <div className="flex-1 overflow-y-auto p-10 space-y-8">
                        {step === 0 && (
                            <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="space-y-4">
                                    <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Тип клиента</label>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Фамилия *</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Имя *</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Отчество</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">
                        ...
                        {step === 1 && (
                            <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Телефон *</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Email</label>
                                        <input
                                            type="email"
                                ...
                                <div className="grid grid-cols-3 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Telegram</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Instagram</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Соцсеть</label>
                                        <input
                                            type="text"
                        ...
                        {step === 2 && (
                            <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Менеджер</label>
                                        <select
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Город</label>
                                        <input
                                            type="text"
                                            value={formData.city}
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Источник (откуда пришел)</label>
                                        <select
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Адрес</label>
                                        <input
                                            type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-bold text-slate-400  tracking-normal ml-1">Комментарии</label>
                                    <textarea
                    ...
                    <div className="px-10 py-6 border-t border-slate-100 flex justify-between items-center bg-slate-50/30">
                        ...
                        <div className="flex gap-4">
                            <button
                                onClick={handleBack}
                                className="px-6 py-3 rounded-[18px] border border-slate-200 text-sm font-bold text-slate-400 hover:text-slate-900 bg-white transition-all"
                            >
                                Назад
                            </button>
                            {step < 2 ? (
                                <button
                                    onClick={handleNext}
                                    className="px-8 py-3 btn-primary rounded-[18px] text-sm font-bold shadow-lg transition-all"
                                >
                                    Далее
                                </button>
                            ) : (
                                <button
                                    ...
                                    disabled={loading}
                                    className="px-8 py-3 btn-primary rounded-[18px] text-sm font-bold shadow-lg disabled:opacity-50 transition-all"
                                >
