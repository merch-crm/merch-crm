...
export async function globalSearch(query: string): Promise<{ data: SearchResult[] }> {
    ...
    try {
        ...
        const navigationPages = [
            ...
            { title: "Промокоды", href: "/dashboard/admin/promocodes", keywords: ["промокоды", "скидки", "акции", "админ"], deps: ["Руководство", "Отдел продаж"] },
            { title: "Финансы", href: "/dashboard/finance", keywords: ["финансы", "деньги", "касса", "отчеты"], deps: ["Руководство"] },
            { title: "Сотрудники", href: "/dashboard/admin/users", keywords: ["сотрудники", "пользователи", "права", "админ"], deps: ["Руководство"] },
            ...
            { title: "Админ-панель", href: "/dashboard/admin", keywords: ["админ", "панель", "управление", "settings"], deps: ["Руководство"] },
            { title: "Брендинг", href: "/dashboard/admin/branding", keywords: ["логотип", "цвета", "админ", "настройки"], deps: ["Руководство"] },
            { title: "Безопасность", href: "/dashboard/admin/security", keywords: ["логи", "входы", "админ", "безопасность"], deps: ["Руководство"] },
        ...
        const results: SearchResult[] = [
            ...
            ...foundPromocodes.map(p => ({
                ...
                href: `/dashboard/admin/promocodes?id=${p.id}`,
