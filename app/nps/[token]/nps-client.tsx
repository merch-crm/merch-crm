    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-6 rounded-2xl text-lg font-semibold transition-all shadow-lg shadow-indigo-200" onClick={() => window.close()}
          >
            Закрыть
          </Button>
        </motion.div>
          ...
          <AnimatePresence>
            {score !== null && (
              ...
              >
                ...
                <Button disabled={submitting} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-8 rounded-[1.25rem] text-xl font-bold transition-all shadow-xl shadow-indigo-100 active:scale-95 disabled:opacity-50" onClick={handleSubmit}>
