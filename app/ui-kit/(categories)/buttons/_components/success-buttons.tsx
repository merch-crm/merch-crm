    ...
    >
      <div className="flex flex-col gap-3">
        <div className="flex flex-wrap gap-3 items-center">
          <CrmButton variant="success"><Check className="size-4 mr-2" />Принято</CrmButton>
          <CrmButton variant="success"><CheckCircle2 className="size-4 mr-2" />Готово</CrmButton>
          <CrmButton variant="success" size="icon"><ShieldCheck className="size-5" /></CrmButton>
        </div>
        <div className="flex flex-wrap gap-3 items-center">
