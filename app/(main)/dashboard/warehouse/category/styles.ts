...
export const getColorStyles = (color: string | null | undefined) => {
  ...
  if (color && !color.startsWith("#")) {
    const c = color;
    const styles: Record<string, string> = {"slate":"bg-slate-50 border border-slate-200 text-slate-600","red":"bg-rose-50 border border-rose-100 text-rose-500","orange":"bg-orange-50 border border-orange-100 text-orange-500","amber":"bg-amber-50 border border-amber-100 text-amber-500","yellow":"bg-yellow-50 border border-yellow-100 text-yellow-500","lime":"bg-lime-50 border border-lime-100 text-lime-600","green":"bg-emerald-50 border border-emerald-100 text-emerald-500","emerald":"bg-emerald-50 border border-emerald-100 text-emerald-500","teal":"bg-teal-50 border border-teal-100 text-teal-600","cyan":"bg-cyan-50 border border-cyan-100 text-cyan-500","sky":"bg-sky-50 border border-sky-100 text-sky-500","blue":"bg-blue-50 border border-blue-100 text-blue-500","primary":"bg-primary/5 border border-primary/10 text-primary","indigo":"bg-primary/5 border border-primary/10 text-primary","violet":"bg-violet-50 border border-violet-100 text-violet-500","purple":"bg-purple-50 border border-purple-100 text-purple-500","fuchsia":"bg-fuchsia-50 border border-fuchsia-100 text-fuchsia-500","pink":"bg-pink-50 border border-pink-100 text-pink-500","rose":"bg-rose-50 border border-rose-100 text-rose-500",
    };
