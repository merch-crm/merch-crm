...
export const ALL_ICONS_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
    // Lucide Icons"box": Box,"package": Package,"warehouse": Warehouse,"truck": Truck,"plane": Plane,"archive": Archive,"barcode": Barcode,"layers": Layers,"file-text": FileText,"scale": Scale,"factory": Factory,"printer": Printer,"brush": Brush,"palette": Palette,"scissors": Scissors,"hammer": Hammer,"wrench": Wrench,"ruler": Ruler,"pencil": Pencil,"pen-tool": PenTool,"pipette": Pipette,"flask-conical": FlaskConical,"flask": FlaskConical,"circle-dollar-sign": CircleDollarSign,"dollar": CircleDollarSign,"wallet": Wallet,"trending-up": TrendingUp,"shopping-cart": ShoppingCart,"gift": Gift,"users": Users,"user-check": UserCheck,"mail": Mail,"phone": Phone,"home": Home,"settings": Settings,"lock": Lock,"shield": Shield,"check-circle": CheckCircle2,"zap": Zap,"info": Info,"search": Search,"bell": Bell,"calendar": Calendar,"hourglass": Hourglass,"eye": Eye,"sparkles": Sparkles,"ship": Ship,"database": Database,"dollar-sign": DollarSign,"user": User,"trash": Trash,

    // Custom Icons (Legacy Mapping to Phosphor Set)"tshirt-custom": CustomTshirt,"hoodie-custom": CustomHoodie,"sweatshirt-custom": CustomHoodie, // Redirect to Hoodie"longsleeve-custom": CustomTshirt, // Redirect to Tshirt"anorak-custom": CustomJacket,     // Redirect to Jacket"ziphoodie-custom": CustomHoodie,  // Redirect to Hoodie"pants-custom": CustomPants,"polo-custom": CustomTshirt,       // Redirect to Tshirt"cap-custom": CustomCap,"jacket-custom": CustomJacket,"sneakers-custom": CustomSneakers,"beanie-custom": CustomCap,        // Redirect to Cap"backpack-custom": CustomBackpack,"totebag-custom": CustomToteBag,"socks-custom": CustomBoots,       // Redirect to Boots"shorts-custom": CustomPants,      // Redirect to Pants"skirt-custom": CustomDress,       // Redirect to Dress"vest-custom": CustomJacket,       // Redirect to Jacket"gloves-custom": CustomBackpack,   // Redirect to Backpack"scarf-custom": CustomBelt,        // Redirect to Belt"badge-custom": CustomTag,         // Redirect to Tag"sticker-custom": CustomSparkles,  // Redirect to Sparkles"mug-custom": CustomMug,"notebook-custom": CustomNotebook,"umbrella-custom": CustomUmbrella,"inventory-custom": CustomPackage,"packaging-custom": CustomPackage,"supplies-custom": CustomSupplies,"dress-custom": CustomDress,"boots-custom": CustomBoots,"glasses-custom": CustomGlasses,"watch-custom": CustomWatch,"handbag-custom": CustomHandbag,"tag-custom": CustomTag,"baby-custom": CustomBaby,"crown-custom": CustomCrown,"sparkles-custom": CustomSparkles,"discount-custom": CustomDiscount,"heart-custom": CustomHeart,"star-custom": CustomStar,"flame-custom": CustomFlame,"belt-custom": CustomBelt,"wallet-custom": CustomWallet,
};
