              ...
              <thead className="crm-thead">
                <tr>
                  <th className="crm-th crm-td-selection">
                    <Checkbox checked={(items?.length || 0)> 0 && (items || []).every(i => selectedIds.includes(i.id))}
                    ...
                    >
                      ...
                      <td className="crm-td crm-td-actions" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1 transition-all">
                          <Button type="button" variant="ghost" size="icon" onClick={() => handlePrintLabel(item)}
                          ...
                          <Button type="button" variant="ghost" size="icon" onClick={() => handleOpenAdjust(item)}
