...
export const BulkMoveDialog = React.memo(({
  ...
  return (
    <ResponsiveModal isOpen={isOpen} onClose={onClose} title="Массовое перемещение" className="sm:max-w-md">
      <div className="p-6 space-y-3">
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <StorageLocationSelect id="bulk-move-target" value={targetLocationId} onChange={setTargetLocationId} options={storageLocations} placeholder="Выберите склад…" />
          </div>
...
export const BulkCategoryDialog = React.memo(({
  ...
  return (
    <ResponsiveModal isOpen={isOpen} onClose={onClose} title="Смена категории" description={`${selectedIds.length} поз. выбрано`} className="sm:max-w-md">
      <div className="p-6 space-y-3">
        <div className="space-y-1.5">
