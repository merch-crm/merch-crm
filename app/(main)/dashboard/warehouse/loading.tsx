        ...
        <div className="animate-pulse">
            ...
            <div className="flex flex-wrap gap-3">
                {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} className="flex-grow flex-shrink basis-full sm:basis-[calc(50%-12px)] lg:basis-[calc(33.333%-12px)] xl:basis-[calc(25%-12px)] min-w-[280px]">
                        <div className="flex flex-col h-[220px] crm-card p-0 overflow-hidden bg-white shadow-sm border border-slate-100 w-full">
                            {/* Header skeleton */}
