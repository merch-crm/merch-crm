                    ...
                    <div key={i} className="crm-card flex flex-col gap-4 shadow-sm">
                        <div className="flex items-start justify-between relative z-10">
                            <div className="flex items-center gap-5">
                                <div className="w-14 h-14 rounded-[var(--radius-inner)] bg-slate-50 flex items-center justify-center animate-pulse" />
                                <div>
                                    <div className="h-6 w-32 bg-slate-50 rounded animate-pulse mb-2" />
