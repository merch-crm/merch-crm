  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-12 gap-3">
        <StatsOverview totalStorages={totalStorages} totalItems={totalItems} totalQuantity={totalQuantity} totalCategories={totalCategories} totalReserved={totalReserved} archivedCount={archivedCount} />
        <StockAlerts criticalItems={criticalItems} />
      </div>

      {/* Financial Bento Row */}
      <FinancialBento financials={financials} currencySymbol={currencySymbol} />

      {/* Activity Trend */}
      <ActivityTrend activity={activity} />

      {/* Analytics Row: Top Sold & Stagnant */}
      <InventoryAnalytics topSoldItems={topSoldItems} stagnantItems={stagnantItems} />
