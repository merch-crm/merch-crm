                        ...
                        {isDimensions ? (
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    "h-9 rounded-lg border-2 font-bold text-xs transition-all",
                            ...
                            <div className="space-y-3 pt-2 w-full col-span-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="w-32">
                                        <Select
                                            value={isWeight ? customForm.weightUnit : customForm.volumeUnit}
                                            onChange={v => setCustomForm(prev => ({
                                                ...prev,
                                ...
                                <div className="space-y-2">
                                    {customForm.composition.map((item, index) => (
                                        <div key={index} className="flex gap-2">
                                            <Input
                                                className="flex-1 h-11 rounded-[var(--radius-inner)] bg-white border-slate-200 font-bold"
                                            ...
                                            <div className="w-24 relative">
                                                <Input
                                                    type="number"
                                                    className="h-11 pr-8 rounded-[var(--radius-inner)] bg-white border-slate-200 text-center font-bold"
                                                    placeholder="0"
                                                    value={item.percent}
                                                    onChange={e => {
                                                        const newComp = [...customForm.composition];
                                            ...
                                            {customForm.composition.length > 1 && (
                                                <Button
                                                    ...
                                                    variant="ghost"
                                                    size="icon"
                                                    className="h-11 w-11 shrink-0 rounded-[var(--radius-inner)] text-rose-500 hover:bg-rose-50 border border-transparent hover:border-rose-100"
                                                    onClick={() => {
                                                        setCustomForm(prev => ({
                                                            ...prev,
                            ...
                            <>
                                                ...
                                                <div className="flex gap-2">
                                                    <div className="flex-1 relative">
                                                        <Input
                                                            ...
                                                            placeholder="0"
                                                            className={cn(
                                                                "h-12 rounded-[var(--radius-inner)] bg-white border-slate-200 font-bold",
                                                                hasComposition && "pr-8"
                                                            )}
                                                        />
                                                        {hasComposition && (
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        placeholder="SIN"
                                        className={cn(
                                            "w-full h-12 px-4 rounded-[var(--radius-inner)] bg-slate-50 border border-slate-200 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none font-mono transition-all placeholder:text-slate-300 placeholder:font-medium font-bold text-sm text-slate-900 shadow-sm",
