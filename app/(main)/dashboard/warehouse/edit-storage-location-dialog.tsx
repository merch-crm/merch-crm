...
function EditStorageLocationInner({ users, locations, location, isOpen, onClose }: EditStorageLocationDialogProps & { location: StorageLocation; }) {
  ...
  return (
    <>
      <ResponsiveModal isOpen={isOpen} onClose={onClose} title="Редактирование локации" showVisualTitle={false} className="sm:max-w-[720px]">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="md:hidden px-5 pb-6 space-y-3">
              ...
              <div className="pt-6 border-t border-slate-100">
                ...
                <LocationItemsList currentPage={ui.currentPage} itemsPerPage={ITEMS_PER_PAGE} localItems={localItems} setCurrentPage={(p) => setUi(prev => ({ ...prev, currentPage: p }))}
      ...
      {
        ui.transferItem && (
          <QuickTransferModal item={ui.transferItem} currentLocationId={location.id} locations={locations} onClose={() => setUi(prev => ({ ...prev, transferItem: null }))}
