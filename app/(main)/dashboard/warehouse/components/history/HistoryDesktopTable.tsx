...
import { Package, ArrowUpRight, ArrowDownLeft, Book, ArrowRight, ArrowLeftRight, User, Building2, Clock } from "lucide-react";
                            ...
                            >
                                ...
                                <td className="crm-td">
                                    {t.item ? (
                                        <button
                                            type="button"
                                            className="flex items-center gap-3 cursor-pointer group/item hover:opacity-80 transition-all p-0 border-none bg-transparent"
