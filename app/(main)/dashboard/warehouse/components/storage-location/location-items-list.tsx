...
export function LocationItemsList({
  ...
  return (
    <div className="space-y-3 h-full flex flex-col">
      ...
      {totalPages > 1 && (
        <div className="pt-4">
          <Pagination currentPage={currentPage} totalItems={localItems?.length || 0} pageSize={itemsPerPage} onPageChange={setCurrentPage} itemNames={['товар', 'товара', 'товаров']} variant="light" />
        </div>
      )}
    </div>
  );
