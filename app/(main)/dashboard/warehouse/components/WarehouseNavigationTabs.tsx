                ...
                {WAREHOUSE_TABS.map((tab) => {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                "flex-1 h-[44px] relative flex items-center justify-center !rounded-[14px] transition-all duration-300",
                ...
                {WAREHOUSE_TABS.map((tab) => {
                    ...
                    return (
                        <Link
                            ...
                            aria-selected={isActive}
                            className={cn(
                                "flex-auto h-full px-3 sm:px-4 shrink-0 text-[12px] sm:text-[14px] font-bold relative flex items-center justify-center gap-2 group transition-colors duration-200 !rounded-[16px]",
