    ...
    <div className="space-y-2">
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1.5">
          ...
          <Input type="number" value={valueForm.length} onChange={e => updateDimensionStrings(e.target.value, valueForm.width, valueForm.height, valueForm.dimensionUnit)}
            placeholder="0"
        ...
        <div className="space-y-1.5">
          ...
          <Input type="number" value={valueForm.width} onChange={e => updateDimensionStrings(valueForm.length, e.target.value, valueForm.height, valueForm.dimensionUnit)}
            placeholder="0"
            className="h-11 rounded-xl bg-white border-slate-100 font-bold text-center shadow-sm focus:border-primary transition-all"
            required
          />
        ...
        <div className="space-y-1.5">
          ...
          <Input type="number" value={valueForm.height} onChange={e => updateDimensionStrings(valueForm.length, valueForm.width, e.target.value, valueForm.dimensionUnit)}
            placeholder="0"
            className="h-11 rounded-xl bg-white border-slate-100 font-bold text-center shadow-sm focus:border-primary transition-all"
            required
          />
