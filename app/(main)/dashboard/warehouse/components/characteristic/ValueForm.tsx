...
export function ValueForm({
  ...
  const getPlaceholders = () => {
    ...
    if (type === "unit") return { full: "Напр: сантиметры", short: "Напр: см", code: "CM" };
        ...
        <div className="flex-1 w-full flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar px-6 pb-6 space-y-3">
            ...
            <div className="space-y-3">
              ...
              {!hideNames && !isDensity && (
                <StandardFields valueForm={valueForm} setValueForm={setValueForm} typeForm={typeForm} setTypeForm={setTypeForm} showShortName={showShortName} isConsumable={isConsumable} placeholders={placeholders} />
              )}
              ...
              {(isColorType || isConsumable || typeForm.hasColor) && (
                <div className="space-y-1.5 pt-2 animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="flex items-center justify-between ml-1 mb-1">
                    ...
                    {isConsumable && (
                      <Switch checked={typeForm.hasColor} onCheckedChange={(val: boolean) => setTypeForm((prev: TypeFormState) => ({ ...prev, hasColor: val }))}
              ...
              {!showCompositionEditor && (
                <div className="space-y-1.5 pt-2">
                  ...
                  <Input value={valueForm.code} readOnly={isDimensions} maxLength={4} onChange={e => {
