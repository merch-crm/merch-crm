...
export function EditTypeDialog({
  ...
  return (
    <ResponsiveModal isOpen={!!typeForm.editingType} onClose={() => {
    ...
    >
      <div className="flex flex-col h-full md:overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row flex-1 md:overflow-hidden">
          ...
          <ValueForm valueForm={valueForm} setValueForm={setValueForm} handleValueSave={handleValueSave} setDeleteDialog={setDeleteDialog} attributeTypes={attributeTypes} typeForm={typeForm} setTypeForm={setTypeForm} />
        </div>
