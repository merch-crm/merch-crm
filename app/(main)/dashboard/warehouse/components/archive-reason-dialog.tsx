...
export function ArchiveReasonDialog({
  ...
  const footerContent = (
    <div className="p-5 pt-3 flex items-center justify-end gap-2.5 bg-white/95 backdrop-blur-md border-t border-slate-100">
      <Button 
        type="button" 
        variant="ghost" 
        color="neutral"
      ...
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="p-6 pb-2 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3 text-left">
            <div className="w-12 h-12 rounded-lg bg-amber-50 text-amber-500 flex items-center justify-center shrink-0 shadow-sm border border-amber-100">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5 pt-2">
              ...
              <textarea
                ...
                placeholder="…"
                className={cn("w-full min-h-[140px] p-4 rounded-lg border text-sm font-semibold transition-all outline-none resize-none placeholder:text-slate-300",
                  error
