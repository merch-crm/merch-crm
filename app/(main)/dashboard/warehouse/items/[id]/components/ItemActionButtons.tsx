        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 md:mt-0 xl:mt-0">
            ...
            <Button
                ...
                className={cn(
                    "group aspect-square h-auto flex flex-col items-center justify-center",
                    "bg-card rounded-3xl border border-border shadow-sm",
                    "hover:border-emerald-500 hover:bg-emerald-500 hover:text-white hover:shadow-xl hover:shadow-emerald-500/20",
                    "transition-all text-muted-foreground order-last md:hidden",
                    tabletTab !== 'characteristic' && "hidden"
                )}
                title="Экспорт PDF"
            ...
            <Button
                ...
                className={cn(
                    "group aspect-square h-auto flex flex-col items-center justify-center",
                    "bg-card rounded-3xl border border-border shadow-sm",
                    "hover:border-rose-500 hover:bg-rose-500 hover:text-white hover:shadow-xl hover:shadow-rose-500/20",
                    "transition-all text-muted-foreground order-last md:hidden",
                    tabletTab !== 'characteristic' && "hidden"
                )}
                title="Архивировать"
