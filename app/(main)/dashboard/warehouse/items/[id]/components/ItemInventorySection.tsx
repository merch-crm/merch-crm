  ...
  return (
    <div className="space-y-3 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="w-full md:w-[300px] lg:w-[400px] crm-card !bg-slate-900 !border-slate-800 sm: !rounded-2xl text-white flex flex-col justify-between group overflow-hidden relative shadow-xl">
          {/* Decorative flow */}
      ...
      {isEditing && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 animate-in slide-in-from-top-4 duration-500">
          <div className="crm-card !rounded-2xl space-y-3">
            ...
            <Input type="number" value={editData.lowStockThreshold} onChange={(e) => onUpdateField("lowStockThreshold", parseInt(e.target.value))}
          ...
          <div className="crm-card !rounded-2xl space-y-3">
            ...
            <Input type="number" value={editData.criticalStockThreshold} onChange={(e) => onUpdateField("criticalStockThreshold", parseInt(e.target.value))}
