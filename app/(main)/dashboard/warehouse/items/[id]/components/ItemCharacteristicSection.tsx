    ...
    <div className={
      ...
      <div className="flex flex-col xl:flex-row gap-3 min-h-[400px]">
        ...
        <div className="w-full xl:w-[42%] xl:min-w-[320px] shrink-0 xl:border-r border-slate-100/60 flex flex-col relative h-[350px] xl:h-auto pr-0 xl:pr-8">
          <ItemImagePreview item={item} isEditing={isEditing} thumbSettings={thumbSettings} baseScale={baseScale} handleMainMouseDown={handleMainMouseDown} setAspectRatio={setAspectRatio} updateThumb={updateThumb} openGallery={openGallery} />
                  ...
                  <div className="space-y-1 sm:space-y-3">
                    ...
                    {item.printDesign && (
                      <div className="mt-4 pt-4 border-t border-slate-100">
                        ...
                        <Link href={`/dashboard/design/prints/${item.printDesignId}`} className="inline-flex items-center text-sm font-bold text-primary hover:underline">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="flex items-center justify-between gap-3 mb-8">
          ...
          {isEditing && (
            <Link href="/dashboard/warehouse?tab=characteristic" target="_blank" className="flex items-center gap-1.5 text-sm font-bold text-blue-500 hover:text-blue-600 transition-colors">
        ...
        <div className="flex-1 min-h-0">
          <ItemGeneralInfo item={item} isEditing={isEditing} allAttributes={allAttributes} attributeTypes={attributeTypes} editData={editData} onUpdateField={(field, value) => {
