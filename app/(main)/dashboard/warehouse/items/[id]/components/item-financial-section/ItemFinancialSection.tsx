  ...
  return (
    <div className={cn("flex flex-col gap-3", className)}>
      ...
      <div className="crm-card transition-all bg-card relative overflow-hidden flex flex-col gap-3 hover:shadow-md duration-500">
        ...
        <FinancialMetricsGrid item={item} weightedAverageCost={weightedAverageCost} lastInCostPrice={lastInCostPrice} currencySymbol={currencySymbol} isEditing={isEditing} editData={editData} setEditData={setEditData} handleStartEdit={handleStartEdit} />
      ...
      <div className="crm-card transition-all bg-card relative overflow-hidden flex flex-col gap-3 hover:shadow-md duration-500">
        <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-3 relative z-10">
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-col mt-0.5">
              ...
              <PriceAnalyticsSummary actualMax={costHistoryStats.actualMax} avg={costHistoryStats.avg} actualMin={costHistoryStats.actualMin} currencySymbol={currencySymbol} />
            </div>
          </div>
        ...
        <div className="flex flex-col gap-3 mt-1">
          {/* SVG Chart */}
          <PriceHistoryChart points={costHistoryStats.points} min={costHistoryStats.min} max={costHistoryStats.max} currencySymbol={currencySymbol} timeframe={timeframe} />
        </div>
      </div>
    </div>
  );
