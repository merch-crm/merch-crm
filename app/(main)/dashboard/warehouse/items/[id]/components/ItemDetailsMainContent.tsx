  ...
  return (
    <>
      <div className="md:col-span-2 xl:col-span-12">
        <ItemTabsSwitcher tabletTab={tabletTab} setTabletTab={setTabletTab} />
      </div>
      ...
      <div className="flex flex-col gap-3 md:col-span-2 xl:col-span-8">
        ...
        <div className="xl:hidden">
          <ItemActionButtons setAdjustType={setAdjustType} setShowLabelDialog={(val) => setDialogs((prev) => ({ ...prev, label: val }))}
        ...
        <ItemFinancialSection item={item} history={history} isEditing={isEditing} editData={editData} setEditData={setEditData} handleStartEdit={handleStartEdit} user={user} className={cn("xl:flex", tabletTab === 'cost' ? "flex" : "hidden" )} timeframe={timeframe} setTimeframe={setTimeframe} />
      </div>

      {/* RIGHT COLUMN/SIDEBAR: Placement, Alerts */}
      <div className="flex flex-col gap-3 md:col-span-2 xl:col-span-4">
        <ItemPlacementWrapper item={item} storageLocations={storageLocations} stocks={stocks} isEditing={isEditing} editData={editData} setEditData={setEditData as unknown as React.Dispatch<React.SetStateAction<Partial<InventoryItem>>>}
      ...
      <div className={cn(
        ...
        <ItemActiveOrdersWrapper activeOrders={activeOrders} reservedQuantity={reservedQuantity} tabletTab={tabletTab} />
      </div>
      ...
      <div className={cn(
        ...
        <ItemMediaSection item={item} isEditing={isEditing} onImageChange={handleImageUpdate} onImageRemove={handleImageRemove} />
      </div>

      <ItemHistoryWrapper history={history} onExport={handleExportHistory} tabletTab={tabletTab} />
    </>
  );
}
