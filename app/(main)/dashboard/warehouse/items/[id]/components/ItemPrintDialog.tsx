            ...
            <div className="flex flex-col h-full overflow-hidden print:hidden">
                ...
                <div className="px-6 py-6 space-y-6 bg-white overflow-y-auto flex-1 custom-scrollbar">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div id="label-to-print" className="bg-white p-5 rounded-2xl shadow-2xl shadow-slate-200/50 border border-slate-200 flex flex-col items-center gap-4 w-[240px] aspect-[1/1.4] justify-between transition-transform hover:scale-[1.02]">
                            ...
                            <div className="w-full text-center">
                                <div className="bg-slate-900 text-white py-2 px-4 rounded-2xl font-black text-xs shadow-lg shadow-slate-900/20">
                                    {item.sku || "NO-SKU"}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="w-10 h-10 rounded-2xl border border-slate-200 flex items-center justify-center hover:bg-slate-50 transition-all active:scale-90"
                                >
                                    <ChevronLeft className="w-4 h-4 text-slate-400" />
                                </button>
                                <div className="flex-1 h-10 bg-slate-50 rounded-2xl flex items-center justify-center font-bold text-sm text-slate-900 border border-slate-200 tabular-nums">
                                    {copies}
                                </div>
                                <button
