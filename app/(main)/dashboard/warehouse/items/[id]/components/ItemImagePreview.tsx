                    ...
                    {item.image ? (
                        <div className="absolute inset-0 overflow-hidden">
                            <Image
                                ...
                                priority
                                style={{
                                    transform: `scale(${((isEditing ? currentSettings?.zoom : item.thumbnailSettings?.zoom) ?? 1) * baseScale}) translate(${(isEditing ? currentSettings?.x : item.thumbnailSettings?.x) ?? 0}%, ${(isEditing ? currentSettings?.y : item.thumbnailSettings?.y) ?? 0}%)`,
