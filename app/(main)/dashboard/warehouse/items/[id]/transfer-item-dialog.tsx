          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <LocationSelect locations={availableFromLocations as unknown as StorageLocation[]} value={fromLocationId} onChange={setFromLocationId} excludeId={toLocationId} placeholder="Выберите склад…" stocks={stockMap as unknown as Map<string, number>}
                />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700 block mb-2 ml-1">Куда (получатель)</label>
                <LocationSelect locations={locations as unknown as StorageLocation[]} value={toLocationId} onChange={setToLocationId} excludeId={fromLocationId} placeholder="Выберите склад…" stocks={stockMap as unknown as Map<string, number>}
                />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
              <div className="flex-1 space-y-2">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl flex items-stretch p-1.5 h-[72px] shadow-inner transition-all group focus-within:ring-4 focus-within:ring-primary/5 focus-within:border-primary/20">
                  ...
                  <div className="flex-1 flex items-center justify-center gap-1.5 relative px-2">
                    <Input type="number" inputMode="numeric" required min={0} value={amount} onChange={(e) => {
              ...
              <div className="flex-1">
                {fromLocationId && fromStock > 0 ? (
                  ...
                  <div className="h-[72px] w-full rounded-xl border border-dashed border-slate-200 bg-slate-50/50 flex items-center justify-center">
            ...
            <div className="space-y-2 mt-2">
              ...
              <textarea
                ...
                className="w-full min-h-[80px] p-3 rounded-xl border border-slate-200 bg-slate-50 text-sm font-bold text-slate-900 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all resize-none placeholder:text-slate-300 leading-snug shadow-sm"
              />
            </div>

            {error && (
              <div className="flex items-center gap-2 p-3 rounded-xl bg-rose-50 text-rose-600 border border-rose-100 animate-in slide-in-from-top-2">
