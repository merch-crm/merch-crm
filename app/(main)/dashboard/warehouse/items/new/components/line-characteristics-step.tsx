  ...
  return (
    <div className="flex flex-col h-full min-h-0 !overflow-visible">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {availableAttributes.map((attr) => {
                  ...
                  return (
                    ...
                    >
                      {/* Селектор значения */}
                      <AttributeSelector type={attr.code} label={attr.name} value={selectedValue || ""} onChange={(_name: string, value: string) => handleAttributeValueChange(attr.code, value)}
                        allowCustom={true}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <div className="space-y-3">
              ...
              <div className="p-6 rounded-[28px] bg-slate-50 border border-slate-100 h-full">
                <Textarea value={lineDescription} onChange={(e) => onLineDescriptionChange(e.target.value)}
      ...
      <div className="mt-auto shrink-0 border-t border-slate-100 bg-white/50 backdrop-blur-sm">
        <StepFooter onBack={onBack} onNext={onNext} validationError={undefined} />
      </div>
    </div>
  );
}
