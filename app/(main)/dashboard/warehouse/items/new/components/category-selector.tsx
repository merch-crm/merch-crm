    ...
    return (
        <div className="w-full h-full xl:h-full flex flex-col min-h-0">
            ...
            <div
                ...
                className={cn("w-full min-h-0 transition-all",
                    // Desktop (xl+): horizontal flex scroll, explicit h-full to fill parent"xl:flex xl:h-full xl:flex-row xl:items-start xl:overflow-x-auto xl:px-1.5 xl:-mx-1.5 xl:snap-x xl:snap-mandatory xl:hide-scrollbar xl:gap-3 xl:overscroll-x-none xl:touch-pan-x xl:scroll-px-1.5",
                    // Mobile/Tablet: grid that fills height"grid gap-2 sm:gap-3 flex-1 h-full"
                )}
                style={{
                        ...
                        return (
                            <button
                                ...
                                className={cn("group flex flex-col items-center justify-center gap-2 border transition-all text-center duration-200 outline-none cursor-pointer overflow-hidden",
                                    // Desktop: fixed square compact tiles"xl:h-auto xl:w-[90px] xl:shrink-0 xl:aspect-square xl:snap-start xl:p-2",
                                    // Mobile: fills grid cell"h-full p-2 sm:p-3","rounded-[16px] sm:rounded-[18px]",
                                    isSelected
                    ...
                    return (
                        <button
                            ...
                            className={cn("group flex flex-col items-center justify-center gap-1 transition-all text-center h-full duration-200 outline-none cursor-pointer overflow-hidden border",
                                // Desktop snap"xl:snap-start xl:shrink-0 xl:w-[calc(25%-9px)] xl:min-w-[190px] xl:max-w-[240px]",
                                // Padding & radius
