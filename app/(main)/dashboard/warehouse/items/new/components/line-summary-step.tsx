  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="mt-auto shrink-0">
        <StepFooter onBack={onBack} onNext={onSubmit} nextLabel={ isSubmitting ? "Создание..." : `Создать ${positions.length} ${formatPlural(positions.length, ["позицию", "позиции", "позиций"])}` } isNextDisabled={isSubmitting} isSubmitting={isSubmitting} />
      </div>
    </div>
  );
}
