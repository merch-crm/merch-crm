  ...
  const renderInput = (
    ...
    <div className={cn("space-y-1.5", className)}>
      ...
      <div className="relative">
        <Input type={type} value={value || ""} onChange={(e) => updateFormData({ [field]: e.target.value })}
  ...
  return (
    <div className="flex flex-col h-full !overflow-visible">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-2 p-1 bg-slate-100 rounded-[14px]">
                  <Button variant="ghost" onClick={() => updateFormData({ packagingType: "individual" })}
                  ...
                  <Button variant="ghost" onClick={() => updateFormData({ packagingType: "transport" })}
                    className={cn("h-9 flex-1 rounded-[10px] text-xs font-bold transition-all shadow-none",
              ...
              <div className="space-y-1.5">
                ...
                <Select label="" placeholder="Выберите бренд" options={brands.map(b => ({ id: b.id, title: b.name }))}
          ...
          <section className="space-y-2.5 pb-3">
            ...
            <div className="grid grid-cols-12 gap-2.5">
              ...
              <div className="col-span-12 md:col-span-5 space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select options={[ { id: "S", title: "S - Маленький" }, { id: "M", title: "M - Средний" }, { id: "L", title: "L - Большой" }, { id: "XL", title: "XL - Очень большой" }, ]} value={formData.sizeCode || ""} onChange={(val) => updateFormData({ sizeCode: val })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Select label="" placeholder="Выберите материал" options={materials.map(m => ({ id: m.id, title: m.name }))}
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap gap-2">
                  {CLOTHING_COLORS.map(c => {
                    ...
                    return (
                      <Button key={c.code} variant="ghost" onClick={() => updateFormData({ attributeCode: c.code })}
          ...
          <section className="space-y-3 pb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={formData.supplierLink || ""} onChange={(e) => updateFormData({ supplierLink: e.target.value })}
                  placeholder="https://..."
      ...
      <div className="mt-auto shrink-0">
        <StepFooter onBack={onBack} onNext={() => {
            // Basic validation
