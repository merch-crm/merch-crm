              ...
              {isUploading ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center gap-2 z-50 backdrop-blur-[2px]">
                    ...
                    <Button onClick={(e) => { e.preventDefault(); onRemove(idx); }}
                      size="icon"
            ...
            {isUploading ? (
              ...
              <>
                ...
                <div className={cn(
                  ...
                  <Plus className={cn( "w-4 h-4 transition-colors", isNextSlot ? "text-slate-400 group-hover:text-primary" : "text-slate-300" )} />
                </div>
                <span className={cn(
