...
export default async function NewItemPage({
  ...
  return (
    <NewItemPageClient categories={categories} storageLocations={storageLocations} dynamicAttributes={dynamicAttributes} attributeTypes={attributeTypes as AttributeType[]} users={users} initialCategoryId={categoryId} initialSubcategoryId={subcategoryId} />
  );
}
