                ...
                <div className="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white rounded-[18px] p-6 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 group">
                        <div className="flex justify-between items-start mb-6">
                            <div className="w-10 h-10 rounded-[18px] bg-slate-50 text-primary flex items-center justify-center border border-slate-200 transition-all">
                ...
                <div className="col-span-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Link href={primaryAction.href} className="group flex flex-col">
                        <div className="h-full bg-primary rounded-[18px] p-6 flex flex-col items-center justify-center gap-4 text-white shadow-lg shadow-primary/20 hover:opacity-90 transition-all duration-300">
                            <div className="w-16 h-16 rounded-[18px] bg-white/10 flex items-center justify-center border border-white/20 transition-all">
                    ...
                    {actions.map((action) => (
                        <Link key={action.name} href={action.href} className="group">
                            <div className="h-full bg-white rounded-[18px] p-6 flex flex-col items-center justify-center gap-4 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300">
                                <div className={cn("w-16 h-16 rounded-[18px] flex items-center justify-center transition-all", action.color === "bg-primary" ? "bg-primary/10" : action.color.replace('bg-', 'bg-').replace('500', '50'))}>
                    ...
                    <div className="space-y-3">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((note) => (
                                <div key={note.id} className="flex items-center justify-between p-4 rounded-[18px] bg-slate-50 border border-slate-200/50 hover:bg-slate-100 transition-colors">
                                    <div className="flex items-center gap-4">
                                        <div className={cn(
