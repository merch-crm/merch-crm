            ...
            <CardContent className="space-y-3">
              ...
              <FormField control={form.control} name="description" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Детальное описание задачи..." {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField control={form.control} name="quantity" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" min={1} {...field} value={field.value || 0} onChange={e => field.onChange({ target: { value: Number(e.target.value) } })}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
              ...
              <FormField control={form.control} name="priority" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value || "normal"} onChange={field.onChange} options={[ { id: "low", title: "Низкий" }, { id: "normal", title: "Обычный" }, { id: "high", title: "Высокий" }, { id: "urgent", title: "Срочный" } ]} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <CardContent className="space-y-3">
              <FormField control={form.control} name="applicationTypeId" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value || ""} onChange={field.onChange} placeholder="Выберите тип" options={applicationTypes .filter((t) => t.isActive)
              ...
              <FormField control={form.control} name="lineId" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value || ""} onChange={field.onChange} placeholder="Выберите линию" options={lines .filter((l) => l.isActive)
              ...
              <FormField control={form.control} name="assigneeId" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value || ""} onChange={field.onChange} placeholder="Выберите исполнителя" options={staff .filter((s) => s.isActive)
            ...
            <CardContent className="space-y-3">
                  ...
                  <FormItem className="flex flex-col">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar mode="single" selected={field.value || undefined} onSelect={field.onChange} disabled={(date) =>
              ...
              <FormField control={form.control} name="estimatedTime" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min={0} placeholder="60" {...field} value={field.value || 0} onChange={e => field.onChange({ target: { value: Number(e.target.value) } })}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField control={form.control} name="notes" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Дополнительные заметки..." {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
