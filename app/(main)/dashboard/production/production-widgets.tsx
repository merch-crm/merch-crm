            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="crm-card relative group">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-bold  text-primary bg-primary/5 px-2 py-1 rounded-full">KPI</span>
                    </div>
                    <div>
                        <div className="text-4xl md:text-5xl font-bold text-slate-900 mb-1">{stats.efficiency}%</div>
                ...
                <div className="crm-card relative group">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-bold  text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">Сегодня</span>
                    </div>
                    <div>
                        <div className="text-4xl md:text-5xl font-bold text-slate-900 mb-1">{stats.completedToday}</div>
