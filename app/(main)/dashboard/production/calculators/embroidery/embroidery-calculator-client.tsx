...
export function EmbroideryCalculatorClient() {
  ...
  return (
    <BaseCalculatorForm
      ...
      filesSectionTitle={`Файлы ${term.itemGenitive} (DST)`}
      beforeFilesContent={beforeFilesContent}
      afterFilesContent={afterFilesContent}
    >
      <CalculatorSection title="Основные параметры">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <div className="space-y-3">
            ...
            <Select
              options={EMBROIDERY_FABRIC_TYPES.map(t => ({ id: t.value, title: t.label }))}
          ...
          <div className="space-y-3">
            ...
            <Select
              options={STABILIZER_TYPES.map(t => ({ id: t.value, title: t.label }))}
          ...
          <div className="space-y-3">
            ...
            <Select
              options={MACHINE_HEAD_OPTIONS.map(o => ({ id: String(o.value), title: o.label }))}
