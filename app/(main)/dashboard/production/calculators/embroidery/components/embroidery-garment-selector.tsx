        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-[400px] overflow-y-auto pr-2 scrollbar-hide">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant="outline" className="text-xs font-bold border-slate-200 text-slate-400">
          ...
          {filteredGarments.length === 0 && (
            <div className="col-span-full py-12 text-center">
              ...
              <Button variant="link" onClick={() => { setSearchQuery(''); setActiveCategory('all'); }} className="text-pink-600 font-bold">
                Сбросить фильтры
              </Button>
            </div>
          )}
