   ...
   <Card className="p-4 ring-2 ring-pink-500 bg-pink-50/20 border-pink-100">
    <div className="flex flex-col gap-3">
     <div className="grid grid-cols-2 gap-3">
      ...
      <div className="flex flex-col gap-1">
       ...
       <div className="flex items-center gap-2">
        <Input type="number" value={editValues.widthMm} onChange={(e) => {
        ...
        <Input type="number" value={editValues.heightMm} onChange={(e) => {
      ...
      <div className="flex flex-col gap-1">
       ...
       <Input type="number" value={editValues.stitchCount} onChange={(e) => setEditValues(v => ({ ...v, stitchCount: parseInt(e.target.value) || 0 }))}
        min={100}
       />
      </div>
      ...
      <div className="flex flex-col gap-1">
       ...
       <Input type="number" value={editValues.colorsCount} onChange={(e) => setEditValues(v => ({ ...v, colorsCount: parseInt(e.target.value) || 1 }))}
        min={1}
        max={15}
       />
      </div>
      ...
      <div className="flex flex-col gap-1">
       ...
       <Select value={editValues.density} onChange={(value) => {
      ...
      <div className="flex flex-col gap-1 border-t pt-2 col-span-2">
       ...
       <Select value={editValues.threadType} onChange={(value) => setEditValues(v => ({ ...v, threadType: value as ThreadType }))}
     ...
     <div className="flex items-center gap-3 p-4 bg-white/60 rounded-xl border border-pink-100 shadow-inner">
      <Switch checked={editValues.hasDigitizing} onCheckedChange={(checked) => setEditValues(v => ({ ...v, hasDigitizing: checked }))}
      />
   ...
   <div className="p-6">
    ...
    {designs.length > 0 ? (
     <div className="space-y-3 mb-6">
      {designs.map(design => (
       <DesignCard key={design.id} design={design} onUpdate={(updates: Partial<EmbroideryDesign>) => onUpdate(design.id, updates)}
