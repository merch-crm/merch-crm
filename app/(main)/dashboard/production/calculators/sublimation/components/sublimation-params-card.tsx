      ...
      <div className="p-4 sm:p-6 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={params.rollWidthMm.toString()}
          ...
          <div className="space-y-1.5">
            ...
            <Input
                ...
                min={0}
                max={50}
                className="bg-slate-50 border-slate-200 rounded-xl focus:ring-primary/20"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
                type="number"
                value={params.printGapMm}
                onChange={handlePrintGapChange}
                min={0}
                max={20}
                className="bg-slate-50 border-slate-200 rounded-xl focus:ring-primary/20"
            />
