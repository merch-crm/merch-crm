    ...
    <div className="p-6 space-y-3">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
       ...
       <div className="space-y-1.5">
        ...
        <Select value={params.fabricType} onChange={handleFabricTypeChange} options={fabricTypeOptions} triggerClassName="bg-slate-50 border-slate-200 rounded-xl" />
       </div>
       ...
       <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
         ...
         <div className="relative">
          <Input type="number" value={params.widthM} onChange={handleWidthChange} min={0.1} max={3} step={0.1} className="bg-slate-50 border-slate-200 rounded-xl h-10 pr-8" />
        ...
        <div className="space-y-1.5">
         ...
         <Input type="number" value={params.quantity} onChange={handleQuantityChange} min={1} max={100} className="bg-slate-50 border-slate-200 rounded-xl h-10" />
        </div>
       </div>
     </div>
     ...
     <div className="space-y-3 pt-2">
      ...
      <Slider value={[params.lengthM]} onValueChange={handleLengthChange} min={0.1} max={10} step={0.1} className="py-2" />
