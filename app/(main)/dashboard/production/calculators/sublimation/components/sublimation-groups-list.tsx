  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3">
        {groups.map((group, index) => (
          <PrintGroupCard
            ...
            onUpdate={(updates: Partial<PrintGroupInput>) => handleGroupChange(index, updates)}
      ...
      <Button
        ...
        className="w-full h-14 border-2 border-dashed border-slate-200 rounded-[24px] bg-slate-50 text-slate-500 hover:bg-slate-100 hover:border-slate-300 hover:text-slate-600 font-bold transition-all"
      >
