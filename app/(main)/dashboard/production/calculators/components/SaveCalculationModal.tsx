...
export function SaveCalculationModal({
  ...
  return (
    <ResponsiveModal
      ...
      description="Введите название для сохранения расчёта в историю"
      footer={
        <div className="flex justify-end gap-3 w-full">
          <Button
            ...
            variant="outline"
            onClick={handleClose}
            className="rounded-[12px] h-11 px-6 font-semibold"
          >
            Отмена
          </Button>
          <SubmitButton
            ...
            form="save-calculation-form"
            className="rounded-[12px] h-11 px-6 font-semibold bg-slate-900 hover:bg-slate-800 text-white"
          >
            Сохранить
          </SubmitButton>
        </div>
