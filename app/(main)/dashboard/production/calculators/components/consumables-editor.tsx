      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative w-32">
          <Input
            ...
            className="pr-12 text-sm text-right font-medium"
            min={min}
            max={max}
            step={step}
          />
  ...
  return (
    <div className="space-y-3 p-4 bg-slate-50 rounded-xl">
      ...
      <Slider
        ...
        step={5}
        className={cn(
          color === 'green' && "[&_[role=slider]]:bg-green-500",
          color === 'amber' && "[&_[role=slider]]:bg-amber-500",
          color === 'red' && "[&_[role=slider]]:bg-red-500"
        )}
      />
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-3">
          <PercentSlider
            label="Заполнение макета"
            value={config.fillPercent}
            onChange={(v) => handleFieldChange('fillPercent', v)}
          ...
          <PercentSlider
            ...
            onChange={(v) => handleFieldChange('wastePercent', v)}
