...
interface DownloadPdfButtonProps {
  ...
  variant?: "solid" | "outline" | "solid" | "ghost";
  size?: "md" | "sm" | "lg" | "icon";
  className?: string;
}
...
export const DownloadPdfButton = memo(function DownloadPdfButton({
  ...
  if (!canvasRef) {
    return (
      <Button variant={variant} size={size} onClick={handleQuickDownload} disabled={isGenerating} className={className}>
        {isGenerating ? (
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem onClick={() => handleDownload("withCanvas")}
          disabled={isGenerating}
        >
