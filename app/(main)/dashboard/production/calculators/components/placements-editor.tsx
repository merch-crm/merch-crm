        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <div className="relative mt-1">
              <Input
                type="number"
                value={editValues.workPrice}
                onChange={(e) => setEditValues(v => ({ ...v, workPrice: parseFloat(e.target.value) || 0 }))}
                className="pr-8"
              />
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setEditValues(v => ({ ...v, widthMm: parseInt(e.target.value) || 0 }))}
              className="mt-1"
            />
          </div>
          <div>
            ...
            <Input
              ...
              onChange={(e) => setEditValues(v => ({ ...v, heightMm: parseInt(e.target.value) || 0 }))}
              className="mt-1"
            />
          </div>
        </div>
      ...
      <div className="space-y-2">
        {sortedPlacements.map(placement => (
          <PlacementRow
            key={placement.id}
            placement={placement}
            isEditing={editingId === placement.id}
            onStartEdit={() => handleStartEdit(placement.id)}
