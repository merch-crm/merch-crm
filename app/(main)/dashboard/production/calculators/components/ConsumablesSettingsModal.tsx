...
export function ConsumablesSettingsModal({
  ...
  return (
    ...
    <ResponsiveModal
      isOpen={isOpen}
      onClose={onClose}
      title={`Настройки расходников — ${config.label}`}
      description="Настройте стоимость и расход материалов для расчёта себестоимости"
      footer={
    ...
    >
                  ...
                  return (
                    <ConsumableItemEditor
                      ...
                      warehouseItems={warehouseItems.filter(
                        (w) => w.category === item.category || !item.category
                      )}
      ...
      <CreateWarehouseItemModal
        isOpen={!!warehouseCreateCategory}
        onClose={() => setWarehouseCreateCategory(null)}
