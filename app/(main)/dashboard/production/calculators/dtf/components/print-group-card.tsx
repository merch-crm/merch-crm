    ...
    return (
        <Card
            className={cn(
                ...
                isFilled && "ring-2 ring-offset-2",
            )}
            style={{
                borderColor: group.color + "40",
                ...(isFilled && { "--tw-ring-color": group.color + "40" } as React.CSSProperties),
            }}
        >
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-3">
                        ...
                        <div className="flex gap-3">
                            ...
                            {/* Image Uploader */}
                            <ImageUploader
                                imagePreview={group.imagePreview}
                                onImageChange={(preview) => onUpdate({ imagePreview: preview })}
                        ...
                        {/* Row 3: Quick Sizes */}
                        <QuickSizeButtons
                            currentWidth={group.widthMm}
                            currentHeight={group.heightMm}
                            onSelect={(widthMm, heightMm) => onUpdate({ widthMm, heightMm })}
                        />
                        ...
                        <Select
                            ...
                            value={group.placementId || ""}
                            onChange={(value) => onUpdate({ placementId: value || null })}
