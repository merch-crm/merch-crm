...
export function DTGCalculatorClient() {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="space-y-3">
          <div className="space-y-2">
            ...
            <Select
              ...
              value={params.pretreatmentType || ''}
              onChange={(val) => updateParams({ pretreatmentType: val as DTGCalculatorParams['pretreatmentType'] })}
          ...
          <div className="space-y-2">
            ...
            <Select
              options={whitePassOptions}
              value={String(params.whitePassCount || '')}
              onChange={(val) => updateParams({ whitePassCount: parseInt(val) as DTGCalculatorParams['whitePassCount'] })}
        ...
        <div className="flex flex-col justify-center space-y-3">
          <div className={cn(
            ...
            <Switch
              checked={params.whiteUnderbase}
              onCheckedChange={(checked) => updateParams({ whiteUnderbase: checked })}
              disabled={params.garmentColor === 'dark'}
            />
          </div>
  ...
  return (
    <BaseCalculatorForm
      ...
      beforeFilesContent={technologySection}
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateParams({ quantity: Math.max(1, parseInt(e.target.value) || 1) })}
                />
              </div>
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  value={String(params.printResolution || '')}
                  onChange={(val) => updateParams({ printResolution: parseInt(val) as DTGCalculatorParams['printResolution'] })}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onChange={(val) => updateParams({ inkType: val as DTGCalculatorParams['inkType'] })}
                />
              </div>
            </div>
          </div>
