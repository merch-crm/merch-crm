 ...
 return (
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
   {consumption.map((item, index) => (
    <Card key={index} className="p-6 rounded-[28px] border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all border-none bg-white">
     <div className={cn(
