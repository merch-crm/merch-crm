...
export function DefectDialog({ orderItemId, maxQuantity, itemName }: DefectDialogProps) {
  ...
  return (
    <>
      <Button variant="ghost" onClick={(e) => { e.stopPropagation(); setIsOpen(true); }}
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="p-6 pt-2 bg-slate-50/50 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-3">
            ...
            <Button type="button" onClick={handleReport} disabled={isPending} className="w-full sm:flex-1 h-12 rounded-2xl font-bold bg-rose-500 hover:bg-rose-600 text-white shadow-lg shadow-rose-200">
