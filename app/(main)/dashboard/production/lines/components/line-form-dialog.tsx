          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            <FormField control={form.control} name="applicationTypeId" render={({ field }) => (
                <FormItem>
                  ...
                  <Select options={[ { id: "none", title: "Не указан" }, ...applicationTypes.map((type) => ({
                        id: type.id,
                        title: type.name,
            ...
            <FormField control={form.control} name="color" render={({ field }) => (
                <FormItem>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <FormControl>
                      <Input type="text" placeholder="#3B82F6" className="w-24" {...field} value={field.value || ""} />
                    </FormControl>
                  </div>
                  <FormMessage />
                </FormItem>
            ...
            <FormField control={form.control} name="description" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Описание линии..." rows={2} {...field} value={field.value || ""} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
