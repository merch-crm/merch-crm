...
export function EquipmentCard({
  ...
  return (
    <>
      ...
      {/* Edit Dialog */}
      <EquipmentFormDialog open={isEditOpen} onOpenChange={setIsEditOpen} equipment={equipment} applicationTypes={applicationTypes} onSuccess={onUpdated} />

      {/* Maintenance Dialog */}
      <MaintenanceDialog open={isMaintenanceOpen} onOpenChange={setIsMaintenanceOpen} equipment={equipment} onSuccess={onUpdated} />
