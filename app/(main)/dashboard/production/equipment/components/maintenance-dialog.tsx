          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            <FormField control={form.control} name="status" render={({ field }) => (
                <FormItem>
                  ...
                  <Select options={[ { id: "active", title: "Активно" }, { id: "maintenance", title: "На обслуживании" }, { id: "repair", title: "В ремонте" }, { id: "inactive", title: "Неактивно" }, ]} value={field.value} onChange={field.onChange} />
                  <FormMessage />
                </FormItem>
              )}
            />

            <FormField control={form.control} name="nextMaintenanceAt" render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar mode="single" selected={field.value} onSelect={field.onChange} disabled={(date) => isClient && now ? date < now : false}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
            ...
            <FormField control={form.control} name="notes" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Что было сделано..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
