...
export function WarehouseMaterialsList({
 ...
 return (
  <div className={cn("space-y-3", className)}>
      ...
      return (
       ...
       >
        ...
        <div className="flex items-center gap-1.5">
         ...
         <Input type="number" min={1} max={material.availableQuantity} value={material.quantity} onChange={(e) =>
   ...
   <WarehouseMaterialPicker open={pickerOpen} onOpenChange={setPickerOpen} onSelect={handleAddMaterial} selectedIds={materials.map((m) => m.id)}
