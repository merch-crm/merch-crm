    ...
    <div className={cn(
      ...
      <div className="relative z-10">
          <Link 
            ...
            className="w-full flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all group/link"
          >
