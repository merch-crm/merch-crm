                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input 
                        type="number" 
                        min={1} 
                        max={task.maxQuantity}
                        placeholder="0"
                        className="h-12 bg-slate-50/80 rounded-[12px] font-semibold"
                        {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      placeholder="Опишите причину брака для анализа..." 
                      className="resize-none h-28 bg-slate-50/80 rounded-[12px] focus-visible:bg-white transition-colors"
                      {...field}
                    />
                  </FormControl>
