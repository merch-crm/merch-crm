 ...
 return (
  <div className={cn("crm-card flex flex-col", className)}>
   ...
   <div className="flex items-center justify-between mb-4">
    ...
    <Link href="/dashboard/production/staff" className="text-xs font-bold text-primary hover:text-primary/80 flex items-center gap-1 transition-colors">
     <span>Все</span>
...
function StaffRow({ person }: StaffRowProps) {
 ...
 return (
  <Link href={`/dashboard/production/staff/${person.id}`} className={cn( "flex items-center justify-between p-2.5 rounded-xl border transition-all", "hover:shadow-sm hover:border-slate-200 bg-white border-slate-100", "group" )}>
