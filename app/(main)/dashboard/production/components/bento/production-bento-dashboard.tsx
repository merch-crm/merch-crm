...
export function ProductionBentoDashboard({
 ...
 return (
  <div className={cn("flex flex-col gap-3", className)}>
   ...
   {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
   <StatsGrid conversion={conversionForStats} efficiency={shiftForStats} baseStats={baseStatsForGrid} />
   ...
   <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
    ...
    <StaffOnShiftCard staff={data.staffLoad?.staff ?? []} averageLoad={data.staffLoad?.averageLoad} averageEfficiency={data.staffLoad?.averageEfficiency} className="lg:col-span-8" />
   </div>
