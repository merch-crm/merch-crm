 ...
 return (
  <div className={cn(
   ...
   <div className="flex items-center justify-between mb-4">
    ...
    {hasData && (
     <Link href="/dashboard/production/tasks?filter=urgent" className="text-xs font-bold text-rose-600 hover:text-rose-700 flex items-center gap-1 transition-colors">
      <span>Все</span>
...
function UrgentTaskRow({ task }: UrgentTaskRowProps) {
 ...
 return (
  <Link href={`/dashboard/production/tasks/${task.id}`} className={cn( "flex items-center justify-between p-3 rounded-xl border transition-all", "hover:shadow-md hover:-translate-y-0.5 group", isOverdue ? "bg-rose-50/50 border-rose-200 hover:border-rose-300" : "bg-amber-50/50 border-amber-200 hover:border-amber-300" )}>
