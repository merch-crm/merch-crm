   ...
   <div className="crm-filter-tray">
    <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide">
     {calculatorTabs.map((tab) => {
      ...
      return (
       <Link key={tab.id} href={tab.href} className={cn( "relative flex items-center gap-2 px-4 py-2.5 rounded-[14px] text-xs font-bold whitespace-nowrap transition-colors", isActive ? "text-white" : "text-slate-500 hover:text-slate-900" )}>
        {isActive && (
         <motion.div
