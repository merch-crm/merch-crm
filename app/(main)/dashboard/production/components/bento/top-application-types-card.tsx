 ...
 return (
  <div className={cn("crm-card flex flex-col", className)}>
   ...
   <div className="flex items-center justify-between mb-4">
    ...
    <Link href="/dashboard/production/application-types" className="text-xs font-bold text-primary hover:text-primary/80 flex items-center gap-1 transition-colors">
     <span>Все</span>
