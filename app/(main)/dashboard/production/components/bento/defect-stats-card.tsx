...
export function DefectStatsCard({ stats, className }: DefectStatsCardProps) {
 ...
 return (
  <div className={cn("crm-card flex flex-col", className)}>
   ...
   {/* Ссылка на детали */}
   <Link href="/dashboard/production/reports/defects" className="mt-4 flex items-center justify-center gap-2 text-sm text-primary hover:text-primary/80 transition-colors group">
