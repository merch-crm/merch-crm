 ...
 return (
  <div className={cn("space-y-3", className)}>
   <div className="flex items-center justify-between px-0.5">
    ...
    <Link href="/dashboard/production/settings" className="text-xs font-bold text-slate-400 hover:text-primary flex items-center gap-1 transition-colors">
...
function QuickAccessCard({ item }: QuickAccessCardProps) {
 ...
 return (
  <Link href={item.href} className={cn( "group relative p-4 rounded-2xl bg-white border transition-all duration-200", "hover:shadow-md hover:-translate-y-0.5", item.borderColor )}>
   {/* Иконка */}
   <div className={cn(
