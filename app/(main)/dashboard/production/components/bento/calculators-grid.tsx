 ...
 return (
  <div className={cn("crm-card", className)}>
   <div className="flex items-center justify-between mb-4">
    ...
    <Link href="/dashboard/production/calculators" className="text-xs font-bold text-primary hover:text-primary/80 flex items-center gap-1 transition-colors">
     <span>Все</span>
...
function CalculatorMiniCard({ calculator }: CalculatorMiniCardProps) {
 ...
 return (
  <Link href={calculator.href} className={cn( "group flex flex-col items-center justify-center p-3 rounded-xl border transition-all duration-200", "hover:shadow-md hover:-translate-y-0.5", calculator.bgColor, calculator.borderColor )}>
   <div className={cn(
