...
export function ProductionTimer({
  ...
  return (
    <div className={cn("flex items-center gap-2 px-2 py-1.5 rounded-md border border-border/40 bg-muted/30", className)}>
      ...
      <Button variant="ghost" size="icon" className={cn( "h-7 w-7 rounded-full transition-all duration-300", isRunning ? "text-orange-500 hover:text-orange-600 hover:bg-orange-500/10" : "text-green-500 hover:text-green-600 hover:bg-green-500/10" )} onClick={handleToggle} disabled={loading}>
