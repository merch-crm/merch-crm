      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Link href={`/dashboard/production/tasks/${task.id}`} className="font-medium hover:underline line-clamp-1">
              {task.title}
            </Link>
            ...
            {task.orderItem?.order && (
              <p className="text-sm text-muted-foreground">
                Заказ{" "}
                <Link href={`/dashboard/orders/${task.orderItem.order.id}`} className="text-primary hover:underline">
