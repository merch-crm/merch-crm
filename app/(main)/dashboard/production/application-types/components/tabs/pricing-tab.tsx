...
export function PricingTab({ form }: PricingTabProps) {
  ...
  return (
    <div className="space-y-3 mt-4">
      <FormField control={form.control} name="baseCost" render={() => (
          <FormItem>
            <FormLabel>Базовая стоимость (коп.)</FormLabel>
            <FormControl>
              <Input type="number" min={0} {...form.register("baseCost", { valueAsNumber: true })} />
            </FormControl>
            <FormDescription>
      ...
      <FormField control={form.control} name="costPerUnit" render={() => (
          <FormItem>
            <FormLabel>Стоимость за единицу (коп.)</FormLabel>
            <FormControl>
              <Input type="number" min={0} {...form.register("costPerUnit", { valueAsNumber: true })} />
            </FormControl>
            <FormDescription>
      ...
      <FormField control={form.control} name="setupCost" render={() => (
          <FormItem>
            <FormLabel>Стоимость подготовки (коп.)</FormLabel>
            <FormControl>
              <Input type="number" min={0} {...form.register("setupCost", { valueAsNumber: true })} />
            </FormControl>
            <FormDescription>
