...
export function SpecsTab({ form }: SpecsTabProps) {
  return (
    <div className="space-y-3 mt-4">
      <div className="grid grid-cols-2 gap-3">
        <FormField control={form.control} name="minQuantity" render={() => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min={1} {...form.register("minQuantity", { valueAsNumber: true })} />
              </FormControl>
        ...
        <FormField control={form.control} name="maxColors" render={({ field }) => (
            <FormItem>
              <FormLabel>Макс. цветов</FormLabel>
              <FormControl>
                <Input type="number" min={1} placeholder="∞" {...form.register("maxColors", { valueAsNumber: true })} value={field.value ?? ""} />
              </FormControl>
      ...
      <FormField control={form.control} name="maxPrintArea" render={({ field }) => (
          <FormItem>
      ...
      <div className="grid grid-cols-2 gap-3">
        <FormField control={form.control} name="estimatedTime" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min={0} placeholder="5" {...form.register("estimatedTime", { valueAsNumber: true })} value={field.value ?? ""} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField control={form.control} name="setupTime" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" min={0} placeholder="30" {...form.register("setupTime", { valueAsNumber: true })} value={field.value ?? ""} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
