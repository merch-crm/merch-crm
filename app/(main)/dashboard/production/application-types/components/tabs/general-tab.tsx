    ...
    <div className="space-y-3 mt-4">
      ...
      <FormField control={form.control} name="category" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Select value={field.value} onChange={(val) => field.onChange(val)}
      ...
      <FormField control={form.control} name="description" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea placeholder="Краткое описание метода нанесения..." rows={3} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField control={form.control} name="color" render={({ field }) => (
          <FormItem>
            ...
            <div className="flex items-center gap-2">
              ...
              <FormControl>
                <Input type="text" placeholder="#3B82F6" className="w-24" {...field} />
              </FormControl>
            </div>
            <FormMessage />
          </FormItem>
