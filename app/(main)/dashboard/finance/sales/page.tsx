...
export default async function FinanceSalesPage({
  ...
  return <SalesClient salesData={salesRes.data || { summary: { totalRevenue: 0, orderCount: 0, avgOrderValue: 0, netProfit: 0, averageCost: 0, writeOffs: 0 }, chartData: [], categories: [], recentTransactions: [] }} />;
}
