        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="crm-card !bg-slate-900 text-white !border-none shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-2 mb-4 relative z-10">
                        ...
                        <p className="text-slate-400 text-xs font-black uppercase tracking-wider">Выручка</p>
                    </div>
                ...
                <div className="crm-card shadow-lg hover:border-rose-100 transition-all group overflow-hidden relative">
                    ...
                    <p className="text-slate-400 text-xs font-black uppercase tracking-wider mb-4">Себестоимость</p>
                    <div className="text-4xl font-black text-rose-500">
                        -{plReport.totalCOGS.toLocaleString('ru-RU')} 
                        <span className="text-lg opacity-50 ml-1">{currencySymbol}</span>
                    </div>
                    <div className="text-[10px] font-bold text-rose-400 uppercase mt-4 flex items-center gap-1">
                ...
                <div className="crm-card shadow-lg hover:border-rose-200 transition-all group overflow-hidden relative">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-rose-50 rounded-full -mr-12 -mt-12 blur-xl opacity-50 group-hover:opacity-100 transition-opacity" />
                    <p className="text-slate-400 text-xs font-black uppercase tracking-wider mb-4">Опер. расходы</p>
                    <div className="text-4xl font-black text-rose-600">
                        -{plReport.totalOverhead.toLocaleString('ru-RU')} 
                        <span className="text-lg opacity-50 ml-1">{currencySymbol}</span>
                    </div>
                    <div className="text-[10px] font-bold text-rose-500 uppercase mt-4 flex items-center gap-1">
                ...
                <div className="crm-card !bg-emerald-600 text-white !border-none shadow-2xl relative overflow-hidden group">
                    ...
                    <p className="text-emerald-100/70 text-xs font-black uppercase tracking-wider mb-4 relative z-10">Чистая прибыль</p>
                    <div className="text-4xl font-black relative z-10">
                        {plReport.netProfit.toLocaleString('ru-RU')} 
                        <span className="text-lg opacity-60 ml-1">{currencySymbol}</span>
                    </div>
                    <div className="mt-6 flex items-center gap-2 relative z-10">
                        <div className="text-[11px] font-black bg-white/20 px-4 py-1.5 rounded-full flex items-center gap-1.5 backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="crm-card !p-8 bg-white border-none shadow-xl !rounded-[32px] lg:col-span-1 flex flex-col items-center">
                    ...
                    <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-8 w-full">Соотношение затрат</p>
                    ...
                    <div className="h-[280px] w-full relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none pb-8">
                            <span className="text-xs font-bold text-slate-400 uppercase">Всего</span>
                ...
                <div className="crm-card !p-8 bg-white border-none shadow-xl !rounded-[32px] lg:col-span-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="group cursor-default">
                             ...
                             <p className="text-[10px] font-bold text-slate-400 mt-2 uppercase tracking-widest">Доля от выручки: {((plReport.totalCOGS / plReport.totalRevenue) * 100 || 0).toFixed(1)}%</p>
                        </div>
                        ...
                        <div className="group cursor-default">
                             ...
                             <p className="text-[10px] font-bold text-slate-400 mt-2 uppercase tracking-widest">Доля от выручки: {((plReport.totalOverhead / plReport.totalRevenue) * 100 || 0).toFixed(1)}%</p>
                        </div>
                    </div>
                </div>
            </div>
