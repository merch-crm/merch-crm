                ...
                {statsCards.map((card, i) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <p className="text-slate-400 text-[10px] font-black uppercase tracking-wider mb-1 opacity-70 group-hover:opacity-100 transition-opacity">{card.label}</p>
                                ...
                                <div key={i} className="space-y-2">
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className="text-[10px] font-bold text-slate-400 ml-1.5">({Math.round(percentage)}%)</span>
                                        </div>
                                    </div>
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">доля</div>
                                </div>
                            </div>

                            <div>
                                <p className="text-slate-400 text-[10px] font-black uppercase tracking-wider mb-1">{config.label}</p>
                                ...
                                <div className="text-[10px] text-slate-500 font-bold bg-slate-50 inline-block px-2 py-0.5 rounded-md">{cat.count} {pluralize(cat.count, 'заказ', 'заказа', 'заказов')}</div>
                            </div>
                        </motion.div>
                    );
                })}
