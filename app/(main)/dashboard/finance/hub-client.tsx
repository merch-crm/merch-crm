        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="bg-slate-50 p-2 rounded-xl border border-slate-100 hidden sm:block">
                             <span className="text-xs font-black text-slate-500 px-3 uppercase">Real-time data</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-4">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[10px] text-slate-400 font-bold uppercase">{link.desc}</div>
                                        </div>
                                    </div>
                    ...
                    >
                        <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-6">Топ категорий</h4>
