            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[var(--crm-grid-gap)]">
                <div className="crm-card p-8 bg-white flex flex-col justify-between h-44 hover:scale-[1.02] transition-all duration-500 group border-none shadow-sm">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                            <div className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-100/50 shadow-sm">Авто-расчет</div>
                        </div>
                    </div>
                ...
                <div className="crm-card p-8 bg-white flex flex-col justify-between h-44 hover:scale-[1.02] transition-all duration-500 group border-none shadow-sm">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                            <div className="text-xs font-bold text-slate-400">Активный штат</div>
                        </div>
                    </div>
                    <div className="mt-auto">
                            ...
                            <div className="px-8 py-7 bg-slate-50/70 border-b border-slate-200/60 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs font-bold text-slate-400 mt-0.5">Департамент</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="text-xs font-bold text-slate-400 mb-1.5">ФОТ Отдела</div>
                                                ...
                                                {emps.map((emp) => (
                                                    <tr key={emp.id} className="crm-tr">
                                                        <td className="crm-td">
                                                            ...
                                                            <div className="text-xs text-primary font-black opacity-70">USR-{emp.id.split('-')[0]}</div>
                                                        </td>
                                                        <td className="crm-td text-center">
                                                            <span className="px-3.5 py-1.5 bg-slate-100/70 rounded-full text-xs font-bold text-slate-600 border border-slate-200/50 whitespace-nowrap">
                                                                {emp.role}
                                                            </span>
                                                        </td>
                                                        <td className="crm-td text-center">
                                                        ...
                                                        <td className="crm-td text-center">
                                                            <div className="inline-flex flex-col items-center">
                                                                <div className="font-black text-emerald-600 text-[15px]">+{emp.bonus.toLocaleString('ru-RU')} {currencySymbol}</div>
                                                                <div className="text-xs font-bold text-slate-400 mt-0.5">за {emp.ordersCount} заказов</div>
                                                            </div>
                                                        </td>
                                                        <td className="crm-td crm-td-number">
                                                            <div className="font-black text-slate-900 border-l border-slate-200/50 pl-6 inline-block text-[20px] leading-none">
                                                                {emp.total.toLocaleString('ru-RU')} <span className="text-slate-400 text-xs font-bold">{currencySymbol}</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))}
                                    ...
                                    <div key={emp.id} className="p-4 flex flex-col gap-3 active:bg-slate-50 transition-colors">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                            <div className="flex flex-col">
                                                <span className="text-slate-400 font-bold text-xs">Оклад</span>
                                                <span className="font-bold text-slate-900 text-sm">{emp.baseSalary.toLocaleString('ru-RU')} {currencySymbol}</span>
                                            </div>
                                            <div className="flex flex-col">
                                                <span className="text-slate-400 font-bold text-xs">KPI</span>
                                                <span className="font-black text-emerald-600 text-sm">+{emp.bonus.toLocaleString('ru-RU')} {currencySymbol}</span>
                                                <span className="text-xs font-bold text-slate-400 mt-0.5 whitespace-nowrap">({emp.ordersCount} заказов)</span>
                                            </div>
                                        </div>
