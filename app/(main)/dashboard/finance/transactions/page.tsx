...
export default async function TransactionsPage({
  ...
  return (
    <TransactionsClient initialPayments={(paymentsRes.success && paymentsRes.data ? paymentsRes.data : []) as PaymentData[]} initialExpenses={(expensesRes.success && expensesRes.data ? expensesRes.data : []) as ExpenseData[]} />
  );
}
