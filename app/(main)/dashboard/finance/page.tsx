        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div>
                    ...
                    <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-2 lg:grid-cols-6 gap-[var(--crm-grid-gap)]">
                            {statsCards.map((card, i) => (
                                <div key={i} className="crm-card p-6 bg-white flex flex-col justify-between h-40 hover:scale-[1.02] transition-all duration-500 group border-none">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-[var(--crm-grid-gap)]">
                            {categories.map((cat, i) => {
                                ...
                                return (
                                    <div key={i} className="crm-card p-6 bg-white flex flex-col justify-between hover:scale-[1.02] transition-all duration-500 group border-none">
                ...
                {activeTab === 'salary' && (
                    <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-[var(--crm-grid-gap)]">
                            <div className="crm-card p-6 bg-white flex flex-col justify-between h-40 hover:scale-[1.02] transition-all duration-500 group border-none">
                                <div className="flex justify-between items-start">
                                    ...
                                    <div key={idx} className="crm-card border-none bg-white shadow-sm overflow-hidden">
                                        <div className="px-8 py-6 bg-slate-50/50 border-b border-slate-200 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-[18px] bg-white flex items-center justify-center text-primary shadow-sm border border-slate-200">
                                                    ...
                                                    {emps.map((emp) => (
                                                        <tr key={emp.id} className="group hover:bg-slate-50/50 transition-colors">
                                                            ...
                                                            <td className="px-8 py-6 text-right">
                                                                <div className="font-bold text-slate-900 border-l border-slate-200 pl-6 inline-block text-lg">
                ...
                {activeTab === 'promocodes' && (
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 border-t border-slate-200 pt-8">
                ...
                {activeTab === 'pl' && (
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 border-t border-slate-200 pt-8 space-y-8">
                        {plRes.data && (
                            <>
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-[var(--crm-grid-gap)]">
                                    ...
                                    <div className="crm-card p-8 bg-white border border-slate-200 shadow-sm">
                    ...
                    <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[var(--crm-grid-gap)]">
                            {funds.map((fund, i) => {
                                ...
                                return (
                                    <div key={i} className="crm-card p-8 bg-white flex flex-col justify-between hover:scale-[1.02] transition-all duration-500 border-none group overflow-hidden">
                        ...
                        <div className="crm-card p-10 bg-white border-none shadow-sm relative overflow-hidden group">
                            ...
                            <div className="h-16 w-full flex rounded-[var(--radius-inner)] overflow-hidden shadow-inner bg-slate-50 border border-slate-200 p-1">
                                {funds.map((fund, i) => (
                                    <div
                                        key={i}
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mt-12 bg-slate-50/50 p-6 rounded-[var(--radius-inner)] border border-slate-200/50">
                                {funds.map((fund, i) => (
