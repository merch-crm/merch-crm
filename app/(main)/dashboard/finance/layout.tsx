                    ...
                    {TABS.map((tab) => {
                        ...
                        return (
                            <Link
                                key={tab.id}
                                href={tab.href}
                                className={cn("flex-1 h-full relative flex items-center justify-center gap-2.5 px-6 !rounded-[16px] text-[13px] font-bold group min-w-[130px] whitespace-nowrap transition-all",
