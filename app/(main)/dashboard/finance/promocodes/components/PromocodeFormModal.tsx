...
export function PromocodeFormModal({
  ...
  return (
    <ResponsiveModal isOpen={isOpen} onClose={onClose} showVisualTitle={false} className="sm:max-w-[520px] p-0 overflow-hidden">
          ...
          <form id="promocode-form" action={onSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select options={[ { id:"percentage", title:"Процент %" }, { id:"fixed", title: `Фикс. сумма ${currencySymbol}` }, { id:"free_shipping", title:"Беспл. доставка" }, { id:"gift", title:"Подарок" } ]} value={form.discountType} onChange={(val) => setForm(prev => ({ ...prev, discountType: val }))}
                  autoLayout={false}
                />
              </div>
              <div className="space-y-2">
