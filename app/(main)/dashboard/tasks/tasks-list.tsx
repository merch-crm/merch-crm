...
export function TasksList({ tasks, currentUserId: _currentUserId, onTaskClick }: TasksListProps & { onTaskClick?: (id: string) => void }) {
  ...
  return (
    <>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <Button variant="ghost" size="icon" onClick={(e) => handleToggle(e, task.id, isDone ?"in_progress" :"done")}
              ...
              <div className="flex items-center gap-2 shrink-0 ml-4">
                <Button variant="ghost" size="icon" onClick={(e) => handleDelete(e, task.id)}
      ...
      <ConfirmDialog isOpen={!!taskToDelete} onClose={() => setTaskToDelete(null)}
