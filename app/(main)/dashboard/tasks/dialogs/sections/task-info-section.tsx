   ...
   <div className="space-y-3 animate-in fade-in duration-200">
    <div className="flex items-center justify-between">
     ...
     <div className="flex items-center gap-2">
      ...
      <Button size="sm" onClick={handleSave} disabled={isSaving} className="bg-gradient-to-r from-emerald-500 to-green-600">
       {isSaving ? (
    ...
    <div className="space-y-3">
     ...
     <div className="grid grid-cols-2 gap-3">
      ...
      <div className="space-y-2">
       <Label>Отдел</Label>
       <Select options={departmentOptions} value={departmentId} onChange={setDepartmentId} placeholder="Выберите отдел" />
      </div>
     </div>
    </div>
   </div>
