    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-2.5">
                ...
                <Textarea
                    id="description"
                    placeholder="Описание деталей или требований..."
                    value={description}
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2.5">
                    ...
                    <Select
                        ...
                        className="h-12 rounded-[18px] border-none bg-slate-50 font-bold focus:ring-indigo-500/20 shadow-sm"
                    />
                </div>
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-3">
                ...
                <UserMultiSelect
                    users={(users || []).filter((u) => !assigneeIds.includes(u.id))}
            ...
            <div className="space-y-2.5">
                ...
                <Select
                    ...
                    className="h-12 rounded-[18px] border-none bg-slate-50 font-bold shadow-sm"
                />
            </div>
        </div>
    );
            ...
            <div className="space-y-3.5">
                ...
                <div className="flex gap-3">
                    ...
                    <Button
                        ...
                        className="w-12 h-12 p-0 rounded-xl bg-slate-900 transition-all active:scale-90 hover:bg-slate-800 shrink-0 shadow-lg shadow-black/10 border-none"
                    >
