                ...
                {COLUMNS.map((column) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={cn("flex items-center justify-between p-4 rounded-t-2xl shadow-sm mb-1 transition-all",
                                column.color
                            )}>
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="bg-white/20 text-white px-2 py-0.5 rounded-2xl text-xs font-bold">
                                        {columnTasks.length}
                                    </span>
                                </div>
                            ...
                            {/* Column Body */}
                            <div className={cn("flex-1 p-3 space-y-3 rounded-b-2xl border-x border-b border-slate-200 transition-colors",
                                column.bg,
                                ...
                                {columnTasks.length === 0 && !draggedTaskId && (
                                    <div className="py-20 flex flex-col items-center justify-center border-2 border-dashed border-slate-200/50 rounded-2xl">
                                        ...
                                        <span className="text-xs font-bold text-slate-300">Пусто</span>
                                    </div>
                                )}
                                ...
                                {columnTasks.map((task) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={cn("group relative bg-white rounded-2xl p-4 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 cursor-grab active:cursor-grabbing border-l-4",
                                                priority.line
                                            )}
                                        >
                                            <div className="flex justify-between items-start mb-3">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {task.order && (
                                                            <span className="px-2 py-0.5 bg-primary/5 text-primary rounded-md text-xs font-bold">
                                            ...
                                            <h4 className={cn("text-sm font-bold text-slate-900 leading-tight mb-4 group-hover:text-primary transition-colors",
                                            ...
                                            <div className="flex items-center justify-between pt-3 border-t border-slate-200">
                                                ...
                                                {task.dueDate && (
                                                    <div className={cn("flex items-center gap-1.5 px-2 py-1 rounded-2xl",
