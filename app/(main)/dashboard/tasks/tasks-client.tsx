   ...
   <div className="flex flex-col gap-3 max-w-[1600px] mx-auto pb-8 w-full">
    ...
    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-3">
     ...
     <div className="flex items-center gap-3">
      ...
      {/* Create Button */}
      <Button onClick={handleCreateOpen} className="h-11 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white shadow-lg shadow-violet-500/30 rounded-xl px-6 font-medium transition-all duration-200 hover:shadow-xl hover:shadow-violet-500/40 hover:-translate-y-0.5">
    ...
    <div className="flex flex-col xl:flex-row gap-3">
     ...
     <div className="flex items-center gap-3 flex-1">
      <div className="relative flex-1 max-w-md">
       ...
       <Input placeholder="Поиск по задачам..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
      ...
      <FilterPresets currentFilters={additionalFilters} userPresets={userPresets} onApplyPreset={setAdditionalFilters} onPresetsChange={() => {}}
      />
    ...
    {isFilterOpen && (
     <div className="animate-in slide-in-from-top-2 fade-in duration-300">
      <TaskFiltersPanel filters={additionalFilters} onFiltersChange={setAdditionalFilters} users={users} departments={departments} onClose={() => setIsFilterOpen(false)}
      />
     </div>
    )}
    ...
    <div className="min-h-[600px] mt-2">
     <TasksBentoDashboard tasks={filteredTasks} users={users} departments={departments} currentUserId={currentUserId} viewTab={viewTab} onTaskClick={handleTaskClick} onTasksChange={setTasks} onDeleteTask={handleTaskDeleted} onCreateOpen={handleCreateOpen} />
    </div>

    {/* Dialogs */}
    <CreateTaskDialog open={isCreateOpen} onOpenChange={(v) => !v && handleCreateClose()}
    ...
    <TaskDetailsDialog task={tasks.find(t => t.id === selectedTaskId) || null}
     open={!!selectedTaskId}
