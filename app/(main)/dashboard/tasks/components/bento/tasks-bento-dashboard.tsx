 ...
 return (
  <div className="flex flex-col gap-3">
   ...
   <div className="grid grid-cols-12 gap-3">
    <HeroTaskCard totalTasks={stats.total} completedToday={stats.completedToday} className="col-span-12 lg:col-span-8" />
    <div className="col-span-12 lg:col-span-4 h-full">
     <TaskStatsGrid stats={stats} className="h-full grid grid-cols-2 grid-rows-2 sm:grid-cols-2 sm:grid-rows-2 lg:grid-cols-2 lg:grid-rows-2" />
    </div>
   </div>
   ...
   <div className="crm-card !bg-white p-4 sm:p-6 overflow-x-auto min-h-[600px] mt-2">
    <div className="flex items-center justify-between mb-6">
     ...
     <Button onClick={onCreateOpen} className="sm:hidden h-9 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl shadow-lg shadow-violet-500/30">
