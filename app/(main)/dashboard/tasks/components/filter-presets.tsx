  ...
  <>
   <Popover open={isOpen} onOpenChange={setIsOpen}>
    <PopoverTrigger asChild>
     <Button variant="outline" className="h-11 px-4 rounded-xl border-slate-200/60 bg-white/80 backdrop-blur-sm hover:bg-white transition-all">
    ...
    <PopoverContent className="w-80 p-0 rounded-2xl border-slate-200 shadow-xl" align="end">
     ...
     {hasActiveFilters && (
      <div className="p-3 border-t border-slate-100 bg-slate-50/50">
       <Button variant="ghost" size="sm" className="w-full justify-start rounded-xl hover:bg-white" onClick={() => {
         setIsOpen(false);
   ...
   <Dialog open={isSaveDialogOpen} onOpenChange={setIsSaveDialogOpen}>
    <DialogContent className="rounded-2xl">
     ...
     <DialogFooter>
      ...
      <Button onClick={handleSavePreset} disabled={isSaving} className="rounded-xl bg-gradient-to-r from-violet-600 to-purple-600">
