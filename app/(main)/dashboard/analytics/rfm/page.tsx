...
export default async function RFMPage() {
  ...
  return (
    <div className="space-y-3">
      <PageHeader title="RFM-аналитика" description="Сегментация клиентской базы по давности, частоте и сумме покупок" actions={ <RFMAnalysisTrigger onAnalyze={handleAnalyze} />
        }
      />
