...
export function LoyaltyLevelModal({
  ...
  return (
    <ResponsiveModal isOpen={isOpen} onClose={onClose} title={editingLevel ? "Редактировать уровень" : "Новый уровень"} className="max-w-lg">
      <div className="p-6 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-2">
            ...
            <Input type="text" value={formData.levelKey} onChange={(e) => setFormData(prev => ({
                ...prev,
          ...
          <div className="space-y-2">
            ...
            <Input type="text" value={formData.levelName} onChange={(e) => setFormData(prev => ({ ...prev, levelName: e.target.value }))}
              placeholder="Золото"
              className="h-12 rounded-xl"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-2">
            ...
            <Input type="number" value={formData.minOrdersAmount} onChange={(e) => setFormData(prev => ({ ...prev, minOrdersAmount: Number(e.target.value) }))}
              min={0}
              className="h-12 rounded-xl"
            />
          </div>
          <div className="space-y-2">
            ...
            <Input type="number" value={formData.minOrdersCount} onChange={(e) => setFormData(prev => ({ ...prev, minOrdersCount: Number(e.target.value) }))}
              min={0}
              className="h-12 rounded-xl"
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <Input type="number" value={formData.discountPercent} onChange={(e) => setFormData(prev => ({ ...prev, discountPercent: Number(e.target.value) }))}
            min={0}
            max={100}
            className="h-12 rounded-xl"
          />
