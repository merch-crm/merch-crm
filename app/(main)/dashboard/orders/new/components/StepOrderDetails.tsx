    ...
    <div className="max-w-2xl space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-2">
          ...
          <Select value={details.priority} onChange={(val: string) => onUpdateDetails({ priority: val })}
            options={[
              { id:"low", title:"Низкий" },
        ...
        <div className="space-y-2">
          ...
          <Input id="order-deadline" type="date" min={isClient ? new Date().toISOString().split('T')[0] : undefined} // suppressHydrationWarning value={details.deadline} onChange={(e) => onUpdateDetails({ deadline: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="space-y-2">
          ...
          <Select value={details.paymentMethod} onChange={(val: string) => onUpdateDetails({ paymentMethod: val })}
            options={[
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input id="order-advance" type="number" value={details.advanceAmount} onChange={(e) => onUpdateDetails({ advanceAmount: e.target.value })}
            className="pl-12"
          />
        </div>
      </div>
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Input type="text" placeholder="Введите промокод..." value={promoInput} onChange={(e) => onPromoInputChange(e.target.value)}
              className="pl-12"
            />
          </div>
