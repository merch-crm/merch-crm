...
export function OrdersWidgets({ stats, showFinancials }: OrderStatsProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            ...
            <div className="col-span-12 md:col-span-4 lg:col-span-4 flex flex-col gap-3">
                ...
                <div className="crm-card flex-1 relative group">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-bold text-primary bg-primary/10 px-2 py-1 rounded-full">Новые</span>
                    </div>
                    <div>
                        <div className="text-4xl font-bold text-slate-900 mb-1">{stats.new}</div>
                ...
                <div className="crm-card flex-1 relative group">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-bold text-orange-600 bg-orange-50 px-2 py-1 rounded-full">В работе</span>
                    </div>
                    <div>
                        <div className="text-4xl font-bold text-slate-900 mb-1">{stats.inProduction}</div>
            ...
            <div className="col-span-12 grid grid-cols-1 md:grid-cols-2 gap-3">
                {/* Completed */}
                <div className="crm-card flex items-center gap-3 hover:border-emerald-200 group">
                    ...
                    <div className="ml-auto">
                        <div className="w-12 h-12 rounded-full border-[3px] border-emerald-100 flex items-center justify-center text-xs font-bold text-emerald-600">
                            100%
                        </div>
                    </div>
                </div>
                ...
                <div className="crm-card flex items-center gap-3 relative">
