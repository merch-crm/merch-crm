    ...
    <div className="space-y-3">
      ...
      <div className="crm-filter-tray p-1.5">
        ...
        <div className="relative flex-1 min-w-0 group/search">
          ...
          <Input type="search" placeholder="Поиск по заказам..." aria-label="Поиск по заказам" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
        ...
        <div className="flex-1 min-w-0 flex items-center">
          <div className="flex items-center p-1 gap-1 overflow-x-auto no-scrollbar flex-nowrap w-full">
            {[
              ...
              <Button key={tab.id} variant="ghost" onClick={() => handleTabChange(tab.id ==="archived")}
