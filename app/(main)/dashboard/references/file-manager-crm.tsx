    ...
    <section className="space-y-3">
      ...
      <div className="glass-panel p-6 space-y-3">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-sm text-slate-600">
              <span>Sort by:</span>
              <Select value={sortBy} onChange={setSortBy} options={[ { id:"type", title:"type" }, { id:"name", title:"name" }, { id:"date", title:"date" }, ]} compact variant="minimal" />
            </div>
            <div className="flex gap-2">
              <button type="button"
        ...
        <div className="flex gap-3">
              ...
              {folders.map((folder) => (
                ...
                >
                  <div className="relative mb-2">
                    ...
                    <div className="w-full aspect-[1.3/1] relative transition-transform duration-200">
                      {/* Folder Tab (Back) */}
          ...
          <div className="w-64 bg-white rounded-xl p-6 border border-slate-200 space-y-3">
            <div className="flex items-center gap-3">
