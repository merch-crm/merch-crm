    ...
    return (
        <div className="rounded-[48px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border-4 border-white/50 relative p-1 pb-0 flex flex-col font-sans max-w-[1500px] min-w-[1240px] mx-auto"
            ...
            <div className="px-10 py-8 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button type="button" className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/60 border border-white text-[14px] font-bold text-black/60 hover:bg-white transition-all shadow-sm">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                        ...
                        <button type="button" className="w-11 h-11 rounded-full bg-white/60 border border-white flex items-center justify-center text-black/30 hover:bg-white transition-all shadow-sm">
            ...
            <div className="px-14 py-6 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3 px-6 py-4.5 rounded-[26px] bg-[#9cf8ce] border border-white/40 shadow-[0_10px_25px_-5px_rgba(156,248,206,0.3)]">
                        ...
                        <span className="text-xs font-bold text-black/30 ml-[-4px]">Paid</span>
                    </div>
                    <div className="flex items-center gap-3 px-6 py-4.5 rounded-[26px] bg-[#fff09e] border border-white/40 shadow-[0_10px_25px_-5px_rgba(255,240,158,0.3)]">
                        ...
                        <span className="text-xs font-bold text-black/30 ml-[-4px]">Credits</span>
                    </div>
                    <div className="flex items-center gap-3 px-6 py-4.5 rounded-[26px] bg-[#e4e7ee] border border-white/40 shadow-[0_10px_25px_-5px_rgba(228,231,238,0.3)]">
                        ...
                        <span className="text-xs font-bold text-black/30 ml-[-4px]">Balance</span>
                    </div>
                    ...
                    <div className="flex-1 h-[72px] bg-white/30 backdrop-blur-md rounded-[26px] overflow-hidden flex items-center px-5 gap-3">
                        ...
                        <button type="button" className="px-8 py-4.5 rounded-full bg-black text-white text-[15px] font-bold hover:scale-[1.02] transition-transform shadow-lg">
                            Pay Invoice
                        </button>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col pt-4 relative">
                    <div className="flex items-end mx-14 h-28 relative">
                        ...
                        <div className="relative flex items-end">
                            <button type="button" className="px-16 py-9 bg-white rounded-t-[50px] text-[24px] font-extrabold text-black relative z-20 shadow-[0_-10px_30px_rgba(0,0,0,0.02)]">
                                Invoice lines
                            </button>
                        ...
                        <div className="flex items-center justify-between mb-12">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex p-1.5 bg-[#f5f6f8] rounded-[22px] border border-black/[0.03]">
                                    <button type="button" className="p-3.5 bg-white rounded-[18px] shadow-sm text-black">
                                        <LayoutGrid className="w-5 h-5" />
                                    </button>
                                    <button type="button" className="p-3.5 text-black/20"><MoreHorizontal className="w-5 h-5" /></button>
                                    <button type="button" className="p-3.5 text-black/20"><Settings className="w-5 h-5" /></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 bg-white rounded-tr-[48px] p-[--padding-xl] border-t border-white shadow-[inset_0_20px_40px_rgba(0,0,0,0.02)]">
                        ...
                        <div className="flex items-center gap-3.5 mb-14">
                            {[Calendar, Plus, CreditCard, Plus, Globe, Plus, Bell, Plus].map((Icon, i) => (
                                <button type="button" key={i} className="flex-1 aspect-square rounded-[24px] bg-white border border-black/[0.06] flex items-center justify-center text-black/20 hover:bg-black/5 hover:text-black transition-all">
                                    ...
                                    <div key={i} className="relative group cursor-pointer pl-6">
                                        ...
                                        <div className={cn("p-[--padding-xl] pl-24 rounded-[56px] border-2 border-white transition-all duration-500 shadow-sm hover:shadow-xl relative overflow-hidden", act.color)}>
                                            <div className="flex items-start justify-between mb-12">
                                                ...
                                                <button type="button" className="w-14 h-14 rounded-full bg-white/40 flex items-center justify-center hover:bg-white transition-all duration-300 shadow-sm scale-90 group-hover:scale-100">
