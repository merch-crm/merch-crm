...
export default function SoftUiPanelsCRM() {
  return (
    <section className="space-y-3 py-12 flex flex-col items-center bg-[#f0f2f5] rounded-[var(--radius-outer)]">
      ...
      <div className="flex flex-col gap-3 items-center scale-110">
        ...
        <div className="bg-white p-1.5 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-1">
          ...
          <button type="button" className="px-8 py-3 rounded-full text-sm font-medium text-slate-400 hover:text-slate-600 transition-colors">
            Inactive
          </button>
          <button type="button" className="px-8 py-3 rounded-full text-sm font-medium text-slate-400 hover:text-slate-600 transition-colors">
            Inactive
        ...
        <div className="bg-white p-2 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-2">
          <button type="button" className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-slate-600 rounded-xl hover:bg-slate-50 transition-colors">
            <ChevronLeft size={20} />
          </button>
          ...
          {[2, 3, 4, 5].map((num) => (
            <button type="button" key={num} className="w-12 h-12 flex items-center justify-center text-slate-500 font-medium hover:bg-slate-50 rounded-2xl transition-colors">
              {num}
            </button>
          ))}
        </div>
        ...
        <div className="flex gap-3 w-full justify-center">
          ...
          <div className="bg-white p-2 pr-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-3">
            ...
            <button type="button" className="w-12 h-12 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-slate-200 transition-colors">
              <Check size={20} strokeWidth={3} />
            </button>
            <span className="text-slate-700 font-medium">Check</span>
          </div>
          ...
          {/* View Switcher */}
          <div className="bg-white p-2 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-2">
            <button type="button" className="w-12 h-12 flex items-center justify-center text-slate-800 hover:bg-slate-50 rounded-2xl transition-colors">
