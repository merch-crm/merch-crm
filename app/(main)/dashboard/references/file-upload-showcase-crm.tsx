    ...
    return (
        <section className="space-y-12 py-12 flex flex-col items-center bg-[#f2f4f6] rounded-[3rem]">
            ...
            <div className="scale-110">
                <div className="w-[400px] bg-white rounded-[2.5rem] p-4 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.08)] space-y-3">
                    ...
                    <div className="space-y-3 pt-2">
                        ...
                        <div className="flex items-center p-3 rounded-2xl border border-slate-200 hover:border-slate-200 hover:shadow-sm transition-all bg-white group">
                    ...
                    {/* 4. Uploading State */}
                    <div className="relative p-4 rounded-2xl border border-slate-200 bg-white overflow-hidden">
