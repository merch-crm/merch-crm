      ...
      >
        ...
        <div className="relative z-20 h-full flex flex-col p-6">
          ...
          <div className="flex-1 relative flex items-center justify-center py-4">
            ...
            >
              <Image src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=400&fit=crop" alt="KTM Bike" fill className="object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]" priority />
            </motion.div>
          </div>
