            ...
            <main className="flex-1 p-8 md:p-10 relative overflow-auto">
                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="w-10 h-10 rounded-[var(--radius-inner)] bg-white border border-slate-200 flex items-center justify-center text-slate-400 group hover:text-slate-900 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-12">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        <div className="glass-panel p-6 flex flex-col gap-6 bg-white/50 border-white/80">
                            <h4 className="text-xs font-bold text-slate-400  tracking-normal border-b border-slate-200 pb-4">Live Connections</h4>
                            ...
                            <button className="w-full h-12 rounded-[var(--radius-inner)] bg-white border border-slate-200 hover:border-primary/40 hover:text-primary text-xs font-bold  tracking-normal transition-all">Open Session</button>
                        </div>
                    </div>
