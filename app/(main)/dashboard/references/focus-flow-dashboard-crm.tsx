...
export default function FocusFlowDashboardCRM() {
    return (
        <div className="w-full glass-panel flex rounded-[var(--radius-outer)] mt-10 overflow-hidden bg-white/30 backdrop-blur-xl border border-white/50 shadow-crm-xl relative min-h-[800px]">
            ...
            <aside className="w-20 md:w-[240px] bg-white border-r border-slate-200 p-6 flex flex-col shrink-0 relative z-10 transition-all">
                <div className="flex items-center gap-3 mb-10 md:mb-12">
                    ...
                    <span className="hidden md:block font-bold text-xl text-slate-900">FocusFlow</span>
                </div>
                ...
                <div className="hidden md:flex flex-col gap-3 mt-auto">
                    <div className="bg-slate-50 rounded-[var(--radius-outer)] p-6 border border-slate-200 text-center relative overflow-hidden group">
                        ...
                        <h4 className="font-bold text-slate-900 text-xs  mb-1">New Flow</h4>
                        <p className="text-xs font-medium text-slate-400">Launch workspace</p>
                    </div>
            ...
            <main className="flex-1 p-6 md:p-6 relative overflow-auto">
                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button type="button" className="h-10 px-6 rounded-[var(--radius-inner)] btn-primary text-xs font-bold  shadow-lg shadow-primary/20">Resume session</button>
                    </div>
                </div>
                                ...
                                <div key={i} className="crm-card p-6 flex items-center justify-between group cursor-pointer">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-slate-400  mt-1">{flow.meta}</p>
                                        </div>
                                    </div>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-3">
                        ...
                        <div className="blue-mesh rounded-[var(--radius-outer)] p-6 bg-slate-900 text-white shadow-2xl shadow-slate-900/40 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between min-h-[160px]">
                                ...
                                <button type="button" className="h-10 px-6 rounded-[var(--radius-inner)] bg-white text-slate-900 text-xs font-bold  w-fit mt-6 hover:bg-primary hover:text-white transition-all shadow-md">Enable Node</button>
                            </div>
                        </div>
                        ...
                        <div className="glass-panel p-6 flex flex-col gap-3 bg-white/50 border-white/80">
                            ...
                            <div className="flex -space-x-3">
                                ...
                                <div className="w-12 h-12 rounded-full bg-slate-50 border-4 border-white flex items-center justify-center text-xs font-bold text-slate-400">
                                    +8
                                </div>
                            </div>
                            <button type="button" className="w-full h-12 rounded-[var(--radius-inner)] bg-white border border-slate-200 hover:border-primary/40 hover:text-primary text-xs font-bold  transition-all">Open Session</button>
                        </div>
                    </div>
