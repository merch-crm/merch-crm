  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col gap-3">
        <PageHeader title="Клиенты" description="База контрагентов и история взаимодействий" className="px-1" actions={ <div className="flex items-center gap-2">
              <Link href="/dashboard/clients/funnel" className="h-11 w-11 sm:h-12 sm:w-auto bg-white hover:bg-slate-50 text-slate-600 border-2 border-slate-200 rounded-full sm:rounded-2xl sm:px-4 gap-2 font-bold transition-all active:scale-95 inline-flex items-center justify-center p-0" title="Воронка клиентов">
                <Kanban className="w-5 h-5 text-indigo-500" />
                <span className="hidden lg:inline text-xs font-bold">Воронка</span>
              </Link>
              <Link href="/dashboard/analytics/rfm" className="h-11 w-11 sm:h-12 sm:w-auto bg-white hover:bg-slate-50 text-slate-600 border-2 border-slate-200 rounded-full sm:rounded-2xl sm:px-4 gap-2 font-bold transition-all active:scale-95 inline-flex items-center justify-center p-0" title="RFM Аналитика">
                <Target className="w-5 h-5 text-purple-500" />
                <span className="hidden lg:inline text-xs font-bold">RFM</span>
              </Link>
              <Link href="/dashboard/clients/analytics" className="h-11 w-11 sm:h-12 sm:w-auto bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-200 rounded-full sm:rounded-2xl sm:px-4 gap-2 font-bold transition-all active:scale-95 inline-flex items-center justify-center p-0" title="Аналитика">
                <BarChart3 className="w-5 h-5 text-blue-500" />
                <span className="hidden lg:inline text-xs font-bold">Аналитика</span>
              </Link>
              <Link href="/dashboard/clients/new" className="h-11 w-11 sm:h-12 sm:w-auto bg-slate-900 hover:bg-slate-800 text-white rounded-full sm:rounded-2xl sm:px-6 gap-2 font-bold shadow-xl shadow-slate-200 transition-all active:scale-95 inline-flex items-center justify-center p-0 sm:p-auto" title="Добавить клиента">
