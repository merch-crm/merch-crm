...
export function ExportDialog({
  ...
  return (
    <ResponsiveModal isOpen={open} onClose={onClose} title="Экспорт клиентов" description={ selectedIds?.length ? `Выбрано клиентов: ${selectedIds.length}` : `Всего клиентов: ${totalCount || 0}` } footer={ <div className="flex items-center justify-between w-full">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <Checkbox checked={allSelected ? true : someSelected ? "indeterminate" : false} onCheckedChange={(checked) => toggleAllInCategory(category, !!checked)}
                        />
                      </div>
