  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        {contacts.length < 5 && (
          <Button type="button" variant="ghost" size="sm" onClick={() => setIsAddDialogOpen(true)}
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="relative">
                      <Button type="button" variant="ghost" size="sm" onClick={() => setActiveMenu(activeMenu === contact.id ? null : contact.id)}
      ...
      {/* Add/Edit Dialog */}
      <ContactEditDialog isOpen={isAddDialogOpen || !!editingContact} onClose={() => {
      ...
      {/* Delete Confirmation */}
      <ConfirmDialog isOpen={!!deletingContact} onClose={() => setDeletingContact(null)}
