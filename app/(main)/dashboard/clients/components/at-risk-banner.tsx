                        ...
                        <div className="flex flex-wrap gap-3">
                            {atRiskCount > 0 && (
                                <Link href="/dashboard/clients?activityStatus=at_risk">
                                    <Button
                                        variant="secondary"
                                        className="bg-orange-100/50 hover:bg-orange-100 border border-orange-200 text-orange-700 h-10 px-5 rounded-xl font-bold transition-all hover:translate-x-1"
                                    >
                            ...
                            {attentionCount > 0 && (
                                <Link href="/dashboard/clients?activityStatus=attention">
                                    <Button
                                        variant="secondary"
                                        className="bg-amber-100/50 hover:bg-amber-100 border border-amber-200 text-amber-700 h-10 px-5 rounded-xl font-bold transition-all hover:translate-x-1"
                                    >
                                        <Phone className="w-4 h-4 mr-2" />
