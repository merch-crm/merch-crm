    ...
    <div className="space-y-3 pb-20">
      ...
      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-3 text-white shadow-xl shadow-indigo-100 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <Button onClick={handleRecalculate} disabled={isRecalculating} className="h-14 px-8 rounded-2xl bg-white text-indigo-600 font-bold hover:bg-slate-50 shadow-lg shadow-black/10 active:scale-95 transition-all gap-3 shrink-0">
            {isRecalculating ? (
      ...
      {/* Modal */}
      <ResponsiveModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    <Input type="number" value={formData.minOrdersAmount} onChange={e => setFormData({ ...formData, minOrdersAmount: e.target.value })}
                ...
                <div>
                  ...
                  <Input type="number" value={formData.minOrdersCount} onChange={e => setFormData({ ...formData, minOrdersCount: e.target.value })}
      ...
      <ConfirmDialog isOpen={!!deletingLevelId} onClose={() => setDeletingLevelId(null)}
