  ...
  return (
    <div className={cn("space-y-2", className)}>
      {(clients || []).map((client, index) => (
        ...
        >
          <Link href={`/dashboard/clients?client=${client.id}`} className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors group">
            {/* Rank */}
            <div className={cn(
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {client.rfmSegment && (
                <Badge className="text-xs text-white" style={{ backgroundColor: rfmSegmentColors[client.rfmSegment as keyof typeof rfmSegmentColors] }}>
