...
async function FunnelContent() {
  ...
  return (
    <FunnelBoardClient initialClients={clients} managers={managers} initialStats={stats} />
  );
}
...
export default async function FunnelPage() {
  ...
  return (
    <div className="h-[calc(100vh-80px)] flex flex-col overflow-hidden px-6 lg:px-8 py-6">
      <PageHeader title="Воронка продаж" description="Управление клиентами по этапам" actions={( <Link href="/dashboard/clients">
