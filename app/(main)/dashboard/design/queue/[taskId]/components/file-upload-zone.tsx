            ...
            <Card key={file.id} className="p-3 border-l-4 border-l-lime-500">
              <div className="flex items-center gap-3">
                {file.thumbnailPath || file.mimeType?.startsWith("image/") ? (
                  ...
                  >
                    <Image src={file.thumbnailPath || file.path} alt={file.originalName || "File"} fill className="object-contain" unoptimized />
                  </div>
                ) : (
          ...
          <div className="flex items-center justify-center bg-zinc-950 min-h-[50vh] max-h-[80vh] overflow-auto">
            {previewFile && (
              <div className="relative w-full min-h-[50vh]">
                <Image src={previewFile.path || "/placeholder.png"} alt={previewFile.originalName || "File"} fill className="object-contain" unoptimized />
              </div>
            )}
          </div>
