      ...
      <CardContent className="space-y-3 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="space-y-2">
            ...
            {isEditing ? (
              <Select value={form.applicationTypeId} onChange={(v) => setForm({ ...form, applicationTypeId: v })}
                options={[
          ...
          <div className="space-y-2">
            ...
            {isEditing ? (
              <Input value={form.printFilePath} onChange={(e) => setForm({ ...form, printFilePath: e.target.value })}
