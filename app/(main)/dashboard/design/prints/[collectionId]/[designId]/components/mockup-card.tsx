...
export function MockupCard({
  ...
  return (
    <>
      <Card ref={setNodeRef} style={style} className={`group ${!mockup.isActive ? "opacity-60" : ""}`}>
        <CardContent className="p-0">
          <div className="relative aspect-square bg-muted rounded-t-lg overflow-hidden">
            {mockup.imagePath ? (
              <Image src={mockup.imagePath} alt={mockup.name || "Мокап"} fill className="object-cover" />
            ) : (
