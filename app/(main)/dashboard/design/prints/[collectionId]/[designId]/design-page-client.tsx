    ...
    return (
        <div className="space-y-3">
            ...
            <Button
                ...
                size="sm"
                className="mb-4"
                onClick={() => router.push(`/dashboard/design/prints/${design.collectionId}`)}
            >
            ...
            <DesignHeader
                ...
                onEdit={() => setIsEditDesignDialogOpen(true)}
            ...
            {versions.length === 0 ? (
                <VersionsEmptyState
                    onCreateClick={() => setIsCreateVersionDialogOpen(true)}
                />
            ) : (
                <DndContext
                    sensors={sensors}
            ...
            {/* Edit design dialog */}
            <DesignFormDialog
                open={isEditDesignDialogOpen}
                onOpenChange={setIsEditDesignDialogOpen}
                collectionId={design.collectionId}
                design={design}
                onSuccess={handleDesignUpdated}
            />

            {/* Delete design confirmation */}
            <AlertDialog
                open={isDeleteDesignDialogOpen}
                onOpenChange={setIsDeleteDesignDialogOpen}
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
