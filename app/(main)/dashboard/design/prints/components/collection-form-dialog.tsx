          ...
          >
            <FormField control={form.control} name="name" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Например: Знаки зодиака" disabled={isSubmitting} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField control={form.control} name="description" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea {...field} placeholder="Краткое описание коллекции..." rows={3} disabled={isSubmitting} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
