  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <Select value={styles.fontFamily} onChange={(value) => applyStyles({ fontFamily: value })}
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <Select value={styles.fontSize.toString()} onChange={(value) =>
            ...
            compact
          />
          <Input type="number" value={styles.fontSize} onChange={(e) =>
      ...
      <div className="space-y-3">
        ...
        <ToggleGroup type="multiple" className="justify-start" value={[ styles.fontWeight === "bold" ? "bold" : "", styles.fontStyle === "italic" ? "italic" : "", styles.underline ? "underline" : "", styles.linethrough ? "linethrough" : "" ].filter(Boolean)} onValueChange={(values: string[]) => {
            applyStyles({
      ...
      <div className="space-y-3">
        ...
        <ToggleGroup type="single" value={styles.textAlign} onValueChange={(value: string) => {
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Input value={styles.fill} onChange={(e) => applyStyles({ fill: e.target.value })}
      ...
      <div className="space-y-3">
        ...
        <Slider value={[styles.charSpacing]} min={-50} max={200} step={1} onValueChange={([value]) => applyStyles({ charSpacing: value })}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[styles.lineHeight * 10]} min={5} max={30} step={1} onValueChange={([value]) => applyStyles({ lineHeight: value / 10 })}
        />
      </div>
    </div>
  );
