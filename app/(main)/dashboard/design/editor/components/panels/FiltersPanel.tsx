  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.brightness * 100]} min={-100} max={100} step={1} onValueChange={([value]) => applyFilter("brightness", value / 100)}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.contrast * 100]} min={-100} max={100} step={1} onValueChange={([value]) => applyFilter("contrast", value / 100)}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.saturation * 100]} min={-100} max={100} step={1} onValueChange={([value]) => applyFilter("saturation", value / 100)}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.blur * 100]} min={0} max={100} step={1} onValueChange={([value]) => applyFilter("blur", value / 100)}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch checked={filters.grayscale} onCheckedChange={(checked) => applyFilter("grayscale", checked)}
          />
        </div>

        <div className="flex items-center justify-between">
          <Label className="text-xs">Сепия</Label>
          <Switch checked={filters.sepia} onCheckedChange={(checked) => applyFilter("sepia", checked)}
          />
        </div>

        <div className="flex items-center justify-between">
          <Label className="text-xs">Инверсия</Label>
          <Switch checked={filters.invert} onCheckedChange={(checked) => applyFilter("invert", checked)}
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.noise]} min={0} max={500} step={10} onValueChange={([value]) => applyFilter("noise", value)}
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <Slider value={[filters.pixelate]} min={1} max={20} step={1} onValueChange={([value]) => applyFilter("pixelate", value)}
        />
      </div>
    </div>
  );
