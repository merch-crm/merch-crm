    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Input type="number" value={size.width} disabled className="h-8 bg-muted" />
          </div>
          <div className="space-y-1.5">
            <Label className="text-xs">Высота</Label>
            <Input type="number" value={size.height} disabled className="h-8 bg-muted" />
          </div>
        </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <Slider value={[rotation]} min={0} max={360} step={1} onValueChange={([value]) => handleRotationChange(value)}
            className="flex-1"
          />
          <div className="w-16">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <Slider value={[opacity]} min={0} max={100} step={1} onValueChange={([value]) => handleOpacityChange(value)}
            className="flex-1"
          />
          <div className="w-16">
            <Input type="number" value={opacity} onChange={(e) =>
