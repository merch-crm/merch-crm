...
export default async function CommunicationsPage() {
  ...
  return (
    <div className="flex flex-col h-full space-y-3">
      <PageHeader title="Коммуникации" description="Управление всеми входящими обращениями в одном окне" className="px-1" actions={ <div className="flex items-center gap-3 text-sm font-bold text-amber-600 bg-amber-50/50 border border-amber-100 px-4 py-2 rounded-2xl">
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <CommunicationsClient initialConversations={initialConversations} templates={templates} stats={stats} />
      </Suspense>
    </div>
  );
}
