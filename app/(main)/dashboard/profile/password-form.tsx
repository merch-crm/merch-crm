...
export function PasswordForm() {
    ...
    return (
      <div className="space-y-2 group/input">
        ...
        <div className="relative">
          <Input name={name} type={showPassword ?"text" :"password"} required className={cn(height,"px-6 rounded-2xl bg-slate-50/50 border-slate-200 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 font-bold transition-all duration-300")} placeholder="••••••••" />
  ...
  return (
    <form id="password-form" onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="pt-6">
        <Button type="submit" disabled={loading} className="w-full h-11 rounded-3xl bg-slate-900 hover:bg-black text-white font-black text-base shadow-2xl shadow-slate-200 transition-all duration-500 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3 border-none">
