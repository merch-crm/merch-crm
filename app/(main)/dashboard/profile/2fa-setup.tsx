      ...
      <CardContent>
        {step === "idle" && (
          <div className="flex flex-col gap-3 max-w-sm">
            ...
            <Input type="password" placeholder="Введите ваш пароль для подтверждения" value={password} onChange={(e) => setPassword(e.target.value)}
            />
        ...
        {step === "setup" && totpUri && (
          <div className="flex flex-col gap-3">
            ...
            <div className="max-w-xs pt-4 border-t">
              ...
              <Input type="text" placeholder="Введите 6-значный код" className="text-center text-lg h-12" maxLength={6} onChange={(e) => {
