            ...
            <div className="lg:col-span-2 space-y-4">
                <div className="crm-card p-10 relative overflow-hidden group/tasks border-none">
                    ...
                    <div className="flex items-center justify-between mb-12">
                        <div>
                            <h2 className="text-2xl font-black text-slate-900er">Рабочий план</h2>
                            <p className="text-xs font-black text-slate-400 mt-1">управление временем и задачами</p>
                        </div>
                        <div className="flex -space-x-3">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="w-12 h-12 rounded-2xl border-4 border-white bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-400 shadow-xl">
                                    {i}+
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="space-y-4">
                        {sortedTasks.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                                                ...
                                                <div className={cn("px-3 py-1.5 rounded-xl text-xs font-black shadow-sm", pStyle.bg, pStyle.text)}>
                                                    {pStyle.label}
                                                </div>
                                            </div>
                                        ...
                                        <div className="absolute top-6 right-6 opacity-0 group-hover/item:opacity-100 transition-all duration-300 transform translate-x-4 group-hover/item:translate-x-0">
                                            <button type="button" className="h-10 w-10 rounded-xl bg-slate-900 text-white flex items-center justify-center hover:bg-black transition-colors shadow-lg shadow-slate-200">
                            ...
                            <div className="text-center py-24 bg-slate-50/50 rounded-[32px] border-4 border-dashed border-slate-200 flex flex-col items-center">
                                ...
                                <p className="text-slate-400 font-bold text-sm">Задач на ближайшее время нет</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                            <div className="p-5 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                                ...
                                <div className="flex justify-between items-center">
                                    <span className="text-sm font-bold">Пн - Пт</span>
                                    <span className="text-sm font-black text-white/80">09:00 - 18:00</span>
                                </div>
                            </div>

                            <div className="p-5 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                                <h4 className="text-xs font-black text-white/50 mb-2">Перерыв</h4>
                                <div className="flex justify-between items-center">
                                    <span className="text-sm font-bold">Обед</span>
                                    <span className="text-sm font-black text-white/80">13:00 - 14:00</span>
                                </div>
                            </div>
                        </div>

                        <div className="mt-8 flex items-center gap-3 text-white/40 text-xs font-black opacity-60">
                ...
                >
                    ...
                    <div className="mt-8 flex items-center justify-between">
                        <div className="text-xs font-black text-slate-400">Просрочено:</div>
