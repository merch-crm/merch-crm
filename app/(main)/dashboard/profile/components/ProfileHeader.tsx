    ...
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-10">
      ...
      <div className="flex items-center gap-3">
        <div className="relative hidden md:block group">
          ...
          <Input type="text" placeholder="Поиск..." className="w-64 h-11 pl-11 pr-4 bg-white border border-slate-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm" />
        </div>
