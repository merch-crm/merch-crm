...
export function DepartmentsList({ departments, loading, onRefresh }: DepartmentsListProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <DepartmentSettingsDialog department={editingDept} isOpen={!!editingDept} onClose={() => setEditingDept(null)}
        onSuccess={onRefresh}
      />

      <DeleteDepartmentDialog department={deletingDept} isOpen={!!deletingDept} onClose={() => setDeletingDept(null)}
