      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="crm-card space-y-3">
          ...
          <div className="space-y-3">
            <SwitchRow icon={Bell} title="Показывать в колокольчике CRM" description="" checked={settings.system.enabled} onCheckedChange={() => toggleNested("system","enabled")}
            />
            <SwitchRow icon={Smartphone} title="Всплывающие окна рабочего стола" description="" checked={settings.system.browserPush} onCheckedChange={() => toggleNested("system","browserPush")}
            />
          </div>
        </div>
        ...
        <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl space-y-3 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <Switch checked={settings.telegram.enabled} onCheckedChange={() => toggleNested("telegram","enabled")}
              className="ml-auto"
            />
          </div>
