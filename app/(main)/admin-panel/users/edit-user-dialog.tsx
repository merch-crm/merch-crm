    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" data-dialog-open="true">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div className="relative transform overflow-hidden rounded-[18px] bg-white p-6 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-slate-200">
                    ...
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-slate-900 leading-tight">Редактирование</h3>
                            <p className="text-[11px] font-medium text-slate-500 mt-0.5">Измените данные сотрудника {user.name}</p>
                        </div>
                    </div>
