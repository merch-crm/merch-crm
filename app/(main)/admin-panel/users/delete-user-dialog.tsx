            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div className="relative transform overflow-hidden rounded-[18px] bg-white p-8 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-slate-200">
                    ...
                    <div className="mb-8 text-center">
                        <div className="h-16 w-16 rounded-[var(--radius-inner)] bg-red-50 text-[#ff463c] flex items-center justify-center mx-auto mb-4 border border-red-100 shadow-sm">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={onClose}
                            disabled={isLoading}
                            className="flex-1 px-4 py-3 text-sm font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-[var(--radius-inner)] transition-colors disabled:opacity-50"
                        >
                            Отмена
                        </button>
                        <button
