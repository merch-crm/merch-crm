...
async function AdminOverview() {
  ...
  return (
    <AdminOverviewClient stats={statsRes.success ? statsRes.data : undefined} monitoring={monitoringRes.success ? (monitoringRes.data as never) : undefined} security={securityRes.success ? securityRes.data : undefined} backups={backupsRes.success ? backupsRes.data : []} />
  );
}
