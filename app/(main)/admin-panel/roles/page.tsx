...
export default function AdminRolesPage() {
  ...
  return (
    <div className="space-y-3 pb-20">
      <AdminPageHeader title="Роли и права" subtitle="Настройка доступов и полномочий сотрудников" icon={Shield} actions={<AddRoleDialog onSuccess={fetchRoles} />}
      />
      ...
      <RolePermissionsDialog role={permissionsRole} isOpen={!!permissionsRole} onClose={() => {
          setPermissionsRole(null);
          fetchRoles();
        }}
      />

      <EditRoleDialog role={editingRole} isOpen={!!editingRole} onClose={() => setEditingRole(null)}
        onSuccess={fetchRoles}
      />

      <DeleteRoleDialog role={deletingRole} isOpen={!!deletingRole} onClose={() => setDeletingRole(null)}
