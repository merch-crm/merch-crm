                    ...
                    <form action={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-1">
                                <label className="text-sm font-bold text-slate-500 ml-1">Название роли</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-sm font-bold text-slate-500 ml-1">Привязка к отделу</label>
                                <div className="relative">
                        ...
                        <div className="space-y-3">
                            <label className="text-sm font-bold text-slate-500 ml-1">Цвет роли (наследуется от отдела по умолчанию)</label>
                            <div className="flex flex-wrap gap-2 p-4 bg-slate-50 rounded-[var(--radius-inner)] border border-slate-200 shadow-inner">
                        ...
                        <div className="space-y-3">
                            <label className="text-sm font-bold text-slate-500 ml-1">Права доступа</label>
                        ...
                        <div className="mt-5 pt-5 border-t border-slate-200 flex gap-3">
                            <button
                                type="button"
