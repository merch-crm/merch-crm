...
export function DeleteDepartmentDialog({ department, isOpen, onClose, onConfirm }: DeleteDepartmentDialogProps) {
  ...
  return (
    <ResponsiveModal isOpen={isOpen} onClose={handleClose} title="Подтвердите действие" description="Вы уверены, что хотите удалить этот отдел?" className="items-start">
