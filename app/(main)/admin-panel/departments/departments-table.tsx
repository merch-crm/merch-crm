...
export function DepartmentsTable() {
  ...
  return (
    <div className="space-y-3 pb-20">
      ...
      <DeleteDepartmentDialog department={departmentToDelete} isOpen={deleteDialogOpen} onClose={() => {
          setDeleteDialogOpen(false);
          setDepartmentToDelete(null);
        }}
      ...
      <DepartmentSettingsDialog department={selectedDepartment} isOpen={!!selectedDepartment} onClose={() => setSelectedDepartment(null)}
