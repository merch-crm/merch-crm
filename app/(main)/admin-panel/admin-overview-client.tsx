...
export function AdminOverviewClient({ stats, monitoring, security, backups }: AdminOverviewProps) {
  ...
  return (
    <div className="space-y-3 pb-20">
      {/* Page Header */}
      <AdminPageHeader title="Обзор системы" subtitle="Основные показатели и состояние платформы MerchCRM" icon={ShieldCheck} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-start">
        <div className="lg:col-span-8 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Button type="button" variant="ghost" className="text-xs font-bold text-primary flex items-center gap-1 hover:gap-2 transition-all group h-auto p-2">
        ...
        <div className="lg:col-span-4 space-y-3">
          ...
          <div className="crm-card !bg-primary !border-primary text-white !shadow-2xl !shadow-primary/30 relative min-h-[300px] flex flex-col justify-between group">
            ...
            <Button type="button" className="relative z-10 w-full py-6 bg-white text-slate-900 rounded-2xl font-bold text-sm shadow-lg shadow-black/5 hover:scale-[1.02] active:scale-95 transition-all h-auto border-none hover:bg-white/90">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between px-2">
              ...
              <Button type="button" variant="ghost" size="icon" className="text-primary hover:bg-primary/10 p-2 rounded-lg transition-colors h-10 w-10">
            ...
            <Button type="button" variant="outline" className="w-full py-8 border-2 border-dashed border-slate-200 rounded-2xl flex items-center justify-center gap-2 text-slate-400 hover:text-primary hover:bg-primary/5 transition-all group font-bold text-xs h-auto bg-transparent border-slate-200">
