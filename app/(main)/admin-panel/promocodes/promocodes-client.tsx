...
export function PromocodesClient({ initialData }: { initialData: Promocode[] }) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-700">
            ...
            {isDialogOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300" role="dialog" aria-modal="true" data-dialog-open="true">
                    <div className="bg-white rounded-[12px] w-full max-w-lg p-8 shadow-2xl animate-in zoom-in-95 slide-in-from-top-4 duration-400 relative overflow-hidden">
                        ...
                        <form action={async (formData) => {
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-bold text-slate-500 ml-1">Код купона</label>
                                <input
                                    name="code"
                                    required
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-sm font-bold text-slate-500 ml-1">Дата истечения</label>
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="flex-[2] btn-dark text-white py-4 rounded-[var(--radius-inner)] text-[11px] font-bold tracking-normal transition-all active:scale-[0.98] disabled:opacity-50 shadow-lg shadow-slate-900/10 flex items-center justify-center gap-2 border-none"
                                >
