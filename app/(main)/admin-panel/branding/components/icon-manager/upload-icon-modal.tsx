        ...
        >
          ...
          >
            ...
            <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-slate-100">
              <Button type="button" variant="outline" className="rounded-xl font-bold h-12 px-6" onClick={() => {
                  onClose();
                  setUploadedFile(null);
                }}
              >
              ...
              <Button type="button" className="btn-dark rounded-xl font-bold h-12 px-8 shadow-xl shadow-slate-900/20" disabled={!uploadedFile} onClick={() => {
                  if (uploadedFile) {
