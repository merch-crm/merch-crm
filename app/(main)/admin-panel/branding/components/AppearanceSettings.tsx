            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              ...
              <div className="flex items-center gap-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-200/60 border-dashed">
                <div className="relative group shrink-0">
                  {formData.crmBackgroundUrl ? (
                    <div className="relative">
                      <Image src={formData.crmBackgroundUrl} alt="CRM Background" className="h-20 w-32 object-cover rounded-[18px] border border-slate-200 p-1 bg-white" width={128} height={80} />
                      <Button type="button" variant="ghost" size="icon" onClick={() => setFormData(prev => ({ ...prev, crmBackgroundUrl: null }))}
                ...
                <div className="flex-1">
                  ...
                  />
                  <Button type="button" variant="outline" size="sm" className="w-full rounded-[20px] font-bold h-10 border-slate-200" disabled={currentUpload?.uploading} onClick={() => document.getElementById("crm-bg-u")?.click()}
                  >
              ...
              <div className="flex items-center gap-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-200/60 border-dashed">
                <div className="relative group shrink-0">
                  {formData.loginBackgroundUrl ? (
                    <div className="relative">
                      <Image src={formData.loginBackgroundUrl} alt="Login Background" className="h-20 w-32 object-cover rounded-[18px] border border-slate-200 p-1 bg-white" width={128} height={80} />
                      <Button type="button" variant="ghost" size="icon" onClick={() => setFormData(prev => ({ ...prev, loginBackgroundUrl: null }))}
                        className="absolute -top-2 -right-2 w-6 h-6 bg-rose-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition-all shadow-md hover:bg-rose-600 hover:text-white p-0"
                      >
                        <X className="w-3 h-3" />
                      </Button>
                ...
                <div className="flex-1">
                  ...
                  />
                  <Button type="button" variant="outline" size="sm" className="w-full rounded-[20px] font-bold h-10 border-slate-200" disabled={currentUpload?.uploading} onClick={() => document.getElementById("bg-u")?.click()}
                  >
                    {currentUpload?.uploading ? (
                      <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-200/60 border-dashed">
                <div className="relative group">
                  {formData.logoUrl ? (
                    <div className="relative">
                      <Image src={formData.logoUrl} alt="Logo" className="h-14 w-auto min-w-[56px] object-contain" width={200} height={56} />
