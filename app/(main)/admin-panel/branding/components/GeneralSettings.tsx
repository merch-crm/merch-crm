        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input value={formData.loginSlogan ||""} onChange={(e) => setFormData(prev => ({ ...prev, loginSlogan: e.target.value }))}
          ...
          <div className="space-y-3">
            <div>
              ...
              <Input value={formData.dashboardWelcome ||""} onChange={(e) => setFormData(prev => ({ ...prev, dashboardWelcome: e.target.value }))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {["₽","$","€","₴","₸"].map((sym) => (
                <Button key={sym} type="button" variant="outline" onClick={() => setFormData(prev => ({ ...prev, currencySymbol: sym }))}
              ...
              <Input value={formData.currencySymbol ||""} onChange={(e) => setFormData(prev => ({ ...prev, currencySymbol: e.target.value }))}
                placeholder="Свой..."
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {["DD.MM.YYYY","YYYY-MM-DD","MM/DD/YYYY"].map((fmt) => (
                <Button key={fmt} type="button" variant="outline" onClick={() => setFormData(prev => ({ ...prev, dateFormat: fmt }))}
          ...
          <div className="space-y-3">
            ...
            <Select options={timezoneOptions} value={formData.timezone ||"Europe/Moscow"} onChange={(val) => setFormData(prev => ({ ...prev, timezone: val }))}
