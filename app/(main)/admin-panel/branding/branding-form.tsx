      ...
      <form onSubmit={onSubmitStrinct} className="space-y-3">
        ...
        <Tabs defaultValue="main" value={ui.activeTab} onValueChange={(val) => setUi(prev => ({ ...prev, activeTab: val }))} className="space-y-3">
          ...
          <TabsContent value="ui">
            <AppearanceSettings formData={formData} setFormData={setFormData} ui={ui} handleFileUpload={handleFileUpload} cancelUpload={cancelUpload} uploadStates={uploadStates} initialIconGroups={initialIconGroups} />
          </TabsContent>

          <TabsContent value="comms">
            <CommunicationSettings formData={formData} setFormData={setFormData} ui={ui} handleFileUpload={handleFileUpload} cancelUpload={cancelUpload} uploadStates={uploadStates} />
          </TabsContent>

          <TabsContent value="sounds">
            <SoundSettings formData={formData} setFormData={setFormData} ui={ui} setUi={setUi} handleFileUpload={handleFileUpload} cancelUpload={cancelUpload} uploadStates={uploadStates} />
          </TabsContent>
        </Tabs>
      </form>
