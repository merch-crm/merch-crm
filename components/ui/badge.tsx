...
const badgeVariants = cva(
    "inline-flex items-center rounded-[10px] border px-3 py-1 text-[11px] font-black tracking-wider uppercase transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
    {
        variants: {
            variant: {
                default:
