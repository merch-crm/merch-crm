...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-[var(--radius)] max-sm:rounded-full text-sm font-bold  ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
    {
        variants: {
            variant: {
                ...
                action: "bg-slate-50 text-slate-400 border border-slate-200/60 hover:bg-white hover:text-primary hover:border-primary/20 hover:shadow-sm transition-all active:scale-90",
                "action-destructive": "bg-slate-50 text-slate-400 border border-slate-200/60 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 hover:shadow-sm transition-all active:scale-90",
            },
            size: {
