    ...
    return (
        <div className={cn("p-[--padding-xl] text-center flex flex-col items-center justify-center animate-in fade-in zoom-in duration-500", className)}>
            <div className="relative mb-6">
                ...
                <div className="relative w-20 h-20 rounded-[var(--radius)] bg-white/40 backdrop-blur-xl border border-white/50 flex items-center justify-center shadow-crm-lg overflow-hidden group">
                    {/* Glossy Reflection */}
                    ...
                    {createElement(icon, {
                        className:"w-10 h-10 text-primary/60 drop-shadow-sm"
                    })}
                </div>
            </div>
