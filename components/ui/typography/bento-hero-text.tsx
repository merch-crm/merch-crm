...
export function BentoHeroText() {
  return (
    <div className="w-full max-w-sm rounded-card bg-white border border-gray-100 shadow-crm-md p-8 flex flex-col gap-3 overflow-hidden relative group">
      ...
      >
        <span className="text-xs font-black text-primary-base tracking-tight">Дизайн-система</span>
        <h1 className="text-4xl font-black text-gray-950 leading-[1.1] tracking-tight">
          <br />
      ...
      <div className="mt-4 flex items-center gap-3 relative z-10">
         ...
         <span className="text-xs font-black text-gray-400 tracking-tight">v4.0.2</span>
      </div>
    </div>
  );
}
