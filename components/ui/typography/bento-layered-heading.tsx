...
export function BentoLayeredHeading({ title = "CRM" }: { title?: string }) {
  return (
    <div className="w-full max-w-sm rounded-card bg-white border border-gray-100 shadow-crm-md p-8 flex flex-col items-center justify-center h-48 relative overflow-hidden group">
      ...
      <p className="text-xs font-black text-primary-base tracking-tight mt-2 relative z-20">Apple</p>
    </div>
  );
}
