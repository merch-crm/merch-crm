    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-6">
                <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center transition-transform duration-500 group-hover:scale-110 shadow-sm",
                    scheme.bg,
                    scheme.text,"border",
                    scheme.border
                )}>
            ...
            <div className={cn("absolute -inset-px rounded-[inherit] opacity-0 group-hover:opacity-10 pointer-events-none transition-opacity duration-500 blur-xl",
                scheme.bg
            )} />
        </Component>
    );
