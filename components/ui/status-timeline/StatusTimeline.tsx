            ...
            {events.map((event, index) => {
                ...
                return (
                    <div key={event.id} className="relative flex gap-3 pb-8 last:pb-0">
                        ...
                        {!isLast && (
                            <div
                                className={cn("absolute left-[15px] top-8 bottom-0 w-0.5",
                                    stateStyle.line
                                )}
                            />
                        )}
                        ...
                        {/* Иконка */}
                        <div
                            className={cn("relative z-10 w-8 h-8 rounded-full flex items-center justify-center shrink-0 border-2 transition-colors",
