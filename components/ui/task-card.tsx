...
const TaskCard = React.forwardRef<HTMLDivElement, TaskCardProps>(
  ({ title, priority = 'medium', status: _status, assignee, dueDate, completed, onToggle, className, ...rest }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'flex items-start gap-3 rounded-element border border-stroke-soft-200 bg-bg-white-0 p-4 shadow-sm transition duration-200 hover:shadow-md hover:border-primary-base/20',
