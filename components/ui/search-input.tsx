  ...
  return (
    <div className="relative flex-1 w-full max-w-md group/search">
      ...
      <Input 
        ...
        value={value} 
        onChange={onChange} 
        className="pl-10 h-11 bg-white border-slate-100 rounded-xl focus-visible:ring-primary/20 focus-visible:border-primary/30 transition-all duration-300 placeholder:text-slate-400" 
        {...props}
      />
    </div>
  )
