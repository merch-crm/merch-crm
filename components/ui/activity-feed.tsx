          ...
          <div key={item.id} className="flex gap-3">
            ...
            <div className={cn('flex flex-col gap-1.5 pb-2', !isLast && 'mb-4')}>
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-black text-slate-900 tracking-tight">{item.title}</span>
              ...
              {item.user && (
                <div className="flex items-center gap-1.5 pt-1">
                   ...
                   <span className="text-[11px] font-black text-slate-400/80 tracking-tighter">— {item.user}</span>
                </div>
              )}
            </div>
          </div>
