...
import { FolderPlus, Settings, Hash, Type, Users, Lock, LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import { BentoCard, BentoIconContainer, BentoInput } from "@/components/ui/bento-primitives";
      ...
      <div className="relative z-10 w-full">
        <div className="flex justify-between items-center mb-8">
           <div className="flex items-center gap-3">
              <BentoIconContainer className="size-10 bg-[#F1F5F9] text-primary-base">
        ...
        <div className="min-h-[220px]">
          {step === 1 && (
            <div className="space-y-3 animate-in fade-in slide-in-from-right-4 duration-500">
               ...
               <div>
                  ...
                  <BentoInput icon={Type} placeholder="Project Name" value={projectName} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setProjectName(e.target.value)} 
                  ...
                  {[
                    ...
                    return (
                      <button 
                        key={i} 
                        type="button"
                        className="flex items-center gap-3 p-4 rounded-element border border-slate-100 dark:border-zinc-800 bg-[#F8FAFC] dark:bg-zinc-900 hover:bg-white dark:hover:bg-zinc-800 hover:shadow-xl hover:scale-[1.02] transition-all text-left"
                      >
          ...
          {step === 3 && (
            <div className="flex flex-col items-center justify-center py-6 animate-in zoom-in-95 duration-500">
               <div className="size-20 rounded-card bg-[#EEF2FF] border border-indigo-200 flex items-center justify-center mb-6 text-indigo-500 shadow-sm animate-bounce">
        ...
        <div className="mt-10 pt-8 border-t border-slate-100 dark:border-zinc-800/50 flex justify-between items-center">
          ...
          <button 
            ...
            className={cn(
              "px-10 py-3.5 rounded-element font-black text-xs   transition-all",
