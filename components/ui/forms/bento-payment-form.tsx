...
import { CreditCard, ShieldCheck, Calendar, Lock, CheckCircle2 } from "lucide-react";
      ...
      <div className="relative z-10 w-full">
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-10 animate-in fade-in zoom-in-95 duration-500">
             <div className="w-20 h-20 rounded-card bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6 text-emerald-500 shadow-lg shadow-emerald-500/10">
             ...
             <button type="button" className="mt-8 px-10 py-3 bg-emerald-500 text-white rounded-xl font-bold text-sm transition-all hover:shadow-xl active:scale-95 shadow-sm">
                Return home
             </button>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="space-y-3">
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-11 pr-4 py-4 bg-[#F8FAFC] border border-slate-200 rounded-element text-sm font-bold focus:border-primary-base transition-all outline-none"
                  required
                />
              </div>
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full mt-4 bg-slate-950 dark:bg-white text-white dark:text-slate-950 py-4 lg:py-5 rounded-element font-black text-xs   flex items-center justify-center gap-2 transition-all hover:shadow-xl active:scale-95 disabled:opacity-50"
            >
              {loading ? (
            ...
            <div className="bg-[#ECFDF5] border border-emerald-100 p-3 rounded-element text-center flex items-center justify-center gap-2">
