...
function TooltipIcon({ content, side = "top", className, iconClassName }: TooltipIconProps) {
    return (
        <Tooltip content={content} side={side}>
            <button
                type="button"
                className={cn("inline-flex items-center justify-center w-4 h-4 rounded-full bg-slate-200 hover:bg-slate-300 transition-colors cursor-help",
                    className
                )}
            >
                <svg
