...
export function BentoInvoiceList() {
  return (
    <BentoCard>
      <BentoHeader title="Billing History" icon={<CreditCard className="size-5" />}
        rightElement={
      ...
      <div className="space-y-3">
         {invoices.map((inv, i) => (
            <motion.div 
               ...
               className="p-4 rounded-element bg-gray-50 border border-gray-100 flex flex-col gap-1 hover:bg-white hover:shadow-sm transition-all"
            >
      ...
      <button type="button" className="w-full py-4 rounded-element bg-slate-900 text-white text-[11px] font-black   hover:bg-primary-base transition-colors shadow-lg mt-2">
         Manage Subscription
      </button>
