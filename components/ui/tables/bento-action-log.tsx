    ...
    <BentoCard className={cn("max-w-sm p-8 flex flex-col gap-3 group overflow-hidden", className)}>
      ...
      <div className="space-y-3">
         {logs.map((log, i) => (
            ...
            >
               <div className={cn(
                  "size-8 rounded-element mt-0.5 flex items-center justify-center shrink-0",
      ...
      <div className="mt-2 p-3 bg-gray-50 rounded-element border border-gray-100 flex items-center justify-between">
