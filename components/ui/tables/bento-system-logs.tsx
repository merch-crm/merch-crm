...
export function BentoSystemLogs({ title, logs, className }: BentoSystemLogsProps) {
  ...
  return (
    <div className={cn("bg-[#0f172a] text-slate-300 shadow-xl border border-slate-800 p-6 rounded-card flex flex-col font-mono text-xs relative overflow-hidden", className)}>
      {/* Decorative top bar */}
      ...
      <div className="flex-1 w-full overflow-x-auto bg-[#020617] rounded-element p-4 border border-slate-800/50 shadow-inner">
