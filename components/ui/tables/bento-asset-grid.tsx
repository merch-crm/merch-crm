      ...
      <div className="grid grid-cols-1 gap-3">
         {assets.map((asset, i) => (
            <motion.div 
               ...
               className="p-4 rounded-element bg-gray-50 border border-gray-100 flex items-center justify-between group/asset hover:bg-white hover:shadow-sm transition-all cursor-pointer"
            >
