...
export function ResponsiveDetailLayout({
    ...
    return (
        <div className="flex flex-col font-sans relative pt-4 pb-4">
            <div className="flex-1 w-full mx-auto space-y-0 text-foreground">
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-2 xl:flex xl:flex-row xl:items-start md:gap-3 xl:gap-3">
                    ...
                    {leftSidebar && (
                        <div className={cn("flex flex-col gap-3 w-full xl:sticky xl:top-[112px] xl:z-[10] xl:w-[320px] xl:shrink-0",
                    ...
                    {/* MAIN BENTO GRID */}
                    <div className={cn("md:contents xl:flex-1 xl:w-full xl:grid xl:grid-cols-12 xl:gap-3",
                        isArchived && "grayscale opacity-70"
                    )}>
