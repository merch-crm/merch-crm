...
export function BentoPresenceIndicator() {
  return (
    <div className="w-full max-w-sm rounded-card bg-white border border-gray-100 shadow-crm-md p-8 flex flex-col items-center gap-3 group overflow-hidden relative">
