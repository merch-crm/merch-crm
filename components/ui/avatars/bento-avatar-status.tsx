...
export function BentoAvatarStatus() {
  ...
  return (
    <div className="w-full max-w-sm rounded-card bg-white border border-gray-100 shadow-crm-md p-8 flex flex-col gap-3">
        ...
        {statuses.map((s, i) => (
          <div key={i} className="flex flex-col items-center gap-3">
             <div className="relative">
                <div className="size-14 rounded-element bg-gray-50 border border-gray-100 flex items-center justify-center">
      ...
      <div className="mt-2 bg-gray-50 rounded-element p-4 border border-gray-100 flex items-center justify-between">
