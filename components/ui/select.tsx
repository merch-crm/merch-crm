            ...
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                    <button
                        ...
                        aria-expanded={open}
                        className={cn("w-full transition-all group disabled:opacity-50 disabled:cursor-not-allowed flex items-center",
                            (center || variant ==="minimal") ?"justify-center" :"justify-between",
                            variant ==="default" ? ["bg-slate-50 border border-border rounded-[var(--radius-inner)] shadow-sm hover:shadow-md",
                    ...
                    >
                        ...
                        <ChevronDown className={cn("text-muted-foreground transition-transform duration-300 shrink-0 ml-1.5",
                    ...
                    {open && (
                        ...
                        >
                            <motion.div
                                ...
                                className={cn("rounded-[22px] bg-white border border-border overflow-hidden shadow-crm-xl ring-1 ring-black/[0.03]",
                                    ...
                                    <div className="overflow-y-auto scrollbar-hide flex-1" role="listbox">
                                        {filteredOptions.length > 0 ? (
                                            <div className={cn("p-0.5",
                                                effectiveGridColumns ? ["grid gap-2",
                                                ...
                                                {filteredOptions.map((option, index) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={cn("transition-all text-left group/item rounded-[var(--radius-inner)] border",
                                                                effectiveGridColumns ? ["flex items-center p-3",
                                                            ...
                                                            <div className={cn(
                                                                ...
                                                                <div className={cn(
                                                                    ...
                                                                    <div className="flex items-center gap-2 min-w-0">
                                                                        <span className={cn("font-bold leading-none",
                                                                        ...
                                                                        {option.badge && (
                                                                            <span className={cn("text-xs font-bold px-1.5 py-0.5 rounded-full shrink-0",
                                                                    ...
                                                                    {isSelected && (
                                                                        <Check className={cn("text-primary shrink-0",
