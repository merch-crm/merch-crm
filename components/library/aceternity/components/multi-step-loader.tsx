    ...
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 h-full bg-white [mask-image:radial-gradient(900px_at_center,transparent_30%,white)] dark:bg-black" />
        </motion.div>
      )}
    </AnimatePresence>
  );
