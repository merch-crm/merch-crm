...
export function HoverBorderGradient<T extends React.ElementType = "button">({
  ...
  const TagResolved = Tag as React.ElementType;
  ...
  return React.createElement(
    TagResolved,
    {
      ...
      className: cn(
        "relative flex h-min w-fit flex-col items-center justify-center gap-3 overflow-visible rounded-full border bg-black/20 p-px transition duration-500 hover:bg-black/10 dark:bg-white/20",
        containerClassName
      ),
      ...props,
    },
    React.createElement(
      ...
      {
        className: cn(
          "z-10 w-auto rounded-[inherit] bg-black px-4 py-2 text-white gap-3",
          className
        ),
      },
      children
    ...
    React.createElement("div", {
      className: "absolute inset-[2px] z-[1] flex-none rounded-[100px] bg-black",
    })
  );
}
