...
export function BentoTargetTracker({ 
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative overflow-hidden bg-primary text-primary-foreground shadow-crm-lg flex flex-col justify-between group",
        "rounded-[27px]", // Matching extreme radius
        className
      )}
    >
      ...
      <div className="relative z-10 p-6 flex justify-between items-start w-full">
        <div className="flex-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-black/20 backdrop-blur-md rounded-full mb-4">
            ...
            <span className="text-[11px] font-black uppercase tracking-tight text-white/90">{title}</span>
          ...
          <div className="flex items-end gap-x-3 gap-y-1 flex-wrap">
            ...
            <span className="text-primary-foreground/60 text-lg font-medium mb-1">
      ...
      <div className="relative z-10 p-6 mt-auto">
        <div className="flex justify-between items-end mb-3">
          <div className="flex flex-col">
            <span className="text-[11px] font-bold text-white/70 uppercase tracking-tighter">Current Pace</span>
            <span className="text-lg font-black tracking-tighter text-white">+12.4% vs last Q</span>

          </div>
          
          <div className="text-right">
            <span className="text-[11px] font-bold text-white/50 uppercase tracking-tighter">Remaining</span>
            <div className="text-sm font-black tracking-tighter text-white">${(remaining / 1000).toFixed(1)}k</div>
