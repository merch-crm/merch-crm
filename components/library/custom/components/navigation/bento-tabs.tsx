...
export function BentoTabs({ 
  ...
  return (
    <div 
      ...
      className={cn("inline-flex p-2 bg-slate-50/50 rounded-[2.5rem] border border-slate-100 shadow-premium backdrop-blur-sm", className)}
    >
      {tabs.map((tab) => {
        ...
        return (
          ...
          >
            ...
            <span className={cn(
              "relative z-10 text-[11px] font-black uppercase tracking-[0.3em] transition-all duration-500",
