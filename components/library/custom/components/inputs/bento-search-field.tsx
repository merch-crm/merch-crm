  ...
  return (
    <div className={cn("relative w-full group", className)}>
      <motion.div
        ...
        className={cn(
          "relative flex items-center gap-3 p-1 rounded-[1.5rem] transition-all duration-500 border",
          isFocused 
            ? "bg-white border-primary shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] ring-4 ring-primary/5" 
            : "bg-gray-50/50 border-gray-100/50 hover:bg-white hover:border-gray-200"
        )}
      >
        <div className={cn(
