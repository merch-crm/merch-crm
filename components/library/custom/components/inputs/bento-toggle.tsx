...
export function BentoToggle({ 
  ...
  return (
    <div className={cn("flex items-center justify-between gap-4 py-3 px-4 rounded-[2rem] bg-white border border-slate-100 shadow-sm transition-all hover:shadow-md", className)}>
      {label && (
        <span className="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1 leading-none">
          {label}
        </span>
      )}
