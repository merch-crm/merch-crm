...
export function BentoIdentityCard() {
  return (
    <div className="w-full max-w-sm rounded-[32px] bg-slate-900 p-8 flex flex-col gap-3 relative overflow-hidden group">
      <div className="absolute top-0 right-0 w-32 h-32 bg-primary-base/20 blur-[60px] rounded-full" />
      
      <div className="flex items-center gap-3 relative z-10">
         <div className="size-20 rounded-[24px] bg-primary-base p-1 ring-4 ring-white/5">
            <div className="w-full h-full bg-slate-800 rounded-[20px] flex items-center justify-center text-white text-2xl font-black">
               LM
            </div>
         </div>
      ...
      <div className="space-y-3 relative z-10 pt-4 border-t border-white/5">
         <div className="flex items-center gap-3 text-white/50 hover:text-white transition-colors cursor-pointer group/item">
      ...
      <button type="button" className="w-full mt-2 py-3 rounded-2xl bg-white text-slate-900 text-xs font-black   flex items-center justify-center gap-2 hover:bg-primary-base hover:text-white transition-all shadow-xl">
