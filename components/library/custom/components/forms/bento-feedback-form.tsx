...
export function BentoFeedbackForm({ className }: { className?: string }) {
  ...
  if (!isMounted) {
    return <div className={cn("bg-white dark:bg-zinc-950 min-h-[480px] rounded-[2.5rem] animate-pulse border border-slate-200 dark:border-zinc-800", className)} />;
  }
      ...
      <div className="relative z-10 w-full text-center">
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-10 animate-in zoom-in-95 duration-500">
             <div className="w-16 h-16 rounded-[1.5rem] bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-6 text-amber-500 shadow-lg shadow-amber-500/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative group space-y-2">
               ...
               <textarea 
                  ...
                  className="w-full min-h-[120px] p-4 bg-slate-50 dark:bg-zinc-900 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary-base/10 transition-all outline-none resize-none placeholder:text-slate-300 dark:placeholder:text-zinc-700"
               />
            </div>
            ...
            <button 
              ...
              className="w-full py-4 bg-slate-950 dark:bg-white text-white dark:text-slate-950 rounded-2xl font-black text-xs   flex items-center justify-center gap-2 transition-all hover:shadow-xl active:scale-95 disabled:opacity-30 disabled:grayscale"
            >
