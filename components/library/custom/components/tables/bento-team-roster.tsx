  ...
  return (
    <div className="w-full max-w-sm rounded-[32px] bg-white border border-gray-100 shadow-crm-md p-8 flex flex-col gap-3 group overflow-hidden">
      <div className="flex justify-between items-center">
         <div>
            <h3 className="text-sm font-black text-gray-950  leading-none">Team Efficiency</h3>
            <p className="text-[11px] font-black text-gray-400   mt-1">Top Performers</p>
         </div>
         <button type="button" aria-label="More options" className="size-8 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 cursor-pointer hover:bg-gray-100 transition-colors">
      ...
      <button type="button" className="w-full bg-emerald-500 rounded-3xl p-5 flex items-center gap-3 group/banner cursor-pointer transition-transform hover:scale-[1.02] text-left">
