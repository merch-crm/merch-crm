    ...
    <div className={cn('flex flex-col gap-3', className)} {...rest}>
      <div className="relative group">
        ...
        <input
          ...
          className={cn(
            'w-full rounded-2xl border border-stroke-soft-200 bg-bg-white-0 py-3 pl-10.5 pr-4 text-sm font-medium text-text-strong-950 outline-none placeholder:text-text-soft-400 transition-all duration-200',
