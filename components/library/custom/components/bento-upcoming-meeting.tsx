...
const defaultParticipants: Participant[] = [
  { name: "Olga K.", initials: "OK", color: "bg-rose-500" },
  { name: "Dmitry S.", initials: "DS", color: "bg-blue-500" },
  { name: "Anna R.", initials: "AR", color: "bg-emerald-500" },
  { name: "Max P.", initials: "MP", color: "bg-amber-500" },
];
...
export function BentoUpcomingMeeting({
      ...
      <div className="p-6 pb-4 flex items-start justify-between">
        <div>
          <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-emerald-500/10 text-emerald-600 rounded-full mb-3">
            ...
            <span className="text-[11px] font-black uppercase tracking-tight">Starting soon</span>
          </div>
          <h3 className="text-[11px] font-black uppercase tracking-tight text-slate-900 leading-tight">{title}</h3>
 ...
 Broadway typography in BentoUpcomingMeeting.tsx.
      ...
      <div className="px-6 flex items-center gap-3 text-[11px] font-bold text-slate-400">
        ...
        <span className="uppercase tracking-tighter">{duration}</span>
        <motion.a
          href="#"
          whileHover={{ x: 3 }}
          className="ml-auto flex items-center gap-1 text-[11px] font-black text-primary hover:underline cursor-pointer uppercase tracking-widest"
        >
      ...
      <div className="mt-auto pt-6 px-6 pb-6 relative">
        ...
        <div className="flex items-center">
          ...
          <span className="ml-3 text-[11px] font-bold text-slate-400 uppercase tracking-tighter">
