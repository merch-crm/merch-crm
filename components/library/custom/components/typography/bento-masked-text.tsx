    ...
    <div className="w-full max-w-sm rounded-[3rem] bg-white border border-slate-100 shadow-premium p-8 flex flex-col gap-6 group overflow-hidden relative">
      ...
      <div className="relative h-32 flex items-center justify-center p-6 bg-slate-50 rounded-[2.5rem] border border-slate-100 shadow-inner overflow-hidden group/mask cursor-wait active:cursor-none">
        ...
        <div className="relative z-10 flex items-center justify-center w-full h-full">
            <div className="text-xl font-black text-slate-950 uppercase tracking-[0.4em] transition-all duration-700 blur-xl opacity-0 group-hover/mask:blur-none group-hover/mask:opacity-100 select-none">
               CRM-TOKEN-2025
            </div>
            <p className="absolute text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] pointer-events-none transition-all duration-700 opacity-100 group-hover/mask:opacity-0 flex items-center gap-3">
      ...
      <div className="flex justify-between items-center border-t border-slate-50 pt-6 relative z-10">
         ...
         <button 
           ...
           className="text-[11px] font-black text-primary-base uppercase tracking-widest hover:text-slate-950 transition-colors bg-primary-base/5 px-4 py-2 rounded-full border border-primary-base/10 hover:border-slate-200"
         >
           Revoke Access
         </button>
      </div>
