  ...
  return (
    <div className={cn("flex flex-col gap-3 w-full", className)}>
      <div className="flex items-center justify-between px-1">
        <span className="text-xs font-bold text-gray-400  ">Размерная сетка</span>
        <span className="text-[11px] font-medium text-gray-400 italic">Наличие обновлено 5м назад</span>
      </div>
        ...
        {sizes.map((size) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "relative h-14 rounded-2xl border-2 flex flex-col items-center justify-center transition-all duration-300 overflow-hidden group",
                isSelected 
            ...
            >
              ...
              {size.price_adder && !isSelected && (
                 <span className="absolute bottom-1 right-2 text-[11px] font-bold text-emerald-600">
                    +{size.price_adder}₽
                 </span>
              )}
            </motion.button>
      ...
      <div className="flex gap-3 mt-2 px-1">
         <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-bold text-gray-500">Достаточно</span>
         </div>
         <div className="flex items-center gap-1.5">
            <div className="size-2 rounded-full bg-amber-400" />
            <span className="text-[11px] font-bold text-gray-500">Мало</span>
         </div>
         <div className="flex items-center gap-1.5">
            <div className="size-2 rounded-full bg-gray-200" />
            <span className="text-[11px] font-bold text-gray-500">Нет</span>
         </div>
      </div>
    </div>
  );
