    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button variant="ghost" data-testid="mobile-menu-toggle" className="relative flex-1 h-full flex flex-col items-center justify-center gap-1 text-slate-400 hover:text-slate-600 transition-all duration-300 border-none bg-transparent outline-none p-0">
