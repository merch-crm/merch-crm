...
### Standardized UI Kit API (v4.0)

✅ **MANDATORY**: Use the new 'Purified' component API:
- **Button/Badge**: Use `color` for semantic intent (`primary`, `success`, `danger`, `warning`, `brand`, `neutral`, `dark`).
